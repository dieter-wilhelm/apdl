;;; apdl-keyword.el --- Major mode for the scripting language APDL -*- lexical-binding: t -*-

(defconst apdl-undocumented-command-regexp
"\\(?:\\*\\(?:EVAL\\|MOONEY\\|PREAD\\)\\|/\\(?:OPT\\|P\\(?:ICE\\|METH\\)\\|RUNST\\(?:AT\\)?\\|SSS\\|TRACK\\|V\\(?:ERIFY\\|T\\)\\|WB\\|XML\\)\\|A\\(?:LPFILL\\|R\\(?:COLLAPSE\\|DETACH\\|FILL\\|MERGE\\|SPLIT\\)\\|SLN\\)\\|B\\(?:E\\(?:LLOW\\|ND\\)\\|RANCH\\)\\|C\\(?:E\\(?:CYC\\|WRITE\\)\\|MBLOCK\\|NTR\\|RPLIM\\|WZPLOT\\)\\|E\\(?:ALL\\|BLOCK\\|ND\\|QSLV\\)\\|F\\(?:ATIGUE\\|ELIST\\|IPLOT\\|L\\(?:ANGE\\|DATA1-40\\|ITEM\\|LIST\\|O\\(?:CHECK\\|TRAN\\)\\|READ\\)\\|MAGSUM\\|PLIST\\|S\\(?:DELE\\|LIST\\|NODE\\|PLOT\\)\\|T\\(?:CALC\\|\\(?:SIZ\\|WRIT\\)E\\)\\|[ELPS]\\)\\|G\\(?:AP\\(?:F\\(?:INISH\\)?\\|LIST\\|MERGE\\|\\(?:OP\\|PLO\\)T\\)?\\|P\\(?:DELE\\|LIST\\)?\\)\\|HF\\(?:A\\(?:DP\\|RRAY\\)\\|DEEM\\|E\\(?:IGOPT\\|REFINE\\)\\|MODPRT\\|P\\(?:A\\|CSWP\\|O\\(?:RT\\|WER\\)\\)\\|SCAT\\)\\|IC\\(?:E\\(?:DELE\\|LIST\\)?\\|VFRC\\)\\|KCALC\\|L\\(?:N\\(?:COLLAPSE\\|DETACH\\|FILL\\|MERGE\\|SPLIT\\)\\|PRT\\|SLN\\)\\|M\\(?:ITER\\|S\\(?:ADV\\|CAP\\|DATA\\|M\\(?:ASS\\|ETH\\|IR\\)\\|NOMF\\|PROP\\|QUAD\\|RELAX\\|S\\(?:OLU\\|PEC\\)\\|TERM\\|VARY\\)\\)\\|N\\(?:ALL\\|BLOCK\\|ELE\\)\\|OP\\(?:A\\(?:DD\\|NL\\)\\|CLR\\|D\\(?:ATA\\|EL\\)\\|E\\(?:QN\\|XE\\)\\|F\\(?:\\(?:AC\\|RS\\)T\\)\\|GRAD\\|KEEP\\|L\\(?:FA\\|GR\\|IST\\|OOP\\|SW\\)\\|MAKE\\|PRNT\\|R\\(?:AND\\|ESU\\|FA\\|GR\\|SW\\)\\|S\\(?:AVE\\|EL\\|\\(?:UB\\|WEE\\)P\\)\\|TYPE\\|\\(?:USE\\|VA\\)R\\)\\|P\\(?:CO\\(?:NV\\|RRO\\)\\|DRAG\\|E\\(?:MOPTS\\|RI\\|XCLUDE\\)\\|FLUID\\|G\\(?:AP\\|R\\(?:APH\\|SET\\)\\|\\(?:S\\(?:AV\\|EL\\)\\|WRIT\\)E\\)\\|I\\(?:LE\\(?:CALC\\|DISPSET\\|GEN\\|LOAD\\|MASS\\|RUN\\|S\\(?:EL\\|TIF\\)\\)\\|N\\(?:CLUDE\\|SUL\\)\\|PE\\)\\|L\\(?:C\\(?:ONV\\|RACK\\)\\|FSS\\|S\\(?:CH\\|YZ\\)\\|T\\(?:D\\|LINE\\)\\|V\\(?:AROPT\\|FRC\\)\\|WAVE\\)\\|M\\(?:ETH\\|OPTS\\)\\|O\\(?:PT\\|UTRES\\)\\|P\\(?:LOT\\|R\\(?:ANGE\\|ES\\)\\)\\|R\\(?:CONV\\|ECISION\\|SYZ\\|VAROPT\\)\\|S\\(?:OLVE\\|P\\(?:EC\\|RNG\\)\\)\\|TEMP\\|UNIT\\)\\|QFACT\\|R\\(?:ALL\\|EDUCE\\|FILSZ\\|ITER\\|MEMRY\\|S\\(?:PEED\\|TAT\\)\\|TIMST\\|UN\\|WFRNT\\)\\|S\\(?:ARPLOT\\|HSD\\|L\\(?:[PS]PLOT\\)\\|OLCONTROL\\|P\\(?:A\\(?:DP\\|RM\\)\\|FSS\\|ICE\\|S\\(?:CAN\\|WP\\)\\)\\|STIF\\)\\|T\\(?:EE\\|O\\(?:COMP\\|DEF\\|EXE\\|FREQ\\|GRAPH\\|L\\(?:IST\\|OOP\\)\\|P\\(?:\\(?:LO\\|RIN\\)T\\)\\|STAT\\|T\\(?:AL\\|YPE\\)\\|VAR\\)\\|Z\\(?:AMESH\\|DELE\\|EGEN\\)\\)\\|V\\(?:ALVE\\|CVFILL\\|T\\(?:CLR\\|DISC\\|EVAL\\|FREQ\\|GEOM\\|IN\\|M\\(?:ETH\\|P\\)\\|OP\\|POST\\|R\\(?:EAL\\|FIL\\|SLT\\)\\|S\\(?:EC\\|FE\\|L\\|TAT\\)\\|TEMP\\|VMOD\\)\\)\\|X\\(?:MLO\\|VAROPT\\)\\|~\\(?:CFIN\\|EUI\\)\\)"
...
*CFWRITE, Command" "*COMP - Compresses a matrix using a specifiedalgorithm.
...
*DOT, Vector1, Vector2, Par_Real, Par_Imag, Conj" "*DOWHILE - Loops repeatedly through the next *ENDDO
*DOWHILE, Par" "*DPF - Specifies an input data processing framework (DPF) workflow file or a DPF workflow output pin.
*DPF, Action, WorkflowId,Val1,Val2,Val3" "*EIGEN - Performs a modal solution with unsymmetric or dampingmatrices.
...
*EXPORT, Matrix, Format, Fname, Val1, Val2, Val3" "*FFT - Computes the fast Fourier transformation of a specifiedmatrix or vector.
...
*FREE, Name, VAL1" "*GET - Retrieves a value and stores it as a scalar parameteror part of an array parameter.
*GET, Par, Entity, ENTNUM, Item1, IT1NUM, Item2, IT2NUM" "*GO - Causes a specified line on the input file to be read next.
*GO, Base" "*HPROD - Performs a Hadamard vector product (C = A&#8728;B).
*HPROD, A, B, C" "*IF - Conditionally causes commands to be read.
*IF, VAL1, Oper1, VAL2, Base1, VAL3, Oper2, VAL4, Base2" "*INIT - Initializes a vector or matrix.
*INIT, Name, Method, Val1, Val2, Val3" "*INQUIRE - Retrieves properties of an existing APDL Math object.
*INQUIRE, Obj, Property, Var1" "*ITENGINE - Performs a solution using an iterative solver.
*ITENGINE, Type, EngineName, PrecondName, Matrix, RhsVector, SolVector, MaxIter, Toler" "*KRON - Computes the Kronecker product of two matrices/vectors; 
*KRON, M1, M2, M3" "*LIST - Displays the contents of an external; coded file.
...
*MOPER, ParR, Par1, Oper, Val1, Val2, Val3, Val4, Val5, Val6" "*MSG - Writes an output message via the Mechanical APDL message subroutine.
...
*NRM, Name, NormType, ParR, Normalize" "*PLUG - Loads a plugin into Mechanical APDL so that new functionalities can be dynamically added. 
*PLUG, Action, PLuginName" "*PRINT - Prints the matrix values to a file.
...
*RETURN, Level" "*SCAL - Scales a vector or matrix by a constant or a vector.
...
*VPLOT, ParX, ParY, Y2, Y3, Y4, Y5, Y6, Y7, Y8" "*VPUT - Restores array parameter values into the Mechanical APDL database.
...
*XPL, Action, Val1, Val2" "/AN3D - Specifies 3D annotation functions
/AN3D, Keyword, KEY" "/ANFILE - Saves or resumes an animation sequence to or from a file.
...
/ANUM, NUM, TYPE, XHOT, YHOT" "/ASSIGN - Reassigns a file name to a Mechanical APDL file identifier.
/ASSIGN, Ident, Fname, Ext, --, LGkey" "/AUTO - Resets the focus and distance specifications to \"automaticallycalculated.\"
/AUTO, WN" "/AUX12
...
/BATCH, Lab" "/CFORMAT - Controls the graphical display of alphanumeric character stringsfor parameters; components; assemblies; and tables.
...
/CMAP, Fname, Ext, --, Keyword, NCNTR" "/COLOR - Specifies the color mapping for various items.
...
/CWD, DIRPATH" "/CYCEXPAND - Graphically expands displacements; stresses and strainsof a cyclically symmetric model. 
/CYCEXPAND, WN, OPTION, Value1, Value2" "/DBDECRYPT - Controls decryption of material data in the database file.
/DBDECRYPT, KeyA, KeyB, DataType, NUM1, NUM2, INC" "/DBENCRYPT - Controls encryption of material data in the database file.
/DBENCRYPT, KeyA, KeyB, DataType, NUM1, NUM2, INC" "/DECRYPT - Controls decryption of command input.
/DECRYPT, Key1, Key2" "/DELETE - Deletes a file.
...
/DFLAB, DOF, DispLab, ForceLab" "/DIRECTORY - Put the file names in the current directory into a string parameterarray.
...
/DSCALE, WN, DMULT" "/DV3D - Sets 3D device option modes.
/DV3D, Lab, Key" "/EDGE - Displays only the common lines (&#8220;edges&#8221;)of an object.
/EDGE, WN, KEY, ANGLE" "/EFACET - Specifies the number of facets per element edge for PowerGraphicsdisplays.
/EFACET, NUM" "/ENCRYPT - Controls encryption of command input. 
/ENCRYPT, Key, Fname, Ext" "/EOF
...
/EXIT, Slab, Fname, Ext, --" "/EXPAND - Allows the creation of a larger graphic display than representedby the actual finite element analysis model.
...
/FACET, Lab" "/FCLEAN
/FCLEAN - Deletes all local files in all processors in a distributed parallel processing run." "/FCOMP - Specifies file-compression options.
...
/FORMAT, NDIGIT, Ftype, NWIDTH, DSIGNF, LINE, CHAR, EXPTYPE" "/GCMD - Controls the type of element or graph display used for the GPLOT
...
/GSAVE, Fname, Ext, --" "/GST - Enables the Graphical Solution Tracking (GST) feature.
/GST, Lab, RunTrack" "/GTHK - Sets line thicknesses for graph lines.
/GTHK, Label, THICK" "/GTYPE - Controls the entities that the GPLOT
/GTYPE, WN, LABEL, KEY" "/HBC - Determines how boundary condition symbols are displayed in a displaywindow.
...
/MPLIB, R-W_opt, PATH" "/MREP - Enables you to reissue the graphics command macro \"name\" duringa replot or zoom operation.
...
/PREP7 - Enters the model creation preprocessor." "/PSEARCH - Specifies a directory to be searched for \"unknown command\" macrofiles.
...
/RENAME, Fname1, Ext1, --, Fname2, Ext2, --, DistKey" "/REPLOT - Reissues the last display command. 
/REPLOT, Label" "/RESET
...
/RGB, Keyword, PRED, PGRN, PBLU, N1, N2, NINC, NCNTR" "/RMDIR - Removes (deletes) a directory.
/RMDIR, Dir" "/SECLIB - Sets the default section library path for the SECREAD
...
/SHADE, WN, Type" "/SHOW - Specifies the device and other parameters for graphicsdisplays.
/SHOW, Fname, Option, VECT, NCPL" "/SHRINK - Shrinks elements; lines; areas; and volumes for displayclarity.
/SHRINK, RATIO" "/SMBC - Controls the display of solid model boundary conditionsymbols and labels.
/SMBC, Mode" "/SOLU
...
/STITLE, NLINE, Title" "/SYP - Passes a command string and arguments to the operatingsystem.
/SYP, String, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8" "/SYS - Passes a command string to the operating system.
/SYS, String" "/TEE - Writes a list of commands to a specified file at the sametime that the commands are being executed.
...
/UNITS, Label, LENFACT, MASSFACT, TIMEFACT, TEMPFACT, TOFFST, CHARGEFACT, FORCEFACT, HEATFACT" "/UPF - Links a user-programmable routine into Mechanical APDL.
/UPF, RoutineName" "/USER - Conveniently resets /FOCUS
...
ACCOPTION, Activate" "ACEL - Specifies the linear acceleration of the global Cartesianreference frame for the analysis.
ACEL, ACEL_X, ACEL_Y, ACEL_Z" "ACLEAR - Deletes nodes and area elements associated with selected areas.
ACLEAR, NA1, NA2, NINC" "ADAMS - Performs solutions and writes flexible body information to a modalneutral file (Jobname.MNF
ADAMS, NMODES, KSTRESS, KSHELL" "ADD - Adds (sums) variables.
ADD, IR, IA, IB, IC, Name, --, --, FACTA, FACTB, FACTC" "ADDAM - Specifies the acceleration spectrum computation constantsfor the analysis of shock resistance of shipboard structures.
...
ADGL, NA1, NA2, NINC" "ADPCI - Defines parameters associated with adaptive crack initiation.
ADPCI, Action, Par1, Par2, Par3, Par4, Par5, Par6, Par7, Par8" "ADRAG - Generates areas by dragging a line pattern along a path.
...
AFLIST - Lists the current data in the database." "AFSURF - Generates surface elements overlaid on the surface of existingsolid elements and assigns the extra node as the closest fluid element node.
...
AINV, NA, NV" "AIRL - Specifies that automatic inertia relief calculations are to be performed.
AIRL, NRB, RIGID_CALC" "AL - Generates an area bounded by previously defined lines.
...
ALPHAD, VALUE" "AMAP - Generates a 2D mapped mesh based on specified area corners.
AMAP, AREA, KP1, KP2, KP3, KP4" "AMBEAM - Specifies energy source parameters in an additive manufacturing analysis.
AMBEAM, NUMBEAMS, POWER, ABSORPTIVITY" "AMBUILD - Specifies printer parameters for the build and other options in an additive manufacturing analysis.
AMBUILD, Option, VAL1, VAL2, VAL3, VAL4" "AMENV - Specifies the build-environment thermal boundary conditions in an additive manufacturing analysis.
...
AMPOWDER, TPOWDER, HPOWDER, MATFACTOR" "AMRESULT - Specifies additive manufacturing result data written to a .txt
AMRESULT, Item, Key" "AMSTEP - Specifies the process-sequence steps in an additive manufacturing
AMSTEP, Sequence, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6" "AMSUPPORTS - Specifies information about the supports in an additive manufacturing analysis.
...
ANCUT, NFRAM, DELAY, NCYCL, QOFF, KTOP, TOPOFF, NODE1, NODE2, NODE3" "ANCYC - Applies a traveling wave animation to graphics data ina modal cyclic symmetry analysis.
...
ANDYNA, DELAY, NCYCL, START, END, INC, AUTOCONTOURKEY" "ANFLOW - Produces an animated sequence of a charged particle traveling in an electric or magnetic field.
ANFLOW, NFRAM, DELAY, NCYCL, TIME, SPACING, SIZE, LENGTH" "ANHARM - Produces an animated sequence oftime-harmonic results or complex mode shapes.
...
ANORM, ANUM, NOEFLIP" "ANPRES - Produces an animated sequence of the time-harmonic pressurevariation of an engine-order excitation in a cyclic harmonic analysis.
ANPRES, NFRAM, DELAY, NCYCL, RefFrame" "ANSOL - Specifies averaged element nodal data to be stored from the results file. 
ANSOL, NVAR, NODE, Item, Comp, Name, Mat, Real, Ename, DataKey" "ANSTOAQWA - Creates an AQWA-LINE input file from the current Mechanical APDL model.
ANSTOAQWA, Fname, VertAxis, Gc, Rho, HWL, DiffKey, SymxKey, SymyKey" "ANSTOASAS - Creates an ASAS input file from the current Mechanical APDL model.
...
APLOT, NA1, NA2, NINC, DEGEN, SCALE" "APORT - Specifies input data for plane wave and acoustic ductports.
APORT, PortNum, Label, KCN, PRES, PHASE, --, VAL1, VAL2, VAL3, VAL4" "APPEND - Reads data from the results file and appends it to thedatabase.
...
ARCLEN, Key, MAXARC, MINARC" "ARCTRM - Controls termination of the solutionwhen the arc-length method is used.
...
AREMESH, LCOMB, ANGLE" "AREVERSE - Reverses the normal of an area; regardless of its connectivityor mesh status.
AREVERSE, ANUM, NOEFLIP" "AROTAT - Generates cylindrical areas by rotating a line pattern about anaxis.
...
ASBV, NA, NV, SEPO, KEEPA, KEEPV" "ASBW - Subtracts the intersection of the working plane from areas (dividesareas).
...
ASIFILE, Opt, Fname, Ext, Oper, kDim, kOut, LIMIT, --, ResOpt" "ASKIN - Generates an area by \"skinning\" a surface through guiding lines.
...
ASUB, NA1, P1, P2, P3, P4" "ASUM - Calculates and prints geometry statistics of the selectedareas.
...
ATYPE - Specifies \"Analysis types\" as the subsequent status topic." "AUTOTS - Specifies whether to use automatic time stepping or loadstepping.
AUTOTS, Key" "AVPRIN - Specifies how principal and vector sums are to be calculated.
AVPRIN, KEY, EFFNU" "AVRES - Specifies how results data will be averaged when PowerGraphicsis enabled.
...
BF, Node, Lab, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6, MESHFLAG" "BFA - Defines a body-force load on an area.
...
BFE, Elem, Lab, STLOC, VAL1, VAL2, VAL3, VAL4" "BFECUM - Specifies whether to ignore subsequent element body forceloads.
...
BFLLIST, LINE, Lab" "BFPORT - Transfers a thermal body-force load (HGEN) from selected MESH200
BFPORT, Cmname" "BFSCALE - Scales body-force loads at nodes.
...
BLC4, XCORNER, YCORNER, WIDTH, HEIGHT, DEPTH" "BLC5 - Creates a rectangular area or block volume by center and cornerpoints.
...
BOPTN, Lab, Value" "BSAX - Specifies the axial strain and axial force relationship for beamsections.
BSAX, VAL1, VAL2, T" "BSM1 - Specifies the bending curvature and moment relationship in planeXZ for beam sections.
BSM1, VAL1, VAL2, T" "BSM2 - Specifies the bending curvature and moment relationship in planeXY for beam sections.
...
BSPLIN, P1, P2, P3, P4, P5, P6, XV1, YV1, ZV1, XV6, YV6, ZV6" "BSS1 - Specifies the transverse shear strain and force relationship inplane XZ for beam sections.
BSS1, VAL1, VAL2, T" "BSS2 - Specifies the transverse shear strain and force relationship inplane XY for beam sections.
BSS2, VAL1, VAL2, T" "BSTE - Specifies a thermal expansion coefficient for a nonlinear general beam section.
BSTE, ALPHA, T" "BSTQ - Specifies the cross section twist and torque relationship forbeam sections.
...
C***, Comment" "CALC
CALC - Specifies \"Calculation settings\" as the subsequent status topic." "CAMPBELL - Prepares the result file for a subsequent Campbell diagramof a prestressed structure. 
CAMPBELL, Action" "CBDOF - Activates cut-boundary interpolation (for submodeling).
CBDOF, Fname1, Ext1, --, Fname2, Ext2, --, KPOS, Clab, KSHS, TOLOUT, TOLHGT, TOLTHK" "CBMD - Specifies preintegrated section mass matrix for composite-beamsections.
CBMD, ROW, C(R)(R) , C(R)(R+1) , C(R)(R+2) , C(R)(R+3) , C(R)(R+4) , C(R)(R+5)" "CBMX - Specifies preintegrated cross-section stiffness for compositebeam sections.
CBMX, ROW, S(R)(R) , S(R)(R+1) , S(R)(R+2) , S(R)(R+3) , S(R)(R+4) , S(R)(R+5) , S(R)(R+6)" "CBTE - Specifies a thermal expansion coefficient for a compositebeam section. 
...
CDOPT, Option" "CDREAD - Reads a file of solid model and database information intothe database.
CDREAD, Option, Fname, Ext, --, Fnamei, Exti" "CDWRITE - Writes geometry and load database items to a file.
CDWRITE, Option, Fname, Ext, --, Fnamei, Exti, Fmat, --, Key" "CE - Defines a constraint equation relating degrees of freedom.
CE, NEQN, CONST, NODE1, Lab1, C1, NODE2, Lab2, C2, NODE3, Lab3, C3" "CECHECK - Check constraint equations and couplings for rigid bodymotions.
CECHECK, ItemLab, Tolerance, DOF" "CECMOD - Modifies the constant term of a constraint equation during solution.
CECMOD, NEQN, CONST" "CECYCMS - Generates the constraint equations for a multistage cyclic symmetry analysis.
CECYCMS, CycLowNod, CycHighNod, --, KMAP, TOLER, --, KPRINT, UsrNMap" "CEDELE - Deletes constraint equations.
CEDELE, NEQN1, NEQN2, NINC, Nsel" "CEFILTER - Controls the automatic solution termination of models having constraint equations with too many terms.
CEFILTER, TermKey" "CEIMS - Generates constraint equations at the interstage boundary
CEIMS, TOLER, --, Sname1, Sname2, KPRINT, --, --, --, --, IntF1Nod, IntF2Nod" "CEINTF - Generates constraint equations at an interface.
...
CERIG, INDEPEND, DEPEND, Ldof, Ldof2, Ldof3, Ldof4, Ldof5" "CESEL - Selects constraint equations via predefined reference numbers.
CESEL, Type, --,--, VMIN, VMAX, VINC" "CESGEN - Generates a set of constraint equations from existing sets.
CESGEN, ITIME, INC, NSET1, NSET2, NINC" "CFACT - Defines complex scaling factors to be used with operations.
CFACT, RFACTA, IFACTA, RFACTB, IFACTB, RFACTC, IFACTC" "CGLOC - Specifies the origin location of the acceleration coordinatesystem.
CGLOC, XLOC, YLOC, ZLOC" "CGOMGA - Specifies the rotational velocity of the global origin.
CGOMGA, CGOMX, CGOMY, CGOMZ" "CGROW - Specifies crack-growth options in a fracture analysis.
CGROW, Action, Par1, Par2, Par3, Par4" "CHECK - Checks current database items for completeness.
...
CISOL, n, ID, node, Cont, Dtype" "CJUMP - Initiates a cycle-jump analysis.
CJUMP, Option, Input1, Input2, Input3, Input4, Input5, Input6, Input7, Input8" "CLOAD - Initiates a cyclic-loading analysis.
CLOAD, Option, Input1" "CLOCAL - Defines a local coordinate system relative to the active coordinatesystem.
...
CM, Cname, Entity, --, KOPT" "CMACEL - Specifies the translational acceleration of an elementcomponent
CMACEL, CM_NAME, CMACEL_X, CMACEL_Y, CMACEL_Z" "CMATRIX - Performs electrostatic field solutions and calculatesthe self and mutual capacitances between multiple conductors.
CMATRIX, SYMFAC, Condname, NUMCOND, GRNDKEY, Capname" "CMDELE - Deletes a component or assembly definition.
CMDELE, Name" "CMDOMEGA - Specifies the rotational acceleration of an element componentabout a user-defined rotational axis.
...
CMMOD, Cname, Keyword, Value" "CMOMEGA - Specifies the rotational velocity of an element componentabout a user-defined rotational axis.
...
CMSEL, Type, Name, Entity" "CMSFILE - Specifies a list of component mode synthesis (CMS) results filesfor plotting results on the assembly.
CMSFILE, Option, Fname, Ext, CmsKey" "CMSOPT - Specifies component mode synthesis (CMS) analysis options.
CMSOPT, Cmsmeth, NMODE, FREQB, FREQE, Fbddef, FBDVAL, IOkey, --, --, Elcalc, --, Eigmeth, nStartVN" "CMWRITE - Writes node and element components and assemblies to afile.
...
CNVTOL, Lab, VALUE, TOLER, NORM, MINREF" "COMBINE - Combines distributed memory parallel (DMP
...
CPCYC, Lab, TOLER, KCN, DX, DY, DZ, KNONROT, KMID, CEOPT" "CPDELE - Deletes coupled degree of freedom sets.
...
CPLIST, NSET1, NSET2, NINC, Nsel" "CPMERGE - Merges different couple sets with duplicate degrees offreedom into one couple set.
CPMERGE, Lab" "CPNGEN - Defines; modifies; or adds to a set of coupled degrees of freedom.
CPNGEN, NSET, Lab, NODE1, NODE2, NINC" "CPSEL - Selects coupled degree-of-freedom sets via predefined reference numbers.
CPSEL, Type, --,--, VMIN, VMAX, VINC" "CPSGEN - Generates sets of coupled nodes from existing sets.
...
CSLIST, KCN1, KCN2, KCINC" "CSWPLA - Defines a local coordinate system at the origin of the workingplane.
CSWPLA, KCN, KCS, PAR1, PAR2" "CSYS - Activates a previously defined coordinate system.
CSYS, KCN" "CURR2D
CURR2D - Calculates current flow in a 2D conductor." "CUTCONTROL - Controls time-step cutback during a nonlinear solution.
CUTCONTROL, Lab, VALUE, Option" "CVAR - Computes covariance between two quantities.
CVAR, IR, IA, IB, ITYPE, DATUM, Name" "CYCCALC - Calculates results from a cyclic harmonic mode-superpositionanalysis using the specifications defined by CYCSPEC
CYCCALC, FilePrefix, FileFormat, Separator" "CYCFILES - Specifies the data files where results are to be foundfor a cyclic symmetry mode-superposition harmonic analysis.
CYCFILES, FnameRst, ExtRst, FnameRfrq, ExtRfrq" "CYCFREQ - Specifies solution options for a cyclic symmetry mode-superpositionharmonic analysis.
...
CYCOPT, OPTION, Value1, Value2, Value3, Value4, Value5, Value6, Value7" "CYCPHASE - Provides tools for determining minimum and maximum possibleresult values from frequency couplets produced in a modal cyclic symmetryanalysis.
CYCPHASE, TYPE, OPTION" "CYCSPEC - Defines the set of result items for a subsequent CYCCALC
CYCSPEC, LABEL, Node, Item, Comp" "CYL4 - Creates a circular area or cylindrical volume anywhere on theworking plane.
CYL4, XCENTER, YCENTER, RAD1, THETA1, RAD2, THETA2, DEPTH" "CYL5 - Creates a circular area or cylindrical volume by end points.
CYL5, XEDGE1, YEDGE1, XEDGE2, YEDGE2, DEPTH" "CYLIND - Creates a cylindrical volume centered about the working planeorigin.
...
D, Node, Lab, VALUE, VALUE2, NEND, NINC, Lab2, Lab3, Lab4, Lab5, Lab6, MESHFLAG" "DA - Defines degree-of-freedom constraints on areas.
...
DAMORPH, AREA, XLINE, RMSHKY" "DAMPOPT - Sets damped eigensolver options.
DAMPOPT, Option, Value" "DATA - Reads data records from a file into a variable.
DATA, IR, LSTRT, LSTOP, LINC, Name, KCPLX" "DATADEF
DATADEF - Specifies \"Directly defined data status\" as the subsequent statustopic." "DCGOMG - Specifies the rotational acceleration of the global origin.
DCGOMG, DCGOX, DCGOY, DCGOZ" "DCUM - Specifies that DOF constraint values are to be accumulated.
DCUM, Oper, RFACT, IFACT, TBASE" "DDASPEC - Specifies the shock spectrum computation constants forDDAM analysis.
DDASPEC, KeyRef, Shptyp, MountLoc, Deftyp, Amin" "DDELE - Deletes degree-of-freedom constraints.
DDELE, NODE, Lab, NEND, NINC, Rkey, IRSTRTFLAG" "DDOPTION - Sets domain decomposer option for a distributed-memory parallel (DMP) solution
DDOPTION, Decomp, NPROCPERSOL, NUMSOLFORLP" "DEACT
DEACT - Specifies \"Element birth and death\" as the subsequent status topic." "DEFINE
DEFINE - Specifies \"Data definition settings\" as the subsequent statustopic." "DELETE - Specifies sets in the results file to be deleted beforepostprocessing.
DELETE, SET, Nstart, Nend" "DELTIM - Specifies the time step sizes to be used for the currentload step.
...
DETAB, ELEM, Lab, V1, V2, V3, V4, V5, V6" "DFLX - Imposes a uniform magnetic flux B on an edge-element electromagneticmodel.
DFLX, NODE, BX, BY, BZ, BX2, BY2, BZ2" "DFSWAVE - Specifies the incident planar waves with random phasesfor a diffuse sound field.
DFSWAVE, KCN, RADIUS, PSDREF, DENS, SONIC, INCANG, NPARA, SampOpt" "DISPLAY
DISPLAY - Specifies \"Display settings\" as the subsequent status topic." "DJ - Specifies boundary conditions on the components of relativemotion of a joint element.
DJ, ELEM, LABEL, VALUE" "DJDELE - Deletes boundary conditions on the componentsof relative motion of a joint element.
...
DLLIST, LINE" "DMPEXT - Extracts modal damping coefficients in a specified frequency range.
DMPEXT, SMODE, TMODE, Dmpname, Freqb, Freqe, NSTEPS" "DMPOPTION - Specifies distributed-memory parallel (DMP
DMPOPTION, FileType, Combine, ResCombFreq, DeleOpt" "DMPRAT - Sets a modal damping ratio.
...
DNSOL, NODE, Item, Comp, V1, V2, V3, V4, V5, V6, DataKey" "DOF - Adds degrees of freedom to the current DOF set.
...
DSCALE, RFACT, IFACT, TBASE" "DSPOPTION - Sets memory option for the sparse solver.
DSPOPTION, Reord_Option, Memory_Option, Memory_Size, --, --, Solve_Info" "DSUM - Specifies the double sum mode combination method.
DSUM, SIGNIF, Label, TD, ForceType" "DSYM - Specifies symmetry or antisymmetry degree-of-freedomconstraints on nodes.
DSYM, Lab, Normal, KCN" "DSYS - Activates a display coordinate system for geometry listings andplots.
DSYS, KCN" "DTRAN
DTRAN - Transfers solid model DOF constraints to the finite element model." "DUMP - Dumps the contents of a binary file.
DUMP, NSTRT, NSTOP" "DVAL - Defines values at enforced motionbase.
...
DYNOPT - Specifies \"Dynamic analysis options\" as the subsequent statustopic." "E - Defines an element by node connectivity.
E, I, J, K, L, M, N, O, P" "EALIVE - Reactivates an element (for the birth and death capability).
EALIVE, ELEM" "ECPCHG
ECPCHG - Optimizes degree-of-freedom usage in a coupled acousticmodel." "EDELE - Deletes selected elements from the model.
EDELE, IEL1, IEL2, INC" "EEMBED
EEMBED - Generates bonded connections between intersecting elements." "EEXTRUDE - Extrudes 2D plane elements into 3D solids during a 2D to 3D analysis.
EEXTRUDE, Action, NELEM, SPACE, DIST, THETA, TFACT , –, BCKEY" "EGEN - Generates elements from an existing pattern.
EGEN, ITIME, NINC, IEL1, IEL2, IEINC, MINC, TINC, RINC, CINC, SINC, DX, DY, DZ" "EGID - Specifies a global identifier for a set of MESH200
...
EKILL, ELEM" "ELBOW - Specifies degrees of freedom to be coupled for end releaseand applies section constraints to elbow elements.
...
EMAGERR - Calculates the relative error in an electrostatic or electromagneticfield analysis." "EMATWRITE - Forces the writing of all the element matrices to Jobname.emat
EMATWRITE, Key" "EMF
EMF - Calculates the electromotive force (emf); or voltage drop alonga predefined path." "EMFT
EMFT - Summarizes electromagnetic forces and torques." "EMID - Adds or removes midside nodes.
EMID, Key, Edges" "EMIS - Specifies emissivity as a material property for the RadiationMatrix method.
...
EMSYM, NSECT" "EMTGEN - Generates a set of TRANS126
...
ENDRELEASE, --, TOLERANCE, Dof1, Dof2, Dof3, Dof4, KJCT, KCHECK" "ENERSOL - Specifies the total energies to be stored.
...
EREINF, KOffALim, KTri" "ERESX - Specifies extrapolation of integration-point results.
...
ESORT, Item, Lab, ORDER, KABS, NUMB" "ESTIF - Specifies the matrix multiplier for deactivated elements.
ESTIF, KMULT" "ESURF - Generates elements overlaid on the free faces of selectednodes.
...
EXBOPT, OUTINV2, OUTTCMS, OUTSUB, OUTCMS, OUTCOMP, OUTRM, NOINV, OUTELE" "EXOPTION - Specifies the EXPROFILE
...
EXPASS, Key, --, --, KeyStat" "EXPROFILE - Exports Mechanical APDL interface data on selected nodes to an Ansys CFX or Ansys Fluent Profile file.
EXPROFILE, Ldtype, Load, VALUE, Pname, Fname, Fext, Fdir" "EXPSOL - Specifies the solution to be expanded for mode-superpositionanalyses or substructure analyses.
EXPSOL, LSTEP, SBSTEP, TIMFRQ, Elcalc" "EXTOPT - Controls options relating to the generation of volume elementsfrom area elements.
...
EXUNIT, Ldtype, Load, Untype, Name" "F - Defines force loads at nodes.
F, Node, Lab, VALUE, VALUE2, NEND, NINC, –, –, MESHFLAG" "FC - Provides failure criteria information and activates adata table to input temperature-dependent stress and strain limits.
FC, MAT, Lab1, Lab2, DATA1, DATA2, DATA3, DATA4, DATA5, DATA6" "FCCHECK
FCCHECK - Checks both the strain and stress input criteria for all materials." "FCDELE - Deletes previously defined failure criterion data forthe given material.
...
FESURF - Specifies \"Surface loads on elements\" as the subsequent statustopic." "FILE - Specifies the data file where results are to be found.
...
FITEM, NFIELD, ITEM, ITEMY, ITEMZ" "FJ - Specify forces or moments on the components of the relative motionof a joint element.
FJ, ELEM, LABEL, VALUE" "FJDELE - Deletes forces (or moments) on the components of the relativemotion of a joint element.
...
FLST, NFIELD, NARG, TYPE, Otype, LENG" "FLUREAD - Reads one-way Fluent-to-Mechanical APDL coupling datavia a .cgns
...
FORM, Lab" "FREQ - Defines the frequency points for the SV
...
FSSECT, RHO, NEV, NLOD, KBR" "FSSPARM - Calculates reflection and transmission properties of afrequency selective surface.
FSSPARM, PORT1, PORT2" "FSUM - Sums the nodal force and moment contributions of elements.
FSUM, LAB, ITEM" "FTRAN
FTRAN - Transfers solid model forces to the finite element model." "FTYPE - Specifies the file type and pressure type for the subsequentimport of source points and pressures.
FTYPE, FileType, PresType" "FVMESH - Generates nodes and tetrahedral volume elements from detachedexterior area elements (facets).
FVMESH, KEEP" "GAUGE - Gauges the problem domain for a magnetic edge-elementformulation.
GAUGE, Opt, FREQ" "GCDEF - Defines interface interactions between general contactsurfaces.
...
GENOPT - Specifies \"General options\" as the subsequent status topic." "GEOM - Defines the geometry specifications for the radiationmatrix calculation.
GEOM, K2D, NDIV" "GEOMETRY
GEOMETRY - Specifies \"Geometry\" as the subsequent status topic." "GMATRIX - Performs electric field solutions and calculates the selfand mutual conductance between multiple conductors.
...
GRP, SIGNIF, Label, --, ForceType" "GSBDATA - Specifies the constraints or applies the load at the ending pointfor generalized plane strain option.
GSBDATA, LabZ, VALUEZ, LabX, VALUEX, LabY, VALUEY" "GSGDATA - Specifies the reference point and defines the geometry in thefiber direction for the generalized plane strain element option.
GSGDATA, LFIBER, XREF, YREF, ROTX0, ROTY0" "GSLIST - When using generalized plane strain; lists the input data or solutions.
GSLIST, Lab" "GSSOL - Specifies which results to store from the results file when usinggeneralized plane strain.
...
HBMAT, Fname, Ext, --, Form, Matrx, Rhs, Mapping" "HBMOPT - Specifies solution options for a harmonic balance method (HBM) analysis.
HBMOPT, Option, Value1, Value2, Value3, Value4, Value5" "HELP - Displays help information for Mechanical APDL commands and element types.
HELP, Name" "HEMIOPT - Specifies options for Hemicube view factor calculation.
HEMIOPT, HRES, TOLERANCE" "HFANG - Defines or displays spatial angles of a spherical radiationsurface for sound radiation parameter calculations.
HFANG, Lab, PHI1, PHI2, THETA1, THETA2" "HFSYM - Indicates the presence of symmetry planes for the computationof acoustic fields in the near and far field domains (beyond the finiteelement region).
...
HPTDELETE, NP1, NP2, NINC" "HRCPLX - Computes and stores in the database the time-harmonicsolution at a prescribed phase angle.
HRCPLX, LOADSTEP, SUBSTEP, OMEGAT, 1STLCASE, 2NDLCASE" "HREXP - Specifies the phase angle for the harmonic analysis expansionpass.
...
HROPT, Method, Value1, Value2, Value3, Value4, Value5" "HROUT - Specifies the harmonic analysis output options.
HROUT, Reimky, Clust, Mcont, EngCalc" "IC - Specifies initial conditions at nodes.
IC, NODE, Lab, VALUE, VALUE2,NEND, NINC, LSIC" "ICDELE
...
ICROTATE, NODE, OMEGA, X1, Y1, Z1, X2, Y2, Z2, Vx, Vy, Vz, ACCEL" "IGESIN - Transfers IGES data from a file into Mechanical APDL.
IGESIN, Fname, Ext, --" "IGESOUT - Writes solid model data to a file in IGES Version 5.1format.
...
INRTIA - Specifies \"Inertial loads" "INT1 - Integrates a variable.
...
IRLF, KEY, PrintFreq, RampKey" "IRLIST
IRLIST - Prints inertia relief summary table." "JPEG - Provides JPEG file export for Mechanical APDL displays. 
JPEG, Keyword, OPT" "JSOL - Specifies result items to be stored forthe joint element.
...
KBETW, KP1, KP2, KPNEW, Type, VALUE" "KCENTER - Creates a keypoint at the center of a circular arc defined bythree locations.
...
KPLOT, NP1, NP2, NINC, Lab" "KPSCALE - Generates a scaled set of (meshed) keypoints from a pattern ofkeypoints.
KPSCALE, NP1, NP2, NINC, RX, RY, RZ, KINC, NOELEM, IMOVE" "KREFINE - Refines the mesh around specified keypoints.
KREFINE, NP1, NP2, NINC, LEVEL, DEPTH, POST, RETAIN" "KRYOPT - Specifies solution options for a Krylov method harmonic analysis.
KRYOPT, MAXDIM, --,--, RESTOL, OrthTol" "KSCALE - Generates a scaled pattern of keypoints from a given keypointpattern.
...
LANBOPTION, StrmCk, --, AltMeth, Memory_Option" "LANG - Generates a straight line at an angle with a line.
...
LDRAG, NK1, NK2, NK3, NK4, NK5, NK6, NL1, NL2, NL3, NL4, NL5, NL6" "LDREAD - Reads results from the results file and applies them asloads.
...
LFILLT, NL1, NL2, RAD, PCENT" "LFSURF - Generates surface elements overlaid on the edge of existing solidelements and assigns the extra node as the closest fluid element node.
...
LREFINE, NL1, NL2, NINC, LEVEL, DEPTH, POST, RETAIN" "LREVERSE - Reverses the normal of a line; regardless of its connectivityor mesh status.
LREVERSE, LNUM, NOEFLIP" "LROTAT - Generates circular lines by rotating a keypoint pattern aboutan axis.
...
LSBV, NL, NV, SEPO, KEEPL, KEEPV" "LSBW - Subtracts the intersection of the working plane from lines (divideslines).
...
LSSOLVE, LSMIN, LSMAX, LSINC" "LSTR - Defines a straight line irrespective of the active coordinatesystem.
LSTR, P1, P2" "LSUM
...
LWPLAN, WN, NL1, RATIO" "M - Defines master degrees of freedom (MDOFs) for superelement generation analyses.
M, NODE, Lab1, NEND, NINC, Lab2, Lab3, Lab4, Lab5, Lab6, SUPPORT" "MACOPT - Specifies modal assurance criterion (MAC) or frequency response function (FRF) correlation criteria calculation options for RSTMAC
MACOPT, Option, Value1, Value2, Value3" "MAGOPT - Specifies options for a 3D magnetostatic field analysis.
MAGOPT, Value" "MAGSOLV - Specifies magnetic solution options and initiates thesolution.
MAGSOLV, OPT, NRAMP, CNVCSG, CNVFLUX, NEQIT, BIOT,CNVTOL" "MAP - Maps pressures from source points to target surface elements.
MAP, --, kDIM, --, kOUT, LIMIT" "MAP2DTO3D - Initiates a 2D to 3D analysis and maps variables.
MAP2DTO3D, Action, VALUE1, VALUE2" "MAPSOLVE - Maps solved node and element solutions from an originalmesh to a new mesh.
MAPSOLVE, MAXSBSTEP" "MAPVAR - Defines tensors and vectors in user-defined state variablesfor rezoning and in 2D to 3D analyses.
...
MAT, MAT" "MATER
MATER - Specifies \"Material properties\" as the subsequent status topic." "MAXCYCMODE - Computes the maximum results value of cyclic mode pairs at the same frequency or the amplitude of a single complex mode.
MAXCYCMODE, LSTEP1, SBSTEP1, Cmp1x1, LSTEP2, SBSTEP2, Cmp1x2, Comp, Numsect" "MCFOPT - Specifies options for the Modal Coordinates File (Jobname.mcf
MCFOPT, Format, Type, Norm" "MCHECK - Checks mesh connectivity.
...
MDELE, NODE, Lab1, NEND, NINC, Lab2, Lab3, Lab4, Lab5, Lab6, SUPPORT" "MDPLOT - Plots frequency-dependent modal damping coefficients calculatedby DMPEXT.
MDPLOT, Function, Dmpname, Scale" "MEMM - Allows the current session to keep allocated memory 
MEMM, Lab, Keyword" "MESHING
MESHING - Specifies \"Meshing\" as the subsequent status topic." "MGEN - Generates additional MDOF from a previously defined set.
MGEN, ITIME, INC, NODE1, NODE2, NINC" "MIDTOL - Sets midstep residual criterion values for structural transientanalyses.
...
MOVE, NODE, KC1, X1, Y1, Z1, KC2, X2, Y2, Z2" "MP - Defines a linear material property as a constant or afunction of temperature.
MP, Lab, MAT, C0, C1, C2, C3, C4" "MPAMOD - Modifies temperature-dependent secant coefficients of thermalexpansion.
MPAMOD, MAT, DEFTEMP" "MPCHG - Changes the material number attribute of an element.
MPCHG, MAT, ELEM" "MPCOPY - Copies linear material model data from one material referencenumber to another.
MPCOPY, --, MATF, MATT" "MPDATA - Defines property data to be associated with the temperaturetable.
...
MPTRES, Lab, MAT" "MPWRITE - Writes linear material properties in the database to a file (ifthe LIB option is not specified) or writes both linear and nonlinear materialproperties (if LIB is specified) from the database to a file.
...
MSAVE, Key" "MSHAPE - For elements that support multiple shapes; specifies the elementshape to be used for meshing.
MSHAPE, KEY, Dimension" "MSHCOPY - Simplifies the generation of meshes that have matching node elementpatterns on two different line groups (in 2D) or area groups (3D).
MSHCOPY, KEYLA, LAPTRN, LACOPY, KCN, DX, DY, DZ, TOL, LOW, HIGH" "MSHKEY - Specifies whether free meshing or mapped meshing should be usedto mesh a model.
...
MSOLVE, NUMSLV, VAL1, VAL2, Lab, ANGFIX" "MSOPT - Specifies solution options for a multistage cyclic symmetry analysis.
MSOPT, Option, Sname, Value1, Value2, Value3, Value4, Value5, Value6, Value7" "MSTOLE - Adds two extra nodes from FLUID116
...
NDIST, ND1, ND2" "NDSURF - Generates surface elements overlaid on the edge of existing elementsand assigns the extra node as the closest fluid element node.
NDSURF, Snode, Telem, DIMN" "NEQIT - Specifies the maximum number of equilibrium iterationsfor nonlinear analyses.
NEQIT, NEQIT, FORCEkey" "NFORCE - Sums the nodal forces and moments of elements attachedto nodes.
...
NLADAPTIVE, Component, Action, Criterion, Option, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6, VAL7" "NLDIAG - Sets nonlinear diagnostics functionality.
NLDIAG, Label, Key, MAXFILE" "NLDPOST - Gets element component information from nonlinear diagnosticfiles.
NLDPOST, Label, Key, FileID, Prefix" "NLGEOM - Includes large-deflection effects in a static or fulltransient analysis.
...
NLMESH, Control, VAL1, VAL2, VAL3" "NLOG - Forms the natural log of a variable.
NLOG, IR, IA, --, --, Name, --, --, FACTA, FACTB" "NLOPT
NLOPT - Specifies \"Nonlinear analysis options\" as the subsequent statustopic." "NMODIF - Modifies an existing node.
NMODIF, NODE, X, Y, Z, THXY, THYZ, THZX" "NODES
NODES - Specifies \"Nodes\" as the subsequent status topic." "NOOFFSET - Prevents the CDREAD
...
NREFINE, NN1, NN2, NINC, LEVEL, DEPTH, POST, RETAIN" "NRLSUM - Specifies the Naval Research Laboratory (NRL) sum modecombination method.
NRLSUM, SIGNIF, Label, LabelCSM, ForceType" "NROPT - Specifies the Newton-Raphson options in a static or fulltransient analysis.
...
NSLV, Type, NKEY" "NSMASS - Applies nonstructural mass to selected elements.
NSMASS, Elem, Action, UNIT, VAL, DISTRB" "NSMOOTH - Smooths selected nodes among selected elements.
...
NSTORE, TINC" "NSUBST - Specifies the number of substeps to be taken this loadstep.
NSUBST, NSBSTP, NSBMX, NSBMN, Carry" "NSVR - Defines the number of variables for user-programmable elementoptions.
...
NUMCMP, Label" "NUMEXP - Specifies solutions to be expanded from mode-superpositionanalyses or substructure analyses.
...
OPERATE - Specifies \"Operation data\" as the subsequent status topic." "OPNCONTROL - Sets decision parameter for automatically increasing the time step interval in a pure thermal analysis
OPNCONTROL, Lab, VALUE, NUMSTEP" "OSRESULT - Controls the selected result data written to the database.
OSRESULT, Item, Comp, Freq, Cname" "OUTAERO - Outputs the superelement matrices and load vectors to formattedfiles for aeroelastic analysis.
...
OUTRES, Item, Freq, Cname, -- , NSVAR, DSUBres" "PADELE - Deletes a defined path.
...
PAUSE - Temporarily releases the current product license." "PCALC - Forms additional labeled path items by operating on existing pathitems.
PCALC, Oper, LabR, Lab1, Lab2, FACT1, FACT2, CONST" "PCGOPT - Controls PCG solver options.
PCGOPT, Lev_Diff, Fallback, ReduceIO, StrmCk, Wrtfull, LM_Key" "PCIRC - Creates a circular area centered about the working plane origin.
PCIRC, RAD1, RAD2, THETA1, THETA2" "PCROSS - Calculates the cross product of two path vectors along the currentpath.
PCROSS, LabXR, LabYR, LabZR, LabX1, LabY1, LabZ1, LabX2, LabY2, LabZ2" "PDEF - Interpolates an item onto a path.
PDEF, Lab, Item, Comp, Avglab" "PDOT - Calculates the dot product of two path vectors along the currentpath.
PDOT, LabR, LabX1, LabY1, LabZ1, LabX2, LabY2, LabZ2" "PERBC2D - Generates periodic constraints for 2D planar magnetic field analyses.
PERBC2D, LOC1, LOC2, LOCTOL, R1, R2, TOLR, OPT, PLNOPT" "PERTURB - Sets linear perturbation analysis options.
PERTURB, Type, MatKey, ContKey, LoadControl" "PFACT - Calculates participation factors for the PSD or multi-pointresponse spectrum table.
PFACT, TBLNO, Excit, Parcor" "PIVCHECK - Controls the behavior of an analysis when a negative orzero equation solver pivot value is encountered.
PIVCHECK, KEY, PRNTCNTRL" "PLAS - Plots a specified acoustic quantity during postprocessing of an acoustic analysis.
PLAS, Lab, LDSTEP, SUBSTEP, FREQB, FREQE, LogOpt, PlotType, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6" "PLCAMP - Plots Campbell diagram data for applications involvingrotating structure dynamics.
PLCAMP, Option, SLOPE, UNIT, FREQB, Cname, STABVAL, KeyAllFreq, KeyNegFreq" "PLCFREQ - Plots the frequency response for the given CYCSPEC
PLCFREQ, SPEC, SECTbeg, SECTend" "PLCHIST - Plots a histogram of the frequency response of each sectorfor the given CYCSPEC
PLCHIST, SPEC, FREQpt" "PLCINT - Plots the fracture parameter (CINT
...
PLESOL, Item, Comp, KUND, Fact, AVG" "PLETAB - Displays element table items.
...
PLFAR, Lab, Option, VAR1B, VAR1E, NVAR1, VAR2B, VAR2E, NVAR2, VAL1, VAL2, VAL3, VAL4, VAL5, LDSTEP, SUBSTEP, FREQB, FREQE, PlotType, LogOpt" "PLGEOM - Plots target and source geometries.
PLGEOM, Item, NODEkey" "PLLS - Displays element table items as contoured areas alongelements.
PLLS, LabI, LabJ, Fact, KUND,ViewUP" "PLMAP - Plots target and source pressures.
PLMAP, Item, --, NODEkey, ImagKey" "PLMC - Plots the modal coordinates from a mode-superpositionsolution.
PLMC, LSTEP, SBSTEP, TIMFRQ, KIMG, HIbeg, HIend" "PLNEAR - Plots the pressure in the near zone exterior to the equivalentsource surface.
...
PLNSOL, Item, Comp, KUND, Fact, FileID, Avg, DataKey" "PLORB
...
PLTRAC, Analopt, Item, Comp, TRPNum, Name, MXLOOP, TOLER, --, ESCL, MSCL" "PLVAR - Displays up to ten variables in the form of a graph.
...
PLZZ, RotVel, DeltaRotVel" "PMAP - Creates mapping of the path geometry by defining path interpolationdivision points.
...
PMLOPT, PSYS, Lab, Xminus, Xplus, Yminus, Yplus, Zminus, Zplus, WOptXm, WOptXp, WOptYm, WOptYp, WOptZm, WOptZp" "PMLSIZE - Determines number of PML or IPML layers.
PMLSIZE, FREQB, FREQE, DMIN, DMAX, THICK, ANGLE, WAVESPEED" "PNGR - Provides PNG file export for Mechanical APDL displays. 
PNGR, Keyword, OPT, VAL" "POINT
POINT - Specifies \"Point flow tracing settings\" as the subsequent statustopic." "POLY
POLY - Creates a polygonal area based on working plane coordinate pairs." "POWERH
POWERH - Calculates the rms power loss in a conductor or lossydielectric." "PPATH - Defines a path by picking or defining nodes; or locations on thecurrently active working plane; or by entering specific coordinate locations.
...
PRAS, Lab, LDSTEP, SUBSTEP, FREQB, FREQE, LogOpt, --, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6" "PRCAMP - Prints Campbell diagram data for applications involvingrotating structure dynamics.
PRCAMP, Option, SLOPE, UNIT, FREQB, Cname, STABVAL, KeyALLFreq, KeyNegFreq, KeyWhirl" "PRCINT - Lists fracture parameter (CINT
...
PRED, Sskey, --, Lskey" "PRENERGY - Prints the total energies of a model or the energies of the specifiedcomponents. 
...
PRFAR, Lab, Option, VAR1B, VAR1E, NVAR1, VAR2B, VAR2E, NVAR2, VAL1, VAL2, VAL3, VAL4, VAL5, LDSTEP, SUBSTEP, FREQB, FREQE, PrintType, LogOpt" "PRI2 - Creates a polygonal area or a prism volume by vertices (GUI).
...
PRMC, LSTEP, SBSTEP, TIMFRQ, KIMG, HIbeg, HIend, Matrix" "PRNEAR - Prints the pressure in the near zone exterior to the equivalentsource surface.
...
PRNSOL, Item, Comp, --, --, --, Avg, DataKey" "PROD - Multiplies variables.
PROD, IR, IA, IB, IC, Name, --, --, FACTA, FACTB, FACTC" "PRORB - Prints the orbital motion characteristics of a rotatingstructure
PRORB, WhrlNodKey" "PRPATH - Prints path items along a geometry path.
PRPATH, Lab1, Lab2, Lab3, Lab4, Lab5, Lab6" "PRRFOR - Prints the constrained node reaction solution. Used withthe FORCE
PRRFOR, Lab" "PRRSOL - Prints the constrained node reaction solution.
PRRSOL, Lab" "PRSCONTROL - Specifies whether to include pressure load stiffness inthe element stiffness formation.
...
PSCONTROL, Option, Key" "PSDCOM - Specifies the power spectral density mode combinationmethod.
PSDCOM, SIGNIF, COMODE, , ForceType" "PSDFRQ - Defines the frequency points for the input spectrum tablesPSDVAL vs. PSDFRQ for PSD analysis.
PSDFRQ, TBLNO1, TBLNO2, FREQ1, FREQ2, FREQ3, FREQ4, FREQ5, FREQ6, FREQ7" "PSDGRAPH - Displays input PSD curves.
PSDGRAPH, TBLNO1, TBLNO2, DisplayKey" "PSDRES - Controls solution output written to the results file froma PSD analysis.
...
PSEL, Type, Pname1, Pname2, Pname3, Pname4, Pname5, Pname6, Pname7, Pname8, Pname9, Pname10" "PSMAT - Writes an assembled global matrix to a postscript formatthat graphically displays nonzero matrix values.
PSMAT, Fname, Ext, Matrix, Color" "PSMESH - Creates and meshes a pretension section (PRETS179
PSMESH, SECID, Name, P0, Egroup, NUM, KCN, KDIR, VALUE, NDPLANE, PSTOL, PSTYPE, ECOMP, NCOMP" "PSTRES - Specifies whether prestress effects are calculated orincluded.
...
RADOPT, --, FLUXTOL, SOLVER, MAXITER, TOLER, OVERRLEX, --, --, --, --, MAXFLUXITER , CONSERVATION" "RAPPND - Appends results data from the database to the results file. 
RAPPND, LSTEP, TIME" "RATE - Specifies whether the effect of creep strain rate will be usedin the solution of a load step.
RATE, Option" "RBE3 - Distributes the force/moment applied at an independent node to a set of dependent nodes. 
RBE3, INDEPEND, DOF, Depend, Wtfact" "RCON
RCON - Specifies \"Real constants\" as the subsequent status topic. " "RCYC - Calculates cyclic results for a mode-superposition harmonicsolution.
...
RECTNG, X1, X2, Y1, Y2" "REMESH - Specifies the starting and ending remeshing points; andother options; for rezoning.
REMESH, Action, Filename, Ext, --, Opt1, Opt2" "RESCOMBINE - Reads results from local results files into the database after a distributed-memory parallel solution.
...
RLIST, NSET1, NSET2, NINC" "RMFLVEC
RMFLVEC - Writes eigenvectors of fluid nodes to a file for use in dampingparameter extraction." "RMODIF - Modifies real constant sets.
RMODIF, NSET, STLOC, V1, V2, V3, V4, V5, V6" "RMORE - Adds real constants to a set. 
RMORE, R7, R8, R9, R10, R11, R12" "ROCK - Specifies a rocking response spectrum. 
ROCK, CGX, CGY, CGZ, OMX, OMY, OMZ" "ROSE - Specifies the Rosenblueth mode combination method.
ROSE, SIGNIF, Label, TD, ForceType" "RPOLY - Creates a regular polygonal area centered about the working planeorigin. 
RPOLY, NSIDES, LSIDE, MAJRAD, MINRAD" "RPR4 - Creates a regular polygonal area or prism volume anywhere on theworking plane. 
RPR4, NSIDES, XCENTER, YCENTER, RADIUS, THETA, DEPTH" "RPRISM - Creates a regular prism volume centered about the working planeorigin. 
...
RSMESH, P0, RID, KCN, Kdir, VALUE, NDPLANE, PSTOL, Ecomp" "RSOPT - Creates or loads the radiosity mapping data file for SURF251
RSOPT, Opt, Filename, Ext, Dir" "RSPLIT - Creates one or more results file(s) from the current resultsfile based on subsets of elements.
RSPLIT, Option, Label, Name1, Name2, Name3, Name4, Name5, Name6, Name7, Name8, Name9, Name10, Name11, Name12, Name13, Name14, Name15, Name16" "RSTCONTROL - Controls whether element single value results are written to the results file.
RSTCONTROL, Type, Cname, Method, MethodItem" "RSTMAC - Calculates modal assurance criterion (MAC/FRF) and matches nodal solutions from two results files or from one results file and one universal format file.
...
RSYMM, Option, CS, Axis, NSECT, CONDVALUE, SVAL, EVAL" "RSYS - Activates a coordinate system for printout or displayof element and nodal results. 
...
SBCTRAN - Transfers solid model loads and boundary conditions to the FEmodel." "SCOPT - Specifies System Coupling options.
SCOPT, TempDepKey, MappingKey" "SDELETE - Deletes sections from the database.
...
SECJOINT, DataType, Val1, Val2, Val3, Val4, Val5, Val6" "SECLOCK - Specifies locks on the components of relative motion in a jointelement.
SECLOCK, dof, MINVALUE, MAXVALUE, dof, MINVALUE, MAXVALUE, dof, MINVALUE, MAXVALUE" "SECMODIF - Modifies a pretension or joint section.
SECMODIF, SECID, Keyword" "SECNUM - Sets the element section attribute pointer.
SECNUM, SECID" "SECOFFSET - Defines the section offset for cross sections.
SECOFFSET, Location, OFFSET1, OFFSET2, CG-Y, CG-Z, SH-Y, SH-Z" "SECPLOT - Plots the geometry of a beam; pipe; elbow; shell; or reinforcing section to scale.
SECPLOT, SECID, VAL1, VAL2, VAL3" "SECREAD - Reads a custom section library or a user-defined section mesh into Mechanical APDL.
SECREAD, Fname, Ext, --, Option" "SECSTOP - Specifies stops on the components of relative motion in a jointelement.
SECSTOP, dof, MINVALUE, MAXVALUE, dof, MINVALUE, MAXVALUE, dof, MINVALUE, MAXVALUE" "SECTYPE - Associates section type information with a section IDnumber.
SECTYPE, SECID, Type, Subtype, Name, REFINEKEY" "SECWRITE - Creates an ASCII file containing user mesh section information.
SECWRITE, Fname, Ext, --, ELEM_TYPE" "SED - Defines the excitation direction for response spectrumand PSD analyses.
SED, SEDX, SEDY, SEDZ, Cname" "SEDLIST - Lists the DOF solution of a superelement after the usepass.
...
SEOPT, Sename, SEMATR, SEPR, SESST, ExpMth, SeOcLvL, --, LPnameKey, SeEdgeKey" "SESYMM - Performs a symmetry operation on a superelement within the usepass.
...
SF, Nlist, Lab, VALUE, VALUE2, – ,MESHFLAG" "SFA - Specifies surface loads on the selected areas.
...
SFCONTROL, KCSYS, LCOMP, VAL1, VAL2, VAL3, KTAPER, KUSE, KAREA, KPROJ, KFOLLOW" "SFCUM - Specifies that surface loads are to be accumulated.
SFCUM, Lab, Oper, FACT, FACT2" "SFDELE - Deletes surface loads.
SFDELE, Nlist, Lab" "SFE - Defines surface loads on elements.
SFE, Elem, LKEY, Lab, KVAL, VALUE1, VALUE2, VALUE3, VALUE4, MESHFLAG" "SFEDELE - Deletes surface loads from elements.
...
SFLDELE, LINE, Lab" "SFLEX - Sets flexibility factors for the currently defined pipeelement section.
...
SFTRAN - Transfer the solid model surface loads to the finite element model." "SHELL - Selects a shell element or shell layer location for resultsoutput.
...
SHSD, RID, Action, CHCH_Opt, CGAP, CPEN" "SLIST - Summarizes the section properties for all defined sectionsin the current session.
...
SMBODY - Specifies \"Body loads on the solid model\" as the subsequent statustopic." "SMCONS
SMCONS - Specifies \"Constraints on the solid model\" as the subsequent statustopic." "SMFOR
SMFOR - Specifies \"Forces on the solid model\" as the subsequent statustopic." "SMIN - Forms an element table item from the minimum of two other items.
SMIN, LabR, Lab1, Lab2, FACT1, FACT2" "SMOOTH - Allows smoothing of noisy data and provides a graphical representationof the data.
SMOOTH, Vect1, Vect2, DATAP, FITPT, Vect3, Vect4, DISP" "SMRTSIZE - Specifies meshing parameters for automatic (smart) elementsizing.
SMRTSIZE, SIZLVL, FAC, EXPND, TRANS, ANGL, ANGH, GRATIO, SMHLC, SMANC, MXITR, SPRX" "SMSURF
SMSURF - Specifies \"Surface loads on the solid model\" as the subsequentstatus topic." "SMULT - Forms an element table item by multiplying two other items.
SMULT, LabR, Lab1, Lab2, FACT1, FACT2" "SNOPTION - Specifies Supernode (SNODE) eigensolver options.
SNOPTION, RangeFact, BlockSize, RobustLev, Compute, --, Solve_Info" "SOLOPTION - Specifies solution transition options.
SOLOPTION, Option, Type, Value" "SOLU - Specifies solution summary data per substep to be stored.
...
SOURCE, X, Y, Z" "SPACE - Defines a space node for radiation using the Radiation Matrixmethod.
...
SPCTEMP, ENCL, TEMP" "SPDAMP - Defines input spectrum damping in a multi-point responsespectrum analysis.
SPDAMP, TBLNO, CURVNO, DampRatio" "SPEC
SPEC - Specifies \"Miscellaneous specifications\" as the subsequent statustopic." "SPFREQ - Defines the frequency points for the input spectrum tables SPVAL
...
SPLINE, P1, P2, P3, P4, P5, P6, XV1, YV1, ZV1, XV6, YV6, ZV6" "SPLOT - Displays the selected areas and a faceted view of their underlyingsurfaces 
SPLOT, NA1, NA2, NINC, MESH" "SPMWRITE - Calculates the state-space matrices and writes them tothe SPM file. 
...
SPOPT, Spectype, NMODE, Elcalc, ModeReuseKey, SpecCum" "SPREAD - Turns on a dashed tolerance curve for the subsequent curve plots.
SPREAD, VALUE" "SPTOPT
SPTOPT - Specifies \"Spectrum analysis options\" as the subsequent statustopic." "SPUNIT - Defines the type of multi-point response spectrum.
...
SQRT, IR, IA, --, --, Name, --, --, FACTA" "SRSS - Specifies the square root of sum of squares mode combinationmethod.
...
SSPA, A11 , A21 , A31 , A22 , A32 , A33 , T" "SSPB - Specifies a preintegrated coupling stiffness for shellsections.
SSPB, B11 , B21 , B31 , B22 , B32 , B33 , T, B12 , B13 , B23" "SSPD - Specifies a preintegrated bending stiffness for shell sections.
SSPD, D11 , D21 , D31 , D22 , D32 , D33 , T" "SSPE - Specifies a preintegrated transverse shear stiffness for shellsections.
...
STORE, Lab, NPTS, --, FREQ, Toler, Cluster" "SUBOPT - Specifies Subspace (SUBSP) eigensolver options.
SUBOPT, Option, Value1" "SUBSET - Reads results for the selected portions of the model.
SUBSET, Lstep, SBSTEP, FACT, KIMG, TIME, ANGLE, NSET" "SUCALC - Create new result data by operating on two existing result datasets on a given surface.
SUCALC, RSetName, lab1, Oper, lab2, fact1, fact2, const" "SUCR - Create a surface.
SUCR, SurfName, SurfType, nRefine, Radius, blank, blank, TolOut" "SUDEL - Delete geometry information as well as any mapped results forspecified surface.
SUDEL, SurfName" "SUEVAL - Perform operations on a mapped item and store result in a scalarparameter.
...
SUMAP, RSetName, Item, Comp" "SUMTYPE - Sets the type of summation to be used in the following load caseoperations.
...
SUPR, SurfName, RSetName" "SURESU - Read a set of surface definitions and result items from a fileand make them the current set. 
...
SUSEL, Type, Name1, Name2, Name3, Name4, Name5, Name6, Name7, Name8" "SUVECT - Create new result data by operating on two existing result vectorson a given surface. 
...
SWLIST, Ecomp" "SYNCHRO - Specifies whether the excitation frequency is synchronousor asynchronous with the rotational velocity of a structure.
SYNCHRO, RATIO, Cname" "TALLOW - Defines the temperature table for safety factor calculations.
TALLOW, TEMP1, TEMP2, TEMP3, TEMP4, TEMP5, TEMP6" "TARGET - Specifies the target nodes for mapping pressures ontosurface effect elements.
TARGET, Nlist" "TB - Activates a data table for material properties or special element input.
TB, Lab, MATID, NTEMP, NPTS, TBOPT, --, FuncName" "TBCOPY - Copies a data table from one materialto another.
...
TBDELE, Lab, MAT1, MAT2, INC, TBOPT" "TBEO - Sets special options or parameters for material data tables.
TBEO, Par, Value" "TBFIELD - Defines values of field variables for material data tables.
TBFIELD, Type, Value" "TBFPLOT - Plots material curve-fitting data.
TBFPLOT, MATID, CurveFitName, EXPDATID, ColX, ColY1, ColY2" "TBFT - Performs material curve-fitting operations.
TBFT, Oper, MATID, Option1, Option2, Option3, Option4, Option5, Option6, Option7, –, –, Option10" "TBIN - Sets parameters used for interpolation of the material data tables.
TBIN, Oper, Par1, Par2, Par3, Par4" "TBLE
TBLE - Specifies \"Data table properties\" as the subsequent statustopic." "TBLIST - Lists the material data tables.
...
TBTEMP, TEMP, KMOD" "TCHG - Converts 20-node degenerate tetrahedral elements to their10-node non-degenerate counterparts.
...
THOPT, Refopt, REFORMTOL, NTABPOINTS, TEMPMIN, TEMPMAX, --, ALGO" "TIFF - Provides TIFF file export for Mechanical APDL displays.
TIFF, Keyword, OPT" "TIME - Sets the time for a load step.
...
TIMINT, Key, Lab" "TIMP - Improves the quality of tetrahedral elements that arenot associated with a volume.
TIMP, ELEM, CHGBND, IMPLEVEL" "TINTP - Defines transient integration parameters.
TINTP, GAMMA, ALPHA, DELTA, THETA, OSLM, TOL, OSLM2, --, AVSMOOTH, ALPHAF, ALPHAM" "TOFFST - Specifies the temperature offset from absolute zero to zero.
...
TRNOPT, Method, MAXMODE, InitialAcc, MINMODE, MCFwrite, TINTOPT, VAout, DMPSFreq, EngCalc, MCkey" "TRPDEL - Deletes charged particle trace points.
TRPDEL, NTRP1, NTRP2, TRPINC" "TRPLIS - Lists charged particle trace points.
TRPLIS, NTRP1, NTRP2, TRPINC, Opt" "TRPOIN - Defines a point through which a charged particle trace will travel.
TRPOIN, X, Y, Z, VX, VY, VZ, CHRG, MASS" "TRTIME - Defines the options used for the PLTRAC
TRTIME, TIME, SPACING, OFFSET, SIZE, LENGTH" "TSHAP - Defines simple 2D and 3D geometric surfaces for target segmentelements.
TSHAP, Shape" "TSRES - Defines an array of key times at which the time-stepping strategychanges.
...
UNDELETE, Option, Nstart, Nend" "UNDO - Enables the user to modify or save commands issued since the last RESUME or SAVE. 
UNDO, Keyword" "UNPAUSE
UNPAUSE - Restores use of a temporarily released product license." "UPCOORD - Modifies the coordinates of the active set of nodes; basedon the current displacements.
UPCOORD, FACTOR, Key" "UPGEOM - Adds displacements from a previous analysis and updates the geometry to the deformed configuration.
UPGEOM, FACTOR, LSTEP, SBSTEP, Fname, Ext, --, UPESYS" "USRCAL - Allows user-solution subroutines to be activated or deactivated.
USRCAL, Rnam1, Rnam2, Rnam3, Rnam4, Rnam5, Rnam6, Rnam7, Rnam8, Rnam9" "USRDOF - Specifies the degrees of freedom for the user-definedelement USER300
...
V, P1, P2, P3, P4, P5, P6, P7, P8" "V2DOPT - Specifies 2D/axisymmetric view factor calculation options.
...
VCROSS, LabXR, LabYR, LabZR, LabX1, LabY1, LabZ1, LabX2, LabY2, LabZ2" "VDDAM - Specifies the velocity spectrum computation constantsfor the analysis of shock resistance of shipboard structures.
...
VEXT, NA1, NA2, NINC, DX, DY, DZ, RX, RY, RZ" "VFCO - Controls the use and level of view factor condensation for symmetric radiation.
VFCO, Action, ENCL, LEVEL" "VFDI - Specifies view factor diagnostic options.
VFDI, Opt, ENCLOSURE, DIAGTYPE, REALDATA1, REALDATA2" "VFOPT - Specifies options for the view factor file and calculates view factors.
VFOPT, Opt, Filename, Ext, Dir, Filetype, Fileformat, WRIO" "VFQUERY - Queries and prints element Hemicube view factors and average view factor.
VFQUERY, SRCELEM, TARELEM, --, WrOpt" "VFSM - Adjusts view factor matrix to satisfy reciprocity and/or row sum properties (view factor smoothing).
VFSM, Action, ENCL, OPT, MAXITER, CONV" "VFUP - Controls view factor updating at the substep level for a coupled-field radiation analysis that includes large-deflection effects.
VFUP, Action, Opt, OPT2, OPT3" "VGEN - Generates additional volumes from a pattern of volumes.
...
VGLUE, NV1, NV2, NV3, NV4, NV5, NV6, NV7, NV8, NV9" "VIMP - Improves the quality of the tetrahedral elements in theselected volume(s).
...
VPUT, Par, IR, TSTRT, KCPLX, Name" "VROTAT - Generates cylindrical volumes by rotating an area pattern aboutan axis.
...
VSBV, NV1, NV2, SEPO, KEEP1, KEEP2" "VSBW - Subtracts intersection of the working plane from volumes (dividesvolumes).
...
VSUM, LAB" "VSWEEP - Fills an existing unmeshed volume with elements by sweeping themesh from an adjacent area through the volume.
...
VTRAN, KCNTO, NV1, NV2, NINC, KINC, NOELEM, IMOVE" "VTYPE - Specifies the viewing procedure used to determine the form factorsfor the Radiation Matrix method.
VTYPE, NOHID, NZONE" "WPAVE - Moves the working plane origin to the average of specified points.
WPAVE, X1, Y1, Z1, X2, Y2, Z2, X3, Y3, Z3" "WPCSYS - Defines the working plane location based on a coordinatesystem.
...
WSPRINGS - Creates weak springs on corner nodes of a bounding boxof the currently selected elements." "WTBCREATE - Creates a USER300
WTBCREATE, IEL, NODE, DAMP" "XFCRKMESH - Defines a crack in the model when the crack surface is discretized by MESH200
XFCRKMESH, EnrichmentID, ElemComp, NodeComp" "XFDATA - Defines a crack in the model by specifying nodal levelset values
XFDATA, EnrichmentID, LSM or -- , ELEMNUM, NODENUM, PHI, PSI" "XFENRICH - Defines parameters associated with crack propagation usingXFEM
...
XVAR, N" "~CAT5IN - Transfers a .CATPart
~CAT5IN, Name, Extension, Path, Entity, FMT, NOCL, NOAN" "~CATIAIN - Transfers a CATIA model into the Mechanical APDL program.
~CATIAIN, Name, Extension, Path, - -, - -, BLANK, - -" "~PARAIN - Transfers a Parasolid file into Mechanical APDL.
~PARAIN, Name, Extension, Path, Entity, FMT, Scale" "~PROEIN - Transfers a Creo Parametric part into Mechanical APDL.
~PROEIN, Name, Extension, Path, Proecomm" "~SATIN - Transfers a .sat
~SATIN, Name, Extension, Path, Entity, FMT, NOCL, NOAN" "~UGIN - Transfers an NX part into Mechanical APDL.
~UGIN, Name, Extension, Path, Entity, LAYER, FMT" "*EVAL - APDL undocumented command
*EVAL" "*MOONEY - APDL undocumented command
*MOONEY" "*PREAD - APDL undocumented command
*PREAD" "/OPT - APDL undocumented command
/OPT" "/PICE - APDL undocumented command
/PICE" "/PMETH - APDL undocumented command
/PMETH" "/RUNST - APDL undocumented command
/RUNST" "/RUNSTAT - APDL undocumented command
/RUNSTAT" "/SSS - APDL undocumented command
/SSS" "/TRACK - APDL undocumented command
/TRACK" "/VERIFY - APDL undocumented command
/VERIFY" "/VT - APDL undocumented command
/VT" "/WB - APDL undocumented command
/WB" "/XML - APDL undocumented command
/XML" "ALPFILL - APDL undocumented command
...
ARSPLIT" "ASLN - APDL undocumented command
ASLN" "BELLOW - APDL undocumented command
BELLOW" "BEND - APDL undocumented command
BEND" "BRANCH - APDL undocumented command
BRANCH" "CECYC - APDL undocumented command
CECYC" "CEWRITE - APDL undocumented command
CEWRITE" "CMBLOCK - APDL undocumented command
CMBLOCK" "CNTR - APDL undocumented command
CNTR" "CRPLIM - APDL undocumented command
CRPLIM" "CWZPLOT - APDL undocumented command
CWZPLOT" "EALL - APDL undocumented command
EALL" "EBLOCK - APDL undocumented command
EBLOCK" "END - APDL undocumented command
END" "EQSLV - APDL undocumented command
EQSLV" "FATIGUE - APDL undocumented command
FATIGUE" "FE - APDL undocumented command
FE" "FELIST - APDL undocumented command
FELIST" "FIPLOT - APDL undocumented command
FIPLOT" "FL - APDL undocumented command
FL" "FLANGE - APDL undocumented command
FLANGE" "FLDATA1-40 - APDL undocumented command
FLDATA1-40" "FLITEM - APDL undocumented command
FLITEM" "FLLIST - APDL undocumented command
FLLIST" "FLOCHECK - APDL undocumented command
FLOCHECK" "FLOTRAN - APDL undocumented command
FLOTRAN" "FLREAD - APDL undocumented command
FLREAD" "FMAGSUM - APDL undocumented command
FMAGSUM" "FP - APDL undocumented command
FP" "FPLIST - APDL undocumented command
FPLIST" "FS - APDL undocumented command
FS" "FSDELE - APDL undocumented command
FSDELE" "FSLIST - APDL undocumented command
FSLIST" "FSNODE - APDL undocumented command
FSNODE" "FSPLOT - APDL undocumented command
FSPLOT" "FTCALC - APDL undocumented command
FTCALC" "FTSIZE - APDL undocumented command
FTSIZE" "FTWRITE - APDL undocumented command
FTWRITE" "GAP - APDL undocumented command
GAP" "GAPF - APDL undocumented command
GAPF" "GAPFINISH - APDL undocumented command
...
GAPPLOT" "GP - APDL undocumented command
GP" "GPDELE - APDL undocumented command
GPDELE" "GPLIST - APDL undocumented command
GPLIST" "HFADP - APDL undocumented command
HFADP" "HFARRAY - APDL undocumented command
HFARRAY" "HFDEEM - APDL undocumented command
HFDEEM" "HFEIGOPT - APDL undocumented command
HFEIGOPT" "HFEREFINE - APDL undocumented command
HFEREFINE" "HFMODPRT - APDL undocumented command
HFMODPRT" "HFPA - APDL undocumented command
HFPA" "HFPCSWP - APDL undocumented command
HFPCSWP" "HFPORT - APDL undocumented command
HFPORT" "HFPOWER - APDL undocumented command
HFPOWER" "HFSCAT - APDL undocumented command
HFSCAT" "ICE - APDL undocumented command
ICE" "ICEDELE - APDL undocumented command
ICEDELE" "ICELIST - APDL undocumented command
ICELIST" "ICVFRC - APDL undocumented command
ICVFRC" "KCALC - APDL undocumented command
KCALC" "LNCOLLAPSE - APDL undocumented command
...
LNSPLIT" "LPRT - APDL undocumented command
LPRT" "LSLN - APDL undocumented command
LSLN" "MITER - APDL undocumented command
MITER" "MSADV - APDL undocumented command
MSADV" "MSCAP - APDL undocumented command
MSCAP" "MSDATA - APDL undocumented command
MSDATA" "MSMASS - APDL undocumented command
MSMASS" "MSMETH - APDL undocumented command
MSMETH" "MSMIR - APDL undocumented command
MSMIR" "MSNOMF - APDL undocumented command
MSNOMF" "MSPROP - APDL undocumented command
MSPROP" "MSQUAD - APDL undocumented command
MSQUAD" "MSRELAX - APDL undocumented command
MSRELAX" "MSSOLU - APDL undocumented command
MSSOLU" "MSSPEC - APDL undocumented command
MSSPEC" "MSTERM - APDL undocumented command
MSTERM" "MSVARY - APDL undocumented command
MSVARY" "NALL - APDL undocumented command
NALL" "NBLOCK - APDL undocumented command
NBLOCK" "NELE - APDL undocumented command
NELE" "OPADD - APDL undocumented command
OPADD" "OPANL - APDL undocumented command
OPANL" "OPCLR - APDL undocumented command
OPCLR" "OPDATA - APDL undocumented command
OPDATA" "OPDEL - APDL undocumented command
OPDEL" "OPEQN - APDL undocumented command
OPEQN" "OPEXE - APDL undocumented command
OPEXE" "OPFACT - APDL undocumented command
OPFACT" "OPFRST - APDL undocumented command
OPFRST" "OPGRAD - APDL undocumented command
OPGRAD" "OPKEEP - APDL undocumented command
OPKEEP" "OPLFA - APDL undocumented command
OPLFA" "OPLGR - APDL undocumented command
OPLGR" "OPLIST - APDL undocumented command
OPLIST" "OPLOOP - APDL undocumented command
OPLOOP" "OPLSW - APDL undocumented command
OPLSW" "OPMAKE - APDL undocumented command
OPMAKE" "OPPRNT - APDL undocumented command
OPPRNT" "OPRAND - APDL undocumented command
OPRAND" "OPRESU - APDL undocumented command
OPRESU" "OPRFA - APDL undocumented command
OPRFA" "OPRGR - APDL undocumented command
OPRGR" "OPRSW - APDL undocumented command
OPRSW" "OPSAVE - APDL undocumented command
OPSAVE" "OPSEL - APDL undocumented command
OPSEL" "OPSUBP - APDL undocumented command
...
OPVAR" "PCONV - APDL undocumented command
PCONV" "PCORRO - APDL undocumented command
PCORRO" "PDRAG - APDL undocumented command
PDRAG" "PEMOPTS - APDL undocumented command
PEMOPTS" "PERI - APDL undocumented command
PERI" "PEXCLUDE - APDL undocumented command
PEXCLUDE" "PFLUID - APDL undocumented command
PFLUID" "PGAP - APDL undocumented command
PGAP" "PGRAPH - APDL undocumented command
PGRAPH" "PGRSET - APDL undocumented command
PGRSET" "PGSAVE - APDL undocumented command
PGSAVE" "PGSELE - APDL undocumented command
PGSELE" "PGWRITE - APDL undocumented command
PGWRITE" "PILECALC - APDL undocumented command
...
PILESTIF" "PINCLUDE - APDL undocumented command
PINCLUDE" "PINSUL - APDL undocumented command
PINSUL" "PIPE - APDL undocumented command
PIPE" "PLCONV - APDL undocumented command
PLCONV" "PLCRACK - APDL undocumented command
PLCRACK" "PLFSS - APDL undocumented command
PLFSS" "PLSCH - APDL undocumented command
PLSCH" "PLSYZ - APDL undocumented command
PLSYZ" "PLTD - APDL undocumented command
PLTD" "PLTLINE - APDL undocumented command
PLTLINE" "PLVAROPT - APDL undocumented command
PLVAROPT" "PLVFRC - APDL undocumented command
PLVFRC" "PLWAVE - APDL undocumented command
PLWAVE" "PMETH - APDL undocumented command
PMETH" "PMOPTS - APDL undocumented command
PMOPTS" "POPT - APDL undocumented command
POPT" "POUTRES - APDL undocumented command
POUTRES" "PPLOT - APDL undocumented command
PPLOT" "PPRANGE - APDL undocumented command
PPRANGE" "PPRES - APDL undocumented command
PPRES" "PRCONV - APDL undocumented command
PRCONV" "PRECISION - APDL undocumented command
PRECISION" "PRSYZ - APDL undocumented command
PRSYZ" "PRVAROPT - APDL undocumented command
PRVAROPT" "PSOLVE - APDL undocumented command
PSOLVE" "PSOLVE - APDL undocumented command
PSOLVE" "PSPEC - APDL undocumented command
PSPEC" "PSPRNG - APDL undocumented command
PSPRNG" "PTEMP - APDL undocumented command
PTEMP" "PUNIT - APDL undocumented command
PUNIT" "QFACT - APDL undocumented command
QFACT" "RALL - APDL undocumented command
RALL" "REDUCE - APDL undocumented command
REDUCE" "RFILSZ - APDL undocumented command
...
RTIMST" "RUN - APDL undocumented command
RUN" "RWFRNT - APDL undocumented command
...
SLSPLOT" "SOLCONTROL - APDL undocumented command
SOLCONTROL" "SPADP - APDL undocumented command
SPADP" "SPARM - APDL undocumented command
SPARM" "SPFSS - APDL undocumented command
SPFSS" "SPICE - APDL undocumented command
SPICE" "SPSCAN - APDL undocumented command
SPSCAN" "SPSWP - APDL undocumented command
SPSWP" "SSTIF - APDL undocumented command
SSTIF" "TEE - APDL undocumented command
TEE" "TOCOMP - APDL undocumented command
TOCOMP" "TODEF - APDL undocumented command
TODEF" "TOEXE - APDL undocumented command
TOEXE" "TOFREQ - APDL undocumented command
TOFREQ" "TOGRAPH - APDL undocumented command
TOGRAPH" "TOLIST - APDL undocumented command
TOLIST" "TOLOOP - APDL undocumented command
TOLOOP" "TOPLOT - APDL undocumented command
TOPLOT" "TOPRINT - APDL undocumented command
TOPRINT" "TOSTAT - APDL undocumented command
TOSTAT" "TOTAL - APDL undocumented command
TOTAL" "TOTYPE - APDL undocumented command
TOTYPE" "TOVAR - APDL undocumented command
TOVAR" "TZAMESH - APDL undocumented command
TZAMESH" "TZDELE - APDL undocumented command
TZDELE" "TZEGEN - APDL undocumented command
TZEGEN" "VALVE - APDL undocumented command
VALVE" "VCVFILL - APDL undocumented command
VCVFILL" "VTCLR - APDL undocumented command
VTCLR" "VTDISC - APDL undocumented command
VTDISC" "VTEVAL - APDL undocumented command
VTEVAL" "VTFREQ - APDL undocumented command
VTFREQ" "VTGEOM - APDL undocumented command
VTGEOM" "VTIN - APDL undocumented command
VTIN" "VTMETH - APDL undocumented command
VTMETH" "VTMP - APDL undocumented command
VTMP" "VTOP - APDL undocumented command
VTOP" "VTPOST - APDL undocumented command
VTPOST" "VTREAL - APDL undocumented command
VTREAL" "VTRFIL - APDL undocumented command
VTRFIL" "VTRSLT - APDL undocumented command
VTRSLT" "VTSEC - APDL undocumented command
VTSEC" "VTSFE - APDL undocumented command
VTSFE" "VTSL - APDL undocumented command
VTSL" "VTSTAT - APDL undocumented command
VTSTAT" "VTTEMP - APDL undocumented command
VTTEMP" "VTVMOD - APDL undocumented command
VTVMOD" "XMLO - APDL undocumented command
XMLO" "XVAROPT - APDL undocumented command
XVAROPT" "~CFIN - APDL undocumented command
~CFIN" "~EUI - APDL undocumented command
~EUI")
"Help strings for the parameters of APDL keywords.")

(defconst apdl-command-regexp
"\\(?:\\*\\(?:A\\(?:BB\\|FU\\|SK\\|XP\\)\\|C\\(?:F[COW]\\|OM\\|RE\\|YC\\)\\|D\\(?:EL\\|IM\\|MA\\|O[TW]?\\|PF\\)\\|E\\(?:IG\\|LSE\\(?:IF\\)?\\|ND\\(?:DO\\|IF\\)?\\|VA\\|X[IP]\\)\\|F\\(?:FT\\|RE\\)\\|G\\(?:ET\\|O\\)\\|HPR\\|I\\(?:F\\|N[IQ]\\|TE\\)\\|KRO\\|L\\(?:IS\\|S[BDEFR]\\)\\|M\\(?:ER\\|F[OU]\\|O[OP]\\|SG\\|UL\\|WR\\)\\|NRM\\|P\\(?:LU\\|R[EI]\\)\\|RE[MNPT]\\|S\\(?:CA\\|ET\\|MA\\|OR\\|RE\\|TA\\)\\|T\\(?:AX\\|OP\\|RE\\)\\|U\\(?:LI\\|SE\\)\\|V\\(?:AB\\|C[OU]\\|E[CD]\\|F[AIU]\\|GE\\|IT\\|LE\\|MA\\|OP\\|P[LU]\\|RE\\|S[CT]\\|WR\\)\\|WRK\\|XPL\\)\\|/\\(?:A\\(?:N[3FGNU]\\|SS\\|U\\(?:T\\|X\\(?:1[25]\\|[23]\\)\\)\\|XL\\)\\|BAT\\|C\\(?:FO\\|L[AEO]\\|MA\\|O\\(?:N[FT]\\|[LMP]\\)\\|PL\\|TY\\|VA\\|WD\\|YC\\)\\|D\\(?:B[DE]\\|E[CLV]\\|FL\\|I[RS]\\|SC\\|V3\\)\\|E\\(?:DG\\|FA\\|NC\\|OF\\|RA\\|SH\\|X[IP]\\)\\|F\\(?:AC\\|C[LO]\\|DE\\|IL\\|O[CR]\\)\\|G\\(?:C[MO]\\|F[IO]\\|LI\\|MA\\|O[LP]?\\|R[AEIOT]\\|S[AT]\\|T[HY]\\)\\|H\\(?:BC\\|EA\\)\\|I\\(?:C[LS]\\|MA\\|N[PQ]\\)\\|L\\(?:AR\\|I[GN]\\|S[PY]\\)\\|M\\(?:AP\\|EN\\|KD\\|PL\\|RE\\|ST\\)\\|N\\(?:ER\\|O[ELPR]\\|UM\\)\\|O\\(?:[PU]T\\)\\|P\\(?:AG\\|B[CF]\\|CI\\|IC\\|LO\\|M[AEO]\\|NU\\|O\\(?:L\\|ST\\(?:1\\|26\\)\\)\\|REP7\\|S[EFPTY]\\|WE\\)\\|QUI\\|R\\(?:AT\\|E[NPS]\\|GB\\|MD\\|UNSTA?\\)\\|S\\(?:E[CG]\\|H[AOR]\\|MB\\|OL\\|S[CS]\\|T[AI]\\|Y[PS]\\)\\|T\\(?:EE\\|IT\\|LA\\|R[AIL]\\|SP\\|XT\\|YP\\)\\|U\\(?:CM\\|DO\\|IS?\\|NI\\|PF\\|SE\\)\\|V\\(?:CO\\|ER\\|IE\\|SC\\|T\\|UP\\)\\|W\\(?:AI\\|B\\|IN\\)\\|X\\(?:FR\\|ML\\|RA\\)\\|YRA\\|ZOO\\)\\|A\\(?:A\\(?:DD\\|TT\\)\\|B\\(?:B[RS]\\|EX\\|S\\)\\|C\\(?:C[AO]\\|EL\\|LE\\)\\|D\\(?:AM\\|DA?\\|EL\\|GL\\|PC\\|RA\\)\\|E\\(?:RO\\|SI\\)\\|F\\(?:IL\\|LI\\|SU\\)\\|G\\(?:EN\\|LU\\)\\|I\\(?:N[APV]\\|RL\\)\\|L\\(?:IS\\|LS\\|P[FH]\\)?\\|M\\(?:AP\\|B[EU]\\|E[NS]\\|MA\\|PO\\|RE\\|S[TU]\\|TY\\)\\|N\\(?:C[NUY]\\|D[ASY]\\|FL\\|HA\\|I[MS]\\|MO\\|OR\\|PR\\|S\\(?:O\\|TOA[QS]\\)\\|T[IY]\\)\\|O\\(?:FF\\|VL\\)\\|P\\(?:LO\\|OR\\|PE\\|TN\\)\\|R\\(?:C[LOT]\\|DE\\|E[AFMV]\\|FI\\|ME\\|OT\\|S[CPY]\\)\\|S\\(?:B[ALVW]\\|CR\\|EL\\|IF\\|KI\\|L[LNV]\\|OL\\|U[BM]\\)\\|T\\(?:AN\\|RA\\|YP\\)\\|UTO\\|V\\(?:PR\\|RE\\)\\|WAV\\)\\|B\\(?:CSO\\|E\\(?:LL\\|ND\\|TA\\)\\|F\\(?:A[DL]\\|CU\\|DE\\|E[CDLS]\\|IN\\|K[DL]\\|L[DIL]\\|PO\\|SC\\|TR\\|UN\\|V[DL]\\|[AEKLV]\\)?\\|IO[OT]\\|L\\(?:C[45]\\|OC\\)\\|O\\(?:OL\\|PT\\)\\|RAN\\|S\\(?:AX\\|M[12D]\\|PL\\|S[12]\\|T[EQ]\\)\\|TOL\\|UCO\\)\\|C\\(?:A\\(?:LC\\|MP\\)\\|B\\(?:DO\\|M[DX]\\|T[EM]\\)\\|D\\(?:OP\\|RE\\|WR\\)\\|E\\(?:C\\(?:YCM?\\|[HM]\\)\\|DE\\|FI\\|I[MN]\\|LI\\|NT\\|QN\\|RI\\|S[EG]\\|WR\\)\\|FAC\\|G\\(?:LO\\|OM\\|RO\\)\\|H\\(?:EC\\|KM\\)\\|I\\(?:NT\\|RC\\|SO\\)\\|JUM\\|L\\(?:O[ACG]\\|RM\\)\\|M\\(?:A[CT]\\|BL\\|D[EO]\\|ED\\|GR\\|LI\\|MO\\|OM\\|PL\\|RO\\|S[EFO]\\|WR\\)\\|N\\(?:CH\\|KM\\|TR\\|VT\\)\\|O\\(?:M[BP]\\|N[4EJ]\\|RI\\|UP\\|VA\\)\\|P\\(?:CY\\|DE\\|IN\\|L[GI]\\|ME\\|NG\\|S[EG]\\)\\|QC\\|RPL\\|S\\(?:CI\\|DE\\|KP\\|LI\\|WP\\|YS\\)\\|U\\(?:RR\\|TC\\)\\|VAR\\|WZP\\|Y\\(?:C\\(?:F[IR]\\|[CLOPS]\\)\\|L[45I]\\)\\|Z\\(?:[DM]E\\)\\|[EMPS]\\)\\|D\\(?:A\\(?:DE\\|LI\\|M[OP]\\|TAD?\\)\\|C\\(?:GO\\|UM\\)\\|D\\(?:AS\\|EL\\|OP\\)\\|E\\(?:AC\\|FI\\|L[ET]\\|MO\\|RI\\|S[IO]\\|TA\\)\\|F\\(?:LX\\|SW\\)\\|ISP\\|J\\(?:DE\\|LI\\)\\|K\\(?:DE\\|LI\\)\\|L\\(?:DE\\|IS\\|LI\\)\\|MP[EORS]\\|NSO\\|O\\(?:FS?\\|ME\\)\\|S\\(?:CA\\|PO\\|UM\\|Y[MS]\\)\\|TRA\\|UMP\\|V\\(?:AL\\|MO\\)\\|YNO\\|[AJKL]\\)\\|E\\(?:AL[IL]\\|BLO\\|CPC\\|DEL\\|E\\(?:MB\\|XT\\)\\|G\\(?:EN\\|ID\\)\\|IN[FT]\\|KIL\\|L\\(?:BO\\|EM\\|IS\\)\\|M\\(?:A[GT]\\|FT?\\|I[DS]\\|O[DR]\\|S[EY]\\|TG\\|UN\\)\\|N\\(?:DR?\\|ER\\|GE\\|OR\\|SY\\)\\|ORI\\|PLO\\|QSLV\\|R\\(?:AS\\|E[AFIS]\\|NO\\|RA\\)\\|S\\(?:CH\\|EL\\|IZ\\|L[ALNV]\\|O[LR]\\|TI\\|UR\\|Y[MS]\\)\\|T\\(?:AB\\|C[HO]\\|DE\\|LI\\|YP\\)\\|USO\\|WRI\\|X\\(?:BO\\|OP\\|P\\(?:A[NS]\\|[RS]\\)?\\|T[OR]\\|UN\\)\\|[NT]\\)\\|F\\(?:ATI\\|C\\(?:CH\\|DE\\|LI\\|TY\\|UM\\)\\|DEL\\|E\\(?:BO\\|CO\\|FO\\|LI\\|SU\\)\\|I\\(?:L\\(?:EAUX[23]\\|LD\\|[EL]\\)\\|NI\\|PL\\|TE\\)\\|J\\(?:DE\\|LI\\)\\|K\\(?:DE\\|LI\\)\\|L\\(?:AN\\|DA\\|I[ST]\\|LI\\|O[CT]\\|RE\\|ST\\|U[RX]\\)\\|MAG\\|OR[CM]\\|PLI\\|R\\(?:EQ\\|QS\\)\\|S\\(?:CA\\|DE\\|LI\\|NO\\|PL\\|S[EP]\\|UM\\)\\|T\\(?:CA\\|RA\\|SI\\|WR\\|YP\\)\\|VME\\|[CEJKLPS]\\)\\|G\\(?:A\\(?:P\\(?:FI\\|[FLMOP]\\)?\\|UG\\)\\|C\\(?:[DG]E\\)\\|E\\(?:NO\\|OME?\\)\\|M\\(?:AT\\|FA\\)\\|P\\(?:DE\\|L[IO]\\)?\\|RP\\|S\\(?:BD\\|GD\\|LI\\|SO\\|UM\\)\\)\\|H\\(?:ARF\\|BM[AO]\\|E\\(?:LP\\|MI\\)\\|F\\(?:A[DNR]\\|DE\\|E[IR]\\|MO\\|P\\(?:O[RW]\\|[AC]\\)\\|S[CY]\\)\\|PT[CD]\\|R\\(?:CP\\|EX\\|O[CPU]\\)\\)\\|I\\(?:C\\(?:DE\\|E[DL]?\\|LI\\|RO\\|VF\\)?\\|GES[IO]\\|M\\(?:AG\\|ES\\|ME\\)\\|N\\(?:IS\\|R[ET]\\|T1\\|VO\\)\\|OPT\\|RL[FI]\\)\\|J\\(?:PEG\\|SOL\\)\\|K\\(?:ATT\\|B\\(?:C\\|ET\\)\\|C\\(?:AL\\|EN\\|LE\\)\\|D\\(?:EL\\|IS\\)\\|E\\(?:EP\\|SI\\|Y[OPW]\\)\\|FIL\\|GEN\\|L\\(?:IS\\)?\\|M\\(?:ES\\|O[DV]\\)\\|NOD\\|P\\(?:LO\\|SC\\)\\|R\\(?:EF\\|YO\\)\\|S\\(?:C[AO]\\|EL\\|L[LN]\\|[UY]M\\)\\|TRA\\|USE\\|WP[AL]\\)\\|L\\(?:2\\(?:AN\\|TA\\)\\|A\\(?:N[BG]\\|R[CEG]\\|TT\\|Y\\(?:ERP?\\|[LP]\\)\\)\\|C\\(?:A[BS]\\|CA[LT]\\|DE\\|F[AI]\\|LE\\|O[MP]\\|S[ELU]\\|WR\\|ZE\\)\\|D\\(?:EL\\|IV\\|R[AE]\\)\\|E\\(?:SI\\|XT\\)\\|F\\(?:IL\\|SU\\)\\|G\\(?:EN\\|LU\\|WR\\)\\|I\\(?:N\\(?:ES\\|[AELPV]\\)\\|ST\\)\\|LIS\\|MES\\|N\\(?:CO\\|DE\\|FI\\|ME\\|S[PR]\\)\\|O\\(?:CA\\|VL\\)\\|P\\(?:LO\\|RT\\|TN\\)\\|R\\(?:E[FV]\\|OT\\)\\|S\\(?:B[ALVW]\\|CL\\|DE\\|EL\\|L[AKN]\\|OP\\|RE\\|S[CO]\\|TR\\|UM\\|WR\\|YM\\)\\|T\\(?:AN\\|RA\\)\\|UMP\\|VSC\\|WPL\\)\\|M\\(?:A\\(?:CO\\|G[OS]\\|P[2SV]\\|S[CT]\\|TE\\|XC\\|[PT]\\)\\|C\\(?:FO\\|HE\\)\\|D\\(?:AM\\|[EP]L\\)\\|E\\(?:MM\\|SH\\)\\|GEN\\|I\\(?:DT\\|TE\\)\\|LIS\\|M\\(?:AS\\|F\\)\\|O\\(?:D[CDEIMOS]\\|NI\\|PT\\|RP\\|VE\\)\\|P\\(?:AM\\|C[HO]\\|D[AER]\\|LI\\|PL\\|R[EI]\\|T[EGR]\\|WR\\)?\\|RPM\\|S\\(?:A[DV]\\|CA\\|DA\\|H[ACKMP]\\|M[AEI]\\|NO\\|O[LP]\\|PR\\|QU\\|RE\\|S[OP]\\|T[EO]\\|VA\\)\\|XPA\\)\\|N\\(?:A\\(?:LL\\|NG\\|XI\\)\\|BLO\\|CNV\\|D\\(?:EL\\|IS\\|SU\\)\\|E\\(?:LE\\|QI\\)\\|FOR\\|GEN\\|KPT\\|L\\(?:AD\\|D[IP]\\|GE\\|HI\\|IS\\|ME\\|O[GP]\\)\\|MOD\\|O\\(?:DE\\|OF\\|R[AL]\\)\\|P\\(?:LO\\|RI\\)\\|R\\(?:E[AF]\\|LS\\|O[PT]\\|RA\\)\\|S\\(?:CA\\|EL\\|L[AEKLV]\\|M[AO]\\|O[LR]\\|TO\\|UB\\|VR\\|YM\\)\\|U\\(?:M[CEMOSV]\\|SO\\)\\|W\\(?:P[AL]\\|RI\\)\\)\\|O\\(?:C\\(?:D[AE]\\|LI\\|RE\\|T[AY]\\|ZO\\)\\|MEG\\|P\\(?:A[DN]\\|CL\\|D[AE]\\|E[QRX]\\|F[AR]\\|GR\\|KE\\|L[FGIOS]\\|MA\\|NC\\|PR\\|R[AEFGS]\\|S[AEUW]\\|TY\\|US\\|VA\\)\\|SRE\\|UT[AGOPR]\\)\\|P\\(?:A\\(?:DE\\|GE\\|PU\\|R[ERS]\\|SA\\|TH\\|US\\)\\|C\\(?:AL\\|GO\\|IR\\|O[NR]\\|RO\\)\\|D\\(?:EF\\|OT\\|RA\\)\\|E\\(?:MO\\|R[BIT]\\|XC\\)\\|F\\(?:AC\\|LU\\)\\|G\\(?:AP\\|R[AS]\\|S[AE]\\|WR\\)\\|I\\(?:LE\\(?:S[ET]\\|[CDGLMR]\\)\\|N[CS]\\|PE\\|VC\\)\\|L\\(?:AS\\|C[AFHIKOPR]\\|DI\\|E[ST]\\|F[2AS]\\|GE\\|LS\\|M[AC]\\|N[ES]\\|O[RT]\\|PA[GT]\\|S[CEY]\\|T[DILR]\\|V\\(?:ARO?\\|[EF]\\)\\|WA\\|ZZ\\)\\|M\\(?:AP\\|ET\\|GT\\|L[OS]\\|OP\\)\\|NGR\\|O\\(?:IN\\|LY\\|PT\\|UT\\|WE\\)\\|P\\(?:AT\\|LO\\|R[AE]\\)\\|R\\(?:A[NS]\\|C[AIOP]\\|E[CDNRST]\\|FA\\|I[2MNST]\\|JS\\|MC\\|N[ELS]\\|O[DR]\\|PA\\|R[FS]\\|S[CEY]\\|TI\\|V\\(?:ARO?\\|E\\)\\)\\|S\\(?:CO\\|D[CFGRSUVW]\\|EL\\|M[AE]\\|OLVE\\|P[ER]\\|TR\\|YS\\)\\|T\\(?:EM\\|R\\|XY\\)\\|UNI\\|VEC\\)\\|Q\\(?:DVA\\|FAC\\|RDO\\|SOP\\|U\\(?:AD\\|OT\\)\\)\\|R\\(?:A\\(?:CE\\|DO\\|LL\\|PP\\|TE\\)\\|BE3\\|C\\(?:ON\\|YC\\)\\|DE[CL]\\|E\\(?:A\\(?:LV\\|[DL]\\)\\|CT\\|DU\\|ME\\|S\\(?:CO[MN]\\|[EPUVW]\\)\\|ZO\\)\\|F\\(?:IL\\|OR\\)\\|I\\(?:G[IR]\\|TE\\)\\|LIS\\|M\\(?:EM\\|FL\\|O[DR]\\)\\|O\\(?:CK\\|SE\\)\\|P\\(?:OL\\|R[4I]\\|SD\\)\\|S\\(?:ME\\|OP\\|P[EL]\\|T[ACMO]\\|UR\\|Y[MS]\\)\\|TIM\\|UN\\|WFR\\)\\|S\\(?:A\\(?:BS\\|DD\\|LL\\|RP\\|VE\\)\\|BC[LT]\\|COP\\|DEL\\|E\\(?:C[CDFJL-PRSTW]\\|DL\\|EX\\|L[IMT]\\|MI\\|NE\\|OP\\|SY\\|T[FR]\\|XP\\|[DT]\\)\\|F\\(?:A[CDL]\\|BE\\|C[AOU]\\|DE\\|E[DL]\\|FU\\|GR\\|L[DEIL]\\|SC\\|TR\\|[AEL]\\)\\|H\\(?:EL\\|PP\\|SD\\)\\|L\\(?:IS\\|OA\\|[PS]P\\)\\|M\\(?:A[LX]\\|BO\\|CO\\|FO\\|IN\\|OO\\|RT\\|SU\\|UL\\)\\|NOP\\|O\\(?:L\\(?:UO\\|[COUV]\\)\\|RT\\|UR\\)\\|P\\(?:A[CDR]\\|C[NT]\\|DA\\|EC\\|F[RS]\\|GR\\|H[45E]\\|IC\\|L[IO]\\|MW\\|O[IP]\\|RE\\|S[CW]\\|TO\\|UN\\|VA\\)\\|QRT\\|RSS\\|S\\(?:BT\\|LN\\|MT\\|OP\\|P[ABDEM]\\|T[AI]\\|UM\\)\\|T\\(?:A[BT]\\|EF\\|OR\\)\\|U\\(?:B[OS]\\|C[AR]\\|DE\\|EV\\|GE\\|M[AT]\\|P[LR]\\|RE\\|S[AE]\\|VE\\)\\|V\\(?:PL\\|TY\\)\\|W\\(?:AD\\|DE\\|GE\\|LI\\)\\|YNC\\|[EFV]\\)\\|T\\(?:A\\(?:LL\\|RG\\)\\|B\\(?:CO\\|D[AE]\\|EO\\|F[IPT]\\|IN\\|L[EI]\\|MO\\|P[LT]\\|TE\\)?\\|CHG\\|EE\\|H\\(?:EX\\|OP\\)\\|I\\(?:FF\\|M\\(?:ER\\|[EIP]\\)\\|NT\\)\\|O\\(?:CO\\|DE\\|EX\\|F[FR]\\|GR\\|L[IO]\\|P[LR]\\|RU\\|ST\\|T[AY]\\|VA\\)\\|R\\(?:AN\\|EF\\|NO\\|P[DLO]\\|TI\\)\\|S\\(?:HA\\|RE\\)\\|UNI\\|VAR\\|YPE\\|Z\\(?:AM\\|DE\\|EG\\)\\)\\|U\\(?:IMP\\|N\\(?:D[EO]\\|PA\\)\\|P\\(?:CO\\|GE\\)\\|SR[CDE]\\)\\|V\\(?:2DO\\|A\\(?:DD\\|LV\\|R[DN]\\|TT\\)?\\|C\\(?:LE\\|RO\\|VF\\)\\|D\\(?:DA\\|EL\\|GL\\|OT\\|RA\\)\\|E\\(?:OR\\|XT\\)\\|F\\(?:CO\\|DI\\|OP\\|QU\\|SM\\|UP\\)\\|G\\(?:E[NT]\\|LU\\)\\|I\\(?:MP\\|N[PV]\\)\\|L\\(?:IS\\|SC\\)\\|MES\\|O\\(?:FF\\|LU\\|VL\\)\\|P\\(?:LO\\|TN\\|UT\\)\\|ROT\\|S\\(?:B[AVW]\\|EL\\|LA\\|UM\\|WE\\|YM\\)\\|T\\(?:CL\\|DI\\|EV\\|FR\\|GE\\|IN\\|M[EP]\\|OP\\|PO\\|R[AEFS]\\|S[EFLT]\\|TE\\|VM\\|YP\\)\\)\\|W\\(?:P\\(?:AV\\|CS\\|LA\\|OF\\|RO\\|ST\\)\\|R\\(?:FU\\|ITEM?\\)\\|SPR\\|TBC\\)\\|X\\(?:F\\(?:CR\\|DA\\|EN\\|LI\\)\\|MLO\\|VARO?\\)\\|~\\(?:C\\(?:AT[5I]\\|FI\\)\\|EUI\\|P\\(?:AR\\|RO\\)\\|SAT\\|UGI\\)\\|[AC-FK-NRV]\\)"
"APDL short keyword name regexp.")

(defconst apdl-command-regexp-1
"\\(?:\\*\\(?:A\\(?:BBR\\|FUN\\|SK\\|XPY\\)\\|C\\(?:F\\(?:CLOS\\|OPEN\\|WRITE\\)\\|OMP\\|\\(?:REAT\\|YCL\\)E\\)\\|D\\(?:EL\\|IM\\|MAT\\|O\\(?:T\\|WHILE\\)?\\|PF\\)\\|E\\(?:IGEN\\|LSE\\(?:IF\\)?\\|ND\\(?:DO\\|IF\\)?\\|X\\(?:\\(?:I\\|POR\\)T\\)\\)\\|F\\(?:FT\\|REE\\)\\|G\\(?:ET\\|O\\)\\|HPROD\\|I\\(?:F\\|N\\(?:IT\\|QUIRE\\)\\|TENGINE\\)\\|KRON\\|L\\(?:IST\\|S\\(?:BAC\\|DUMP\\|ENGINE\\|FACTOR\\|RESTORE\\)\\)\\|M\\(?:ERGE\\|F\\(?:OURI\\|UN\\)\\|OPER\\|SG\\|ULT\\|WRITE\\)\\|NRM\\|P\\(?:LUG\\|RINT\\)\\|RE\\(?:MOVE\\|NAME\\|PEAT\\|TURN\\)\\|S\\(?:CAL\\|ET\\|MAT\\|ORT\\|READ\\|TATUS\\)\\|T\\(?:AXIS\\|OPER\\|READ\\)\\|U\\(?:LIB\\|SE\\)\\|V\\(?:ABS\\|C\\(?:OL\\|UM\\)\\|E\\(?:C\\|DIT\\)\\|F\\(?:ACT\\|ILL\\|UN\\)\\|GET\\|ITRP\\|LEN\\|MASK\\|OPER\\|P\\(?:\\(?:LO\\|U\\)T\\)\\|READ\\|S\\(?:CFUN\\|TAT\\)\\|WRITE\\)\\|WRK\\|XPL\\)\\|/\\(?:A\\(?:N\\(?:3D\\|FILE\\|GLE\\|NOT\\|UM\\)\\|SSIGN\\|U\\(?:TO\\|X\\(?:1[25]\\|[23]\\)\\)\\|XLAB\\)\\|BATCH\\|C\\(?:FORMAT\\|L\\(?:ABEL\\|EAR\\|OG\\)\\|MAP\\|O\\(?:LOR\\|M\\|N\\(?:FIG\\|TOUR\\)\\|PY\\)\\|PLANE\\|TYPE\\|VAL\\|\\(?:W\\|YCEXPAN\\)D\\)\\|D\\(?:B\\(?:\\(?:DE\\|EN\\)CRYPT\\)\\|E\\(?:CRYPT\\|\\(?:LET\\|VIC\\)E\\)\\|FLAB\\|I\\(?:RECTORY\\|ST\\)\\|SCALE\\|V3D\\)\\|E\\(?:DGE\\|FACET\\|NCRYPT\\|OF\\|RASE\\|SHAPE\\|X\\(?:IT\\|PAND\\)\\)\\|F\\(?:ACET\\|C\\(?:LEAN\\|OMP\\)\\|DELE\\|ILNAME\\|O\\(?:CUS\\|RMAT\\)\\)\\|G\\(?:C\\(?:MD\\|OLUMN\\)\\|F\\(?:ILE\\|ORMAT\\)\\|LINE\\|MARKER\\|O\\(?:LIST\\|PR\\)?\\|R\\(?:APHICS\\|ESUME\\|ID\\|OPT\\|TYP\\)\\|S\\(?:AVE\\|T\\)\\|T\\(?:HK\\|YPE\\)\\)\\|H\\(?:BC\\|EADER\\)\\|I\\(?:C\\(?:LWID\\|SCALE\\)\\|MAGE\\|N\\(?:PUT\\|QUIRE\\)\\)\\|L\\(?:ARC\\|I\\(?:GHT\\|NE\\)\\|S\\(?:PEC\\|YMBOL\\)\\)\\|M\\(?:AP\\|ENU\\|KDIR\\|PLIB\\|REP\\|START\\)\\|N\\(?:ERR\\|O\\(?:ERASE\\|LIST\\|PR\\|RMAL\\)\\|UMBER\\)\\|OUTPUT\\|P\\(?:AGE\\|B[CF]\\|CIRCLE\\|LOPTS\\|M\\(?:ACRO\\|ORE\\)\\|NUM\\|O\\(?:LYGON\\|ST\\(?:1\\|26\\)\\)\\|REP7\\|S\\(?:EARCH\\|F\\|PEC\\|TATUS\\|YMB\\)\\|WEDGE\\)\\|QUIT\\|R\\(?:ATIO\\|E\\(?:NAME\\|\\(?:PLO\\|SE\\)T\\)\\|GB\\|MDIR\\)\\|S\\(?:E\\(?:CLIB\\|G\\)\\|H\\(?:ADE\\|OW\\|RINK\\)\\|MBC\\|OLU\\|SCALE\\|T\\(?:ATUS\\|ITLE\\)\\|Y[PS]\\)\\|T\\(?:EE\\|ITLE\\|LABEL\\|R\\(?:IAD\\|LCY\\)\\|SPEC\\|\\(?:XTR\\|YP\\)E\\)\\|U\\(?:CMD\\|DOC\\|IS?\\|NITS\\|PF\\|SER\\)\\|V\\(?:CONE\\|IEW\\|SCALE\\|UP\\)\\|W\\(?:AIT\\|INDOW\\)\\|X\\(?:FRM\\|RANGE\\)\\|YRANGE\\|ZOOM\\)\\|A\\(?:A\\(?:DD\\|TT\\)\\|B\\(?:B\\(?:RES\\|SAV\\)\\|EXTRACT\\|S\\)\\|C\\(?:C\\(?:AT\\|OPTION\\)\\|EL\\|LEAR\\)\\|D\\(?:AMS\\|D\\(?:AM\\)?\\|ELE\\|GL\\|PCI\\|RAG\\)\\|E\\(?:ROCOEFF\\|SIZE\\)\\|F\\(?:ILLT\\|LIST\\|SURF\\)\\|G\\(?:EN\\|LUE\\)\\|I\\(?:N[APV]\\|RL\\)\\|L\\(?:IST\\|LSEL\\|PHAD\\)?\\|M\\(?:AP\\|B\\(?:EAM\\|UILD\\)\\|E\\(?:NV\\|SH\\)\\|MAT\\|POWDER\\|RESULT\\|S\\(?:TEP\\|UPPORTS\\)\\|TYPE\\)\\|N\\(?:C\\(?:NTR\\|UT\\|YC\\)\\|D\\(?:ATA\\|SCL\\|YNA\\)\\|FLOW\\|HARM\\|I\\(?:M\\|SOS\\)\\|MODE\\|ORM\\|PRES\\|S\\(?:OL\\|TOA\\(?:QWA\\|SAS\\)\\)\\|T\\(?:\\(?:IM\\|YP\\)E\\)\\)\\|O\\(?:FFST\\|VLAP\\)\\|P\\(?:LOT\\|ORT\\|PEND\\|TN\\)\\|R\\(?:C\\(?:LEN\\|TRM\\)\\|E\\(?:AS\\|FINE\\|MESH\\|VERSE\\)\\|OTAT\\|S\\(?:CALE\\|YM\\)\\)\\|S\\(?:B[ALVW]\\|CRES\\|EL\\|IFILE\\|KIN\\|L[LV]\\|OL\\|U[BM]\\)\\|T\\(?:AN\\|RAN\\|YPE\\)\\|UTOTS\\|V\\(?:PRIN\\|RES\\)\\|WAVE\\)\\|B\\(?:CSOPTION\\|ETAD\\|F\\(?:A\\(?:DELE\\|LIST\\)\\|CUM\\|DELE\\|E\\(?:CUM\\|DELE\\|LIST\\|SCAL\\)\\|INT\\|K\\(?:DELE\\|LIST\\)\\|L\\(?:DELE\\|L?IST\\)\\|PORT\\|SCALE\\|TRAN\\|UNIF\\|V\\(?:DELE\\|LIST\\)\\|[AEKLV]\\)?\\|IO\\(?:\\(?:OP\\)?T\\)\\|L\\(?:C[45]\\|OCK\\)\\|O\\(?:OL\\|PTN\\)\\|S\\(?:AX\\|M[12D]\\|PLIN\\|S[12]\\|T[EQ]\\)\\|TOL\\|UCOPT\\)\\|C\\(?:A\\(?:LC\\|MPBELL\\)\\|B\\(?:DOF\\|M[DX]\\|T\\(?:E\\|MP\\)\\)\\|D\\(?:OPT\\|READ\\|WRITE\\)\\|E\\(?:C\\(?:HECK\\|MOD\\|YCMS\\)\\|DELE\\|FILTER\\|I\\(?:MS\\|NTF\\)\\|LIST\\|NTER\\|QN\\|RIG\\|S\\(?:EL\\|GEN\\)\\)\\|FACT\\|G\\(?:LOC\\|OMGA\\|ROW\\)\\|H\\(?:ECK\\|KMSH\\)\\|I\\(?:NT\\|RCLE\\|SOL\\)\\|JUMP\\|L\\(?:O\\(?:AD\\|CAL\\|G\\)\\|RMSHLN\\)\\|M\\(?:A\\(?:CEL\\|TRIX\\)\\|D\\(?:ELE\\|OMEGA\\)\\|EDIT\\|GRP\\|LIST\\|MOD\\|OMEGA\\|PLOT\\|ROTATE\\|S\\(?:EL\\|FILE\\|OPT\\)\\|WRITE\\)\\|N\\(?:CHECK\\|KMOD\\|TR\\|VTOL\\)\\|O\\(?:M\\(?:BINE\\|PRESS\\)\\|N\\(?:JUG\\|[4E]\\)\\|RIOLIS\\|UPLE\\|VAL\\)\\|P\\(?:CYC\\|DELE\\|INTF\\|L\\(?:GEN\\|IST\\)\\|MERGE\\|NGEN\\|S\\(?:EL\\|GEN\\)\\)\\|QC\\|S\\(?:CIR\\|DELE\\|KP\\|LIST\\|WPLA\\|YS\\)\\|U\\(?:RR2D\\|TCONTROL\\)\\|VAR\\|Y\\(?:C\\(?:CALC\\|F\\(?:ILES\\|REQ\\)\\|LIC\\|OPT\\|PHASE\\|SPEC\\)\\|L\\(?:IND\\|[45]\\)\\)\\|Z\\(?:DEL\\|MESH\\)\\|[EMPS]\\)\\|D\\(?:A\\(?:DELE\\|LIST\\|M\\(?:ORPH\\|POPT\\)\\|TA\\(?:DEF\\)?\\)\\|C\\(?:GOMG\\|UM\\)\\|D\\(?:ASPEC\\|ELE\\|OPTION\\)\\|E\\(?:ACT\\|FINE\\|L\\(?:ETE\\|TIM\\)\\|MORPH\\|RIV\\|S\\(?:IZE\\|OL\\)\\|TAB\\)\\|F\\(?:LX\\|SWAVE\\)\\|ISPLAY\\|J\\(?:DELE\\|LIST\\)\\|K\\(?:DELE\\|LIST\\)\\|L\\(?:DELE\\|L?IST\\)\\|MP\\(?:EXT\\|OPTION\\|RAT\\|STR\\)\\|NSOL\\|O\\(?:F\\(?:SEL\\)?\\|MEGA\\)\\|S\\(?:CALE\\|POPTION\\|UM\\|Y[MS]\\)\\|TRAN\\|UMP\\|V\\(?:AL\\|MORPH\\)\\|YNOPT\\|[AJKL]\\)\\|E\\(?:ALIVE\\|CPCHG\\|DELE\\|E\\(?:MBED\\|XTRUDE\\)\\|G\\(?:EN\\|ID\\)\\|IN\\(?:FIN\\|TF\\)\\|KILL\\|L\\(?:BOW\\|EM\\|IST\\)\\|M\\(?:A\\(?:GERR\\|TWRITE\\)\\|FT?\\|I[DS]\\|O\\(?:DIF\\|RE\\)\\|S\\(?:EL\\|YM\\)\\|TGEN\\|UNIT\\)\\|N\\(?:DRELEASE\\|ERSOL\\|GEN\\|\\(?:OR\\|SY\\)M\\)\\|ORIENT\\|PLOT\\|QSLV\\|R\\(?:ASE\\|E\\(?:AD\\|FINE\\|INF\\|SX\\)\\|NORM\\|RANG\\)\\|S\\(?:CHECK\\|EL\\|IZE\\|L[ALNV]\\|O\\(?:L\\|RT\\)\\|TIF\\|URF\\|Y[MS]\\)\\|T\\(?:ABLE\\|C\\(?:HG\\|ONTROL\\)\\|DELE\\|LIST\\|YPE\\)\\|USORT\\|WRITE\\|X\\(?:BOPT\\|OPTION\\|P\\(?:A\\(?:ND\\|SS\\)\\|ROFILE\\|SOL\\)?\\|T\\(?:OPT\\|REM\\)\\|UNIT\\)\\|[NT]\\)\\|F\\(?:C\\(?:CHECK\\|DELE\\|LIST\\|TYP\\|UM\\)\\|DELE\\|E\\(?:BODY\\|CONS\\|FOR\\|SURF\\)\\|I\\(?:L\\(?:EAUX[23]\\|LDATA\\|[EL]\\)\\|NISH\\|TEM\\)\\|J\\(?:DELE\\|LIST\\)\\|K\\(?:DELE\\|LIST\\)\\|L\\(?:IST\\|ST\\|U\\(?:READ\\|XV\\)\\)\\|OR\\(?:CE\\|M\\)\\|R\\(?:EQ\\|QSCL\\)\\|S\\(?:CALE\\|S\\(?:ECT\\|PARM\\)\\|UM\\)\\|T\\(?:RAN\\|YPE\\)\\|VMESH\\|[CJK]\\)\\|G\\(?:AUGE\\|C\\(?:DEF\\|GEN\\)\\|E\\(?:NOPT\\|OM\\(?:ETRY\\)?\\)\\|M\\(?:ATRIX\\|FACE\\)\\|PLOT\\|RP\\|S\\(?:BDATA\\|GDATA\\|LIST\\|SOL\\|UM\\)\\)\\|H\\(?:ARFRQ\\|BM\\(?:\\(?:A\\|OP\\)T\\)\\|E\\(?:LP\\|MIOPT\\)\\|F\\(?:ANG\\|SYM\\)\\|PT\\(?:\\(?:CREA\\|DELE\\)TE\\)\\|R\\(?:CPLX\\|EXP\\|O\\(?:CEAN\\|[PU]T\\)\\)\\)\\|I\\(?:C\\(?:DELE\\|LIST\\|ROTATE\\)?\\|GES\\(?:IN\\|OUT\\)\\|M\\(?:AGIN\\|ESH\\|MED\\)\\|N\\(?:ISTATE\\|R\\(?:ES\\|TIA\\)\\|T1\\|VOPT\\)\\|OPTN\\|RL\\(?:F\\|IST\\)\\)\\|J\\(?:PEG\\|SOL\\)\\|K\\(?:ATT\\|B\\(?:C\\|ETW\\)\\|C\\(?:\\(?:ENTE\\|LEA\\)R\\)\\|D\\(?:ELE\\|IST\\)\\|E\\(?:EP\\|SIZE\\|Y\\(?:OPT\\|PTS\\|W\\)\\)\\|FILL\\|GEN\\|L\\(?:IST\\)?\\|M\\(?:ESH\\|O\\(?:DIF\\|VE\\)\\)\\|NODE\\|P\\(?:LOT\\|SCALE\\)\\|R\\(?:EFINE\\|YOPT\\)\\|S\\(?:C\\(?:ALE\\|ON\\)\\|EL\\|L[LN]\\|\\(?:U\\|YM\\)M\\)\\|TRAN\\|USE\\|WP\\(?:AVE\\|LAN\\)\\)\\|L\\(?:2\\(?:ANG\\|TAN\\)\\|A\\(?:N\\(?:BOPTION\\|G\\)\\|R\\(?:C\\|EA\\|GE\\)\\|TT\\|Y\\(?:ER\\(?:P26\\)?\\|\\(?:LIS\\|PLO\\)T\\)\\)\\|C\\(?:A\\(?:BS\\|SE\\)\\|CA\\(?:LC\\|T\\)\\|DEF\\|F\\(?:ACT\\|ILE\\)\\|LEAR\\|O\\(?:MB\\|PER\\)\\|S\\(?:EL\\|L\\|UM\\)\\|WRITE\\|ZERO\\)\\|D\\(?:ELE\\|IV\\|R\\(?:AG\\|EAD\\)\\)\\|E\\(?:SIZE\\|XTND\\)\\|F\\(?:ILLT\\|SURF\\)\\|G\\(?:EN\\|\\(?:LU\\|WRIT\\)E\\)\\|I\\(?:N\\(?:ES\\|[AELPV]\\)\\|ST\\)\\|LIST\\|MESH\\|NSRCH\\|O\\(?:CAL\\|VLAP\\)\\|P\\(?:LOT\\|TN\\)\\|R\\(?:E\\(?:\\(?:FIN\\|VERS\\)E\\)\\|OTAT\\)\\|S\\(?:B[ALVW]\\|CLEAR\\|DELE\\|EL\\|L[AK]\\|OPER\\|READ\\|S\\(?:\\(?:CAL\\|OLV\\)E\\)\\|TR\\|UM\\|WRITE\\|YMM\\)\\|T\\(?:R?AN\\)\\|UMPM\\|VSCALE\\|WPLAN\\)\\|M\\(?:A\\(?:COPT\\|G\\(?:OPT\\|SOLV\\)\\|P\\(?:2DTO3D\\|SOLVE\\|VAR\\)\\|S\\(?:CALE\\|TER\\)\\|TER\\|XCYCMODE\\|[PT]\\)\\|C\\(?:FOPT\\|HECK\\)\\|D\\(?:AMP\\|ELE\\|PLOT\\)\\|E\\(?:MM\\|SHING\\)\\|GEN\\|IDTOL\\|LIST\\|M\\(?:ASS\\|F\\)\\|O\\(?:D\\(?:CONT\\|DIR\\|E\\|IFY\\|MSH\\|OPT\\|SELOPTION\\)\\|NITOR\\|PT\\|RPH\\|VE\\)\\|P\\(?:AMOD\\|C\\(?:HG\\|OPY\\)\\|D\\(?:ATA\\|ELE\\|RES\\)\\|LIST\\|PLOT\\|R\\(?:EAD\\|INT\\)\\|T\\(?:EMP\\|GEN\\|RES\\)\\|WRITE\\)?\\|RPM\\|S\\(?:AVE\\|H\\(?:APE\\|COPY\\|KEY\\|MID\\|PATTERN\\)\\|O\\(?:LVE\\|PT\\)\\|TOLE\\)\\|XPAND\\)\\|N\\(?:A\\(?:NG\\|XIS\\)\\|CNV\\|D\\(?:ELE\\|IST\\|SURF\\)\\|EQIT\\|FORCE\\|GEN\\|KPT\\|L\\(?:ADAPTIVE\\|D\\(?:IAG\\|POST\\)\\|GEOM\\|HIST\\|IST\\|MESH\\|O\\(?:G\\|PT\\)\\)\\|MODIF\\|O\\(?:DES\\|OFFSET\\|R[AL]\\)\\|P\\(?:\\(?:LO\\|RIN\\)T\\)\\|R\\(?:E\\(?:AD\\|FINE\\)\\|LSUM\\|O\\(?:\\(?:P\\|TA\\)T\\)\\|RANG\\)\\|S\\(?:CALE\\|EL\\|L[AEKLV]\\|M\\(?:ASS\\|OOTH\\)\\|O\\(?:L\\|RT\\)\\|TORE\\|UBST\\|VR\\|YM\\)\\|U\\(?:M\\(?:CMP\\|EXP\\|MRG\\|OFF\\|\\(?:ST\\|VA\\)R\\)\\|SORT\\)\\|W\\(?:P\\(?:AVE\\|LAN\\)\\|RITE\\)\\)\\|O\\(?:C\\(?:D\\(?:ATA\\|ELETE\\)\\|LIST\\|READ\\|\\(?:T\\(?:ABL\\|YP\\)\\|ZON\\)E\\)\\|MEGA\\|P\\(?:ERATE\\|NCONTROL\\)\\|SRESULT\\|UT\\(?:AERO\\|GEOM\\|OPT\\|PR\\|RES\\)\\)\\|P\\(?:A\\(?:DELE\\|GET\\|PUT\\|R\\(?:ESU\\|RES\\|SAV\\)\\|SAVE\\|TH\\|USE\\)\\|C\\(?:ALC\\|GOPT\\|IRC\\|ROSS\\)\\|D\\(?:EF\\|OT\\)\\|ER\\(?:BC2D\\|TURB\\)\\|FACT\\|IVCHECK\\|L\\(?:AS\\|C\\(?:AMP\\|FREQ\\|HIST\\|INT\\|KSURF\\|PLX\\)\\|DISP\\|E\\(?:SOL\\|TAB\\)\\|F\\(?:2D\\|AR\\)\\|GEOM\\|LS\\|M\\(?:AP\\|C\\)\\|N\\(?:EAR\\|SOL\\)\\|O\\(?:RB\\|TTING\\)\\|PA\\(?:GM\\|TH\\)\\|SECT\\|T\\(?:IME\\|RAC\\)\\|V\\(?:AR\\|ECT\\)\\|ZZ\\)\\|M\\(?:AP\\|GTRAN\\|L\\(?:OPT\\|SIZE\\)\\)\\|NGR\\|O\\(?:INT\\|LY\\|WERH\\)\\|PATH\\|R\\(?:A\\(?:NGE\\|S\\)\\|C\\(?:AMP\\|INT\\|PLX\\)\\|E\\(?:D\\|NERGY\\|RR\\|SOL\\|TAB\\)\\|FAR\\|I\\(?:NT\\|SM\\|TER\\|[2M]\\)\\|JSOL\\|MC\\|N\\(?:EAR\\|LD\\|SOL\\)\\|O\\(?:D\\|RB\\)\\|PATH\\|R\\(?:FOR\\|SOL\\)\\|S\\(?:CONTROL\\|ECT\\)\\|TIME\\|V\\(?:AR\\|ECT\\)\\)\\|S\\(?:CONTROL\\|D\\(?:COM\\|FRQ\\|GRAPH\\|RES\\|SPL\\|UNIT\\|VAL\\|WAV\\)\\|EL\\|M\\(?:AT\\|ESH\\)\\|\\(?:TRE\\|Y\\)S\\)\\|T\\(?:R\\|XY\\)\\|VECT\\)\\|Q\\(?:DVAL\\|RDOPT\\|SOPT\\|U\\(?:AD\\|OT\\)\\)\\|R\\(?:A\\(?:CE\\|DOPT\\|PPND\\|TE\\)\\|BE3\\|C\\(?:ON\\|YC\\)\\|DE\\(?:C\\|LE\\)\\|E\\(?:A\\(?:LVAR\\|[DL]\\)\\|CTNG\\|MESH\\|S\\(?:CO\\(?:MBINE\\|NTROL\\)\\|ET\\|P\\|UME\\|VEC\\|WRITE\\)\\|ZONE\\)\\|FORCE\\|IG\\(?:ID\\|RESP\\)\\|LIST\\|M\\(?:FLVEC\\|O\\(?:DIF\\|RE\\)\\)\\|O\\(?:CK\\|SE\\)\\|P\\(?:OLY\\|R\\(?:4\\|ISM\\)\\|SD\\)\\|S\\(?:MESH\\|OPT\\|PLIT\\|T\\(?:CONTROL\\|MAC\\|OFF\\)\\|URF\\|Y\\(?:MM\\|S\\)\\)\\)\\|S\\(?:A\\(?:BS\\|DD\\|LLOW\\|VE\\)\\|BC\\(?:LIST\\|TRAN\\)\\|COPT\\|DELETE\\|E\\(?:C\\(?:CONTROL\\|DATA\\|FUNCTION\\|JOINT\\|LOCK\\|MODIF\\|NUM\\|OFFSET\\|PLOT\\|READ\\|STOP\\|\\(?:TYP\\|WRIT\\)E\\)\\|DLIST\\|EXP\\|L\\(?:IST\\|M\\|TOL\\)\\|MIIMPLICIT\\|NERGY\\|OPT\\|SYMM\\|T\\(?:FGAP\\|RAN\\)\\|XP\\|[DT]\\)\\|F\\(?:A\\(?:CT\\|DELE\\|LIST\\)\\|BEAM\\|C\\(?:ALC\\|ONTROL\\|UM\\)\\|DELE\\|E\\(?:DELE\\|LIST\\)\\|FUN\\|GRAD\\|L\\(?:DELE\\|EX\\|L?IST\\)\\|SCALE\\|TRAN\\|[AEL]\\)\\|H\\(?:ELL\\|PP\\|SD\\)\\|L\\(?:IST\\|OAD\\)\\|M\\(?:A\\(?:LL\\|X\\)\\|BODY\\|CONS\\|FOR\\|IN\\|OOTH\\|RTSIZE\\|SURF\\|ULT\\)\\|NOPTION\\|O\\(?:L\\(?:OPTION\\|U\\(?:OPT\\)?\\|VE\\)\\|RT\\|URCE\\)\\|P\\(?:ACE\\|C\\(?:NOD\\|TEMP\\)\\|DAMP\\|EC\\|FREQ\\|GRAPH\\|H\\(?:ERE\\|[45]\\)\\|L\\(?:INE\\|OT\\)\\|MWRITE\\|O\\(?:\\(?:IN\\|P\\)T\\)\\|READ\\|TOPT\\|UNIT\\|VAL\\)\\|QRT\\|RSS\\|S\\(?:BT\\|LN\\|MT\\|OPT\\|P[ABDEM]\\|TATE\\|UM\\)\\|T\\(?:A\\(?:BILIZE\\|T\\)\\|EF\\|ORE\\)\\|U\\(?:B\\(?:\\(?:OP\\|SE\\)T\\)\\|C\\(?:ALC\\|R\\)\\|DEL\\|EVAL\\|GET\\|M\\(?:AP\\|TYPE\\)\\|P[LR]\\|RESU\\|S\\(?:AVE\\|EL\\)\\|VECT\\)\\|V\\(?:PLOT\\|TYP\\)\\|W\\(?:ADD\\|DEL\\|GEN\\|LIST\\)\\|YNCHRO\\|[EFV]\\)\\|T\\(?:A\\(?:LLOW\\|RGET\\)\\|B\\(?:COPY\\|D\\(?:ATA\\|ELE\\)\\|EO\\|F\\(?:IELD\\|\\(?:PLO\\)?T\\)\\|IN\\|L\\(?:E\\|IST\\)\\|MODIF\\|P\\(?:\\(?:LO\\)?T\\)\\|TEMP\\)?\\|CHG\\|H\\(?:EXPAND\\|OPT\\)\\|I\\(?:FF\\|M\\(?:ERANGE\\|INT\\|[EP]\\)\\|NTP\\)\\|O\\(?:FFST\\|RUS\\)\\|R\\(?:ANSFER\\|EF\\|NOPT\\|P\\(?:DEL\\|LIS\\|OIN\\)\\|TIME\\)\\|S\\(?:HAP\\|RES\\)\\|UNIF\\|VAR\\|YPE\\)\\|U\\(?:IMP\\|N\\(?:D\\(?:ELETE\\|O\\)\\|PAUSE\\)\\|P\\(?:COORD\\|GEOM\\)\\|SR\\(?:CAL\\|DOF\\|ELEM\\)\\)\\|V\\(?:2DOPT\\|A\\(?:DD\\|R\\(?:DEL\\|NAM\\)\\|TT\\)?\\|C\\(?:LEAR\\|ROSS\\)\\|D\\(?:DAM\\|ELE\\|GL\\|OT\\|RAG\\)\\|E\\(?:\\(?:ORIEN\\|X\\)T\\)\\|F\\(?:CO\\|DI\\|OPT\\|QUERY\\|SM\\|UP\\)\\|G\\(?:E[NT]\\|LUE\\)\\|I\\(?:MP\\|N[PV]\\)\\|L\\(?:IST\\|SCALE\\)\\|MESH\\|O\\(?:FFST\\|LUMES\\|VLAP\\)\\|P\\(?:LOT\\|TN\\|UT\\)\\|ROTAT\\|S\\(?:B[AVW]\\|EL\\|LA\\|UM\\|WEEP\\|YMM\\)\\|T\\(?:RAN\\|YPE\\)\\)\\|W\\(?:P\\(?:AVE\\|CSYS\\|LANE\\|OFFS\\|ROTA\\|STYL\\)\\|R\\(?:FULL\\|ITE\\(?:MAP\\)?\\)\\|SPRINGS\\|TBCREATE\\)\\|X\\(?:F\\(?:CRKMESH\\|DATA\\|ENRICH\\|LIST\\)\\|VAR\\)\\|~\\(?:\\(?:CAT\\(?:5\\|IA\\)\\|P\\(?:ARA\\|ROE\\)\\|SAT\\|UG\\)IN\\)\\|[AC-FK-NRV]\\)"
"APDL full keyword name regexp.")

(defconst apdl-command-regexp-2a
"\\(?:\\*\\(?:DO\\|E\\(?:LSEIF\\|ND\\(?:DO\\|IF\\)?\\)\\|GO\\|IF\\)\\|/\\(?:GO\\|P\\(?:OST\\(?:1\\|26\\)\\|REP7\\)\\|UI\\)\\|A\\(?:BS\\|DD\\|L\\)\\|BF[AEKLV]?\\|C\\(?:QC\\|[EMPS]\\)\\|D\\(?:OF\\|[AJKL]\\)\\|E\\(?:MF\\|XP\\|[NT]\\)\\|F[CJK]\\|GRP\\|IC\\|K\\(?:BC\\|L\\)\\|M\\(?:A[PT]\\|MF\\|P\\)\\|PTR\\|S\\(?:E[DT]\\|F[AEL]\\|[EFV]\\)\\|TB\\|VA\\|[AC-FK-NRV]\\)"
"APDL keyword name regexp 2a.")

(defconst apdl-command-regexp-2b
"\\(?:H\\(?:EMIO?\\|F\\(?:ANG?\\|SYM?\\)\\|PT\\(?:CR\\(?:E\\(?:A\\(?:TE?\\)?\\)?\\)?\\|DE\\(?:L\\(?:E\\(?:TE?\\)?\\)?\\)?\\|[CD]\\)\\|R\\(?:CP\\(?:LX?\\)?\\|EXP?\\|O\\(?:CE\\(?:AN?\\)?\\|[PU]T\\|[CPU]\\)\\)\\)\\|I\\(?:C\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|RO\\(?:T\\(?:A\\(?:TE?\\)?\\)?\\)?\\)\\|GES\\(?:IN\\|OUT?\\|[IO]\\)\\|M\\(?:AG\\(?:IN?\\)?\\|ESH?\\|MED?\\)\\|N\\(?:IS\\(?:T\\(?:A\\(?:TE?\\)?\\)?\\)?\\|R\\(?:ES\\|TIA?\\|[ET]\\)\\|T1\\|VO\\(?:PT?\\)?\\)\\|OPTN?\\|RL\\(?:IST?\\|[FI]\\)\\)\\|J\\(?:PEG\\|SOL\\)\\|K\\(?:ATT\\|BETW?\\|C\\(?:EN\\(?:T\\(?:ER?\\)?\\)?\\|LE\\(?:AR?\\)?\\)\\|D\\(?:ELE?\\|IST?\\)\\|E\\(?:EP\\|SI\\(?:ZE?\\)?\\|Y\\(?:OPT?\\|PTS?\\|[OPW]\\)\\)\\|FILL?\\|GEN\\|LIST?\\|M\\(?:ESH?\\|O\\(?:DIF?\\|VE\\|[DV]\\)\\)\\|NODE?\\|P\\(?:LOT?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\)\\|R\\(?:EF\\(?:I\\(?:NE?\\)?\\)?\\|YO\\(?:PT?\\)?\\)\\|S\\(?:C\\(?:ALE?\\|ON\\|[AO]\\)\\|EL\\|L[LN]\\|\\(?:YM\\|[UY]\\)M\\)\\|TRAN?\\|USE\\|WP\\(?:AVE?\\|LAN?\\|[AL]\\)\\)\\|L\\(?:2\\(?:ANG?\\|TAN?\\)\\|A\\(?:N\\(?:BO\\(?:P\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)?\\|[BG]\\)\\|R\\(?:EA\\|GE\\|[CEG]\\)\\|TT\\|Y\\(?:ER\\(?:P\\(?:26?\\)?\\)?\\|LI\\(?:ST?\\)?\\|PL\\(?:OT?\\)?\\|[LP]\\)\\)\\|C\\(?:A\\(?:BS\\|SE\\|[BS]\\)\\|CA\\(?:LC\\|[LT]\\)\\|DEF?\\|F\\(?:ACT?\\|ILE?\\|[AI]\\)\\|LE\\(?:AR?\\)?\\|O\\(?:MB\\|PER?\\|[MP]\\)\\|S\\(?:EL\\|UM\\|[ELU]\\)\\|WR\\(?:I\\(?:TE?\\)?\\)?\\|ZE\\(?:RO?\\)?\\)\\|D\\(?:ELE?\\|IV\\|R\\(?:AG\\|EAD?\\|[AE]\\)\\)\\|E\\(?:SI\\(?:ZE?\\)?\\|XT\\(?:ND?\\)?\\)\\|F\\(?:IL\\(?:LT?\\)?\\|SU\\(?:RF?\\)?\\)\\|G\\(?:EN\\|LUE?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|I\\(?:N\\(?:ES\\|[AELPV]\\)\\|ST\\)\\|LIST?\\|MESH?\\|NSR\\(?:CH?\\)?\\|O\\(?:CAL?\\|VL\\(?:AP?\\)?\\)\\|P\\(?:LOT?\\|TN\\)\\|R\\(?:E\\(?:FI\\(?:NE?\\)?\\|VE\\(?:R\\(?:SE?\\)?\\)?\\|[FV]\\)\\|OT\\(?:AT?\\)?\\)\\|S\\(?:B[ALVW]\\|CL\\(?:E\\(?:AR?\\)?\\)?\\|DE\\(?:LE?\\)?\\|EL\\|L[AK]\\|OP\\(?:ER?\\)?\\|RE\\(?:AD?\\)?\\|S\\(?:CA\\(?:LE?\\)?\\|OL\\(?:VE?\\)?\\|[CO]\\)\\|TR\\|UM\\|WR\\(?:I\\(?:TE?\\)?\\)?\\|YMM?\\)\\|T\\(?:AN\\|RAN?\\)\\|UMPM?\\|VSC\\(?:A\\(?:LE?\\)?\\)?\\|WPL\\(?:AN?\\)?\\)\\|M\\(?:A\\(?:CO\\(?:PT?\\)?\\|G\\(?:OPT?\\|SO\\(?:LV?\\)?\\|[OS]\\)\\|P\\(?:2D\\(?:T\\(?:O\\(?:3D?\\)?\\)?\\)?\\|SO\\(?:L\\(?:VE?\\)?\\)?\\|VAR?\\|[2SV]\\)\\|S\\(?:CA\\(?:LE?\\)?\\|TER?\\|[CT]\\)\\|TER?\\|XC\\(?:Y\\(?:C\\(?:M\\(?:O\\(?:DE?\\)?\\)?\\)?\\)?\\)?\\)\\|C\\(?:FO\\(?:PT?\\)?\\|HE\\(?:CK?\\)?\\)\\|D\\(?:AMP?\\|ELE?\\|PL\\(?:OT?\\)?\\)\\|E\\(?:MM\\|SH\\(?:I\\(?:NG?\\)?\\)?\\)\\|GEN\\|IDT\\(?:OL?\\)?\\|LIST?\\|MASS?\\|O\\(?:D\\(?:CO\\(?:NT?\\)?\\|DIR?\\|IFY?\\|MSH?\\|OPT?\\|SE\\(?:L\\(?:O\\(?:P\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)?\\)?\\)?\\|[CDEIMOS]\\)\\|NI\\(?:T\\(?:OR?\\)?\\)?\\|PT\\|RPH?\\|VE\\)\\|P\\(?:AM\\(?:OD?\\)?\\|C\\(?:HG\\|OPY?\\|[HO]\\)\\|D\\(?:ATA?\\|ELE?\\|RES?\\|[AER]\\)\\|LI\\(?:ST?\\)?\\|PL\\(?:OT?\\)?\\|R\\(?:EAD?\\|INT?\\|[EI]\\)\\|T\\(?:EMP?\\|GEN?\\|RES?\\|[EGR]\\)\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|RPM\\|S\\(?:AVE?\\|H\\(?:APE?\\|CO\\(?:PY?\\)?\\|KEY?\\|MID?\\|PA\\(?:T\\(?:T\\(?:E\\(?:RN?\\)?\\)?\\)?\\)?\\|[ACKMP]\\)\\|O\\(?:LVE?\\|PT\\|[LP]\\)\\|TO\\(?:LE?\\)?\\)\\|XPA\\(?:ND?\\)?\\)\\|N\\(?:A\\(?:NG\\|XIS?\\)\\|CNV\\|D\\(?:ELE?\\|IST?\\|SU\\(?:RF?\\)?\\)\\|EQIT?\\|FOR\\(?:CE?\\)?\\|GEN\\|KPT\\|L\\(?:AD\\(?:A\\(?:P\\(?:T\\(?:I\\(?:VE?\\)?\\)?\\)?\\)?\\)?\\|D\\(?:IAG?\\|PO\\(?:ST?\\)?\\|[IP]\\)\\|GE\\(?:OM?\\)?\\|HI\\(?:ST?\\)?\\|IST?\\|ME\\(?:SH?\\)?\\|O\\(?:PT\\|[GP]\\)\\)\\|MOD\\(?:IF?\\)?\\|O\\(?:DES?\\|OF\\(?:F\\(?:S\\(?:ET?\\)?\\)?\\)?\\|R[AL]\\)\\|P\\(?:LOT?\\|RI\\(?:NT?\\)?\\)\\|R\\(?:E\\(?:AD\\|FI\\(?:NE?\\)?\\|[AF]\\)\\|LS\\(?:UM?\\)?\\|O\\(?:PT\\|TAT?\\|[PT]\\)\\|RA\\(?:NG?\\)?\\)\\|S\\(?:CA\\(?:LE?\\)?\\|EL\\|L[AEKLV]\\|M\\(?:ASS?\\|OO\\(?:TH?\\)?\\|[AO]\\)\\|O\\(?:RT\\|[LR]\\)\\|TO\\(?:RE?\\)?\\|UB\\(?:ST?\\)?\\|VR\\|YM\\)\\|U\\(?:M\\(?:CMP?\\|EXP?\\|MRG?\\|OFF?\\|STR?\\|VAR?\\|[CEMOSV]\\)\\|SO\\(?:RT?\\)?\\)\\|W\\(?:P\\(?:AVE?\\|LAN?\\|[AL]\\)\\|RI\\(?:TE?\\)?\\)\\)\\|O\\(?:C\\(?:D\\(?:ATA?\\|EL\\(?:E\\(?:TE?\\)?\\)?\\|[AE]\\)\\|LI\\(?:ST?\\)?\\|RE\\(?:AD?\\)?\\|T\\(?:AB\\(?:LE?\\)?\\|YPE?\\|[AY]\\)\\|ZO\\(?:NE?\\)?\\)\\|MEGA?\\|P\\(?:ER\\(?:A\\(?:TE?\\)?\\)?\\|NC\\(?:O\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\)?\\)\\|SRE\\(?:S\\(?:U\\(?:LT?\\)?\\)?\\)?\\|UT\\(?:AE\\(?:RO?\\)?\\|GE\\(?:OM?\\)?\\|OPT?\\|PR\\|RES?\\|[AGOPR]\\)\\)\\|P\\(?:A\\(?:DE\\(?:LE?\\)?\\|GET?\\|PUT?\\|R\\(?:ESU?\\|RES?\\|SAV?\\|[ERS]\\)\\|SA\\(?:VE?\\)?\\|TH\\|USE?\\)\\|C\\(?:ALC?\\|GO\\(?:PT?\\)?\\|IRC?\\|RO\\(?:SS?\\)?\\)\\|D\\(?:EF\\|OT\\)\\|ER\\(?:BC\\(?:2D?\\)?\\|TU\\(?:RB?\\)?\\|[BT]\\)\\|FACT?\\|IVC\\(?:H\\(?:E\\(?:CK?\\)?\\)?\\)?\\|L\\(?:AS\\|C\\(?:AMP?\\|FR\\(?:EQ?\\)?\\|HI\\(?:ST?\\)?\\|INT?\\|KS\\(?:U\\(?:RF?\\)?\\)?\\|PLX?\\|[AFHIKP]\\)\\|DI\\(?:SP?\\)?\\|E\\(?:SOL?\\|TAB?\\|[ST]\\)\\|F\\(?:2D\\|AR\\|[2A]\\)\\|GE\\(?:OM?\\)?\\|LS\\|M\\(?:AP\\|[AC]\\)\\|N\\(?:EAR?\\|SOL?\\|[ES]\\)\\|O\\(?:RB\\|TT\\(?:I\\(?:NG?\\)?\\)?\\|[RT]\\)\\|PA\\(?:GM\\|TH\\|[GT]\\)\\|SE\\(?:CT?\\)?\\|T\\(?:IME?\\|RAC?\\|[IR]\\)\\|V\\(?:AR\\|ECT?\\|[AE]\\)\\|ZZ\\)\\|M\\(?:AP\\|GT\\(?:R\\(?:AN?\\)?\\)?\\|L\\(?:OPT?\\|SI\\(?:ZE?\\)?\\|[OS]\\)\\)\\|NGR\\|O\\(?:INT?\\|LY\\|WE\\(?:RH?\\)?\\)\\|PATH?\\|R\\(?:A\\(?:NGE?\\|[NS]\\)\\|C\\(?:AMP?\\|INT?\\|PLX?\\|[AIP]\\)\\|E\\(?:NE\\(?:R\\(?:GY?\\)?\\)?\\|RR\\|SOL?\\|TAB?\\|[DNRST]\\)\\|FAR?\\|I\\(?:NT\\|SM\\|TER?\\|[2MNST]\\)\\|JS\\(?:OL?\\)?\\|MC\\|N\\(?:EAR?\\|LD\\|SOL?\\|[ELS]\\)\\|O\\(?:RB\\|[DR]\\)\\|PA\\(?:TH?\\)?\\|R\\(?:FOR?\\|SOL?\\|[FS]\\)\\|S\\(?:CO\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\|ECT?\\|[CE]\\)\\|TI\\(?:ME?\\)?\\|V\\(?:AR\\|ECT?\\|[AE]\\)\\)\\|S\\(?:CO\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\|D\\(?:COM?\\|FRQ?\\|GR\\(?:A\\(?:PH?\\)?\\)?\\|RES?\\|SPL?\\|UN\\(?:IT?\\)?\\|VAL?\\|WAV?\\|[CFGRSUVW]\\)\\|EL\\|M\\(?:AT\\|ESH?\\|[AE]\\)\\|TR\\(?:ES?\\)?\\|YS\\)\\|TXY\\|VECT?\\)\\|Q\\(?:DVAL?\\|RDO\\(?:PT?\\)?\\|SOPT?\\|U\\(?:AD\\|OT\\)\\)\\|R\\(?:A\\(?:CE\\|DO\\(?:PT?\\)?\\|PP\\(?:ND?\\)?\\|TE\\)\\|BE3\\|C\\(?:ON\\|YC\\)\\|DE\\(?:LE\\|[CL]\\)\\|E\\(?:A\\(?:LV\\(?:AR?\\)?\\|[DL]\\)\\|CT\\(?:NG?\\)?\\|ME\\(?:SH?\\)?\\|S\\(?:CO\\(?:MB\\(?:I\\(?:NE?\\)?\\)?\\|NT\\(?:R\\(?:OL?\\)?\\)?\\|[MN]\\)\\|ET\\|UME?\\|VEC?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\|[EPUVW]\\)\\|ZO\\(?:NE?\\)?\\)\\|FOR\\(?:CE?\\)?\\|IG\\(?:ID\\|RE\\(?:SP?\\)?\\|[IR]\\)\\|LIST?\\|M\\(?:FL\\(?:V\\(?:EC?\\)?\\)?\\|O\\(?:DIF?\\|RE\\|[DR]\\)\\)\\|O\\(?:CK\\|SE\\)\\|P\\(?:OLY?\\|R\\(?:ISM?\\|[4I]\\)\\|SD\\)\\|S\\(?:ME\\(?:SH?\\)?\\|OPT?\\|PL\\(?:IT?\\)?\\|T\\(?:CO\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\|MAC?\\|OFF?\\|[CMO]\\)\\|URF?\\|Y\\(?:MM\\|[MS]\\)\\)\\)\\|S\\(?:A\\(?:BS\\|DD\\|LL\\(?:OW?\\)?\\|VE\\)\\|BC\\(?:LI\\(?:ST?\\)?\\|TR\\(?:AN?\\)?\\|[LT]\\)\\|COPT?\\|DEL\\(?:E\\(?:TE?\\)?\\)?\\|E\\(?:C\\(?:CO\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\|DA\\(?:TA?\\)?\\|FU\\(?:N\\(?:C\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)?\\)?\\|JO\\(?:I\\(?:NT?\\)?\\)?\\|LO\\(?:CK?\\)?\\|MO\\(?:D\\(?:IF?\\)?\\)?\\|NUM?\\|OF\\(?:F\\(?:S\\(?:ET?\\)?\\)?\\)?\\|PL\\(?:OT?\\)?\\|RE\\(?:AD?\\)?\\|ST\\(?:OP?\\)?\\|TY\\(?:PE?\\)?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\|[CDFJL-PRSTW]\\)\\|DL\\(?:I\\(?:ST?\\)?\\)?\\|EXP?\\|L\\(?:IST?\\|TOL?\\|[IMT]\\)\\|MI\\(?:I\\(?:M\\(?:P\\(?:L\\(?:I\\(?:C\\(?:IT?\\)?\\)?\\)?\\)?\\)?\\)?\\)?\\|NE\\(?:R\\(?:GY?\\)?\\)?\\|OPT?\\|SY\\(?:MM?\\)?\\|T\\(?:FG\\(?:AP?\\)?\\|RAN?\\|[FR]\\)\\|XP\\)\\|F\\(?:A\\(?:CT\\|DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|[CDL]\\)\\|BE\\(?:AM?\\)?\\|C\\(?:ALC?\\|ON\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\|UM\\|[AOU]\\)\\|DE\\(?:LE?\\)?\\|E\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|[DL]\\)\\|FUN?\\|GR\\(?:AD?\\)?\\|L\\(?:DE\\(?:LE?\\)?\\|EX\\|IST?\\|LI\\(?:ST?\\)?\\|[DEIL]\\)\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|TR\\(?:AN?\\)?\\)\\|H\\(?:ELL?\\|PP\\|SD\\)\\|L\\(?:IST?\\|OAD?\\)\\|M\\(?:A\\(?:LL\\|[LX]\\)\\|BO\\(?:DY?\\)?\\|CO\\(?:NS?\\)?\\|FOR?\\|IN\\|OO\\(?:TH?\\)?\\|RT\\(?:S\\(?:I\\(?:ZE?\\)?\\)?\\)?\\|SU\\(?:RF?\\)?\\|ULT?\\)\\|NOP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\|O\\(?:L\\(?:OP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\|UO\\(?:PT?\\)?\\|VE\\|[OUV]\\)\\|RT\\|UR\\(?:CE?\\)?\\)\\|P\\(?:ACE?\\|C\\(?:NOD?\\|TE\\(?:MP?\\)?\\|[NT]\\)\\|DA\\(?:MP?\\)?\\|EC\\|FR\\(?:EQ?\\)?\\|GR\\(?:A\\(?:PH?\\)?\\)?\\|H\\(?:ERE?\\|[45E]\\)\\|L\\(?:INE?\\|OT\\|[IO]\\)\\|MW\\(?:R\\(?:I\\(?:TE?\\)?\\)?\\)?\\|O\\(?:INT?\\|PT\\|[IP]\\)\\|RE\\(?:AD?\\)?\\|TO\\(?:PT?\\)?\\|UN\\(?:IT?\\)?\\|VAL?\\)\\|QRT\\|RSS\\|S\\(?:BT\\|LN\\|MT\\|OPT?\\|P[ABDEM]\\|TA\\(?:TE?\\)?\\|UM\\)\\|T\\(?:A\\(?:BI\\(?:L\\(?:I\\(?:ZE?\\)?\\)?\\)?\\|[BT]\\)\\|EF\\|ORE?\\)\\|U\\(?:B\\(?:OPT?\\|SET?\\|[OS]\\)\\|C\\(?:ALC?\\|[AR]\\)\\|DEL?\\|EV\\(?:AL?\\)?\\|GET?\\|M\\(?:AP\\|TY\\(?:PE?\\)?\\|[AT]\\)\\|P[LR]\\|RE\\(?:SU?\\)?\\|S\\(?:AVE?\\|EL\\|[AE]\\)\\|VE\\(?:CT?\\)?\\)\\|V\\(?:PL\\(?:OT?\\)?\\|TYP?\\)\\|W\\(?:ADD?\\|DEL?\\|GEN?\\|LI\\(?:ST?\\)?\\)\\|YNC\\(?:H\\(?:RO?\\)?\\)?\\)\\|T\\(?:A\\(?:LL\\(?:OW?\\)?\\|RG\\(?:ET?\\)?\\)\\|B\\(?:CO\\(?:PY?\\)?\\|D\\(?:ATA?\\|ELE?\\|[AE]\\)\\|EO\\|F\\(?:IE\\(?:LD?\\)?\\|PL\\(?:OT?\\)?\\|[IPT]\\)\\|IN\\|L\\(?:IST?\\|[EI]\\)\\|MO\\(?:D\\(?:IF?\\)?\\)?\\|P\\(?:LOT?\\|[LT]\\)\\|TE\\(?:MP?\\)?\\)\\|CHG\\|H\\(?:EX\\(?:P\\(?:A\\(?:ND?\\)?\\)?\\)?\\|OPT?\\)\\|I\\(?:FF\\|M\\(?:ER\\(?:A\\(?:N\\(?:GE?\\)?\\)?\\)?\\|INT?\\|[EIP]\\)\\|NTP?\\)\\|O\\(?:FF\\(?:ST?\\)?\\|RUS?\\)\\|R\\(?:AN\\(?:S\\(?:F\\(?:ER?\\)?\\)?\\)?\\|EF\\|NO\\(?:PT?\\)?\\|P\\(?:DEL?\\|LIS?\\|OIN?\\|[DLO]\\)\\|TI\\(?:ME?\\)?\\)\\|S\\(?:HAP?\\|RES?\\)\\|UNIF?\\|VAR\\|YPE\\)\\|U\\(?:IMP\\|N\\(?:D\\(?:EL\\(?:E\\(?:TE?\\)?\\)?\\|[EO]\\)\\|PA\\(?:U\\(?:SE?\\)?\\)?\\)\\|P\\(?:CO\\(?:O\\(?:RD?\\)?\\)?\\|GE\\(?:OM?\\)?\\)\\|SR\\(?:CAL?\\|DOF?\\|EL\\(?:EM?\\)?\\|[CDE]\\)\\)\\|V\\(?:2DO\\(?:PT?\\)?\\|A\\(?:DD\\|R\\(?:DEL?\\|NAM?\\|[DN]\\)\\|TT\\)\\|C\\(?:LE\\(?:AR?\\)?\\|RO\\(?:SS?\\)?\\)\\|D\\(?:DAM?\\|ELE?\\|GL\\|OT\\|RAG?\\)\\|E\\(?:OR\\(?:I\\(?:E\\(?:NT?\\)?\\)?\\)?\\|XT\\)\\|F\\(?:CO\\|DI\\|OPT?\\|QU\\(?:E\\(?:RY?\\)?\\)?\\|SM\\|UP\\)\\|G\\(?:E[NT]\\|LUE?\\)\\|I\\(?:MP\\|N[PV]\\)\\|L\\(?:IST?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\)\\|MESH?\\|O\\(?:FF\\(?:ST?\\)?\\|LU\\(?:M\\(?:ES?\\)?\\)?\\|VL\\(?:AP?\\)?\\)\\|P\\(?:LOT?\\|TN\\|UT\\)\\|ROT\\(?:AT?\\)?\\|S\\(?:B[AVW]\\|EL\\|LA\\|UM\\|WE\\(?:EP?\\)?\\|YMM?\\)\\|T\\(?:RAN?\\|YPE?\\)\\)\\|W\\(?:P\\(?:AVE?\\|CS\\(?:YS?\\)?\\|LA\\(?:NE?\\)?\\|OF\\(?:FS?\\)?\\|RO\\(?:TA?\\)?\\|ST\\(?:YL?\\)?\\)\\|R\\(?:FU\\(?:LL?\\)?\\|ITE\\(?:M\\(?:AP?\\)?\\)?\\)\\|SPR\\(?:I\\(?:N\\(?:GS?\\)?\\)?\\)?\\|TBC\\(?:R\\(?:E\\(?:A\\(?:TE?\\)?\\)?\\)?\\)?\\)\\|X\\(?:F\\(?:CR\\(?:K\\(?:M\\(?:E\\(?:SH?\\)?\\)?\\)?\\)?\\|DA\\(?:TA?\\)?\\|EN\\(?:R\\(?:I\\(?:CH?\\)?\\)?\\)?\\|LI\\(?:ST?\\)?\\)\\|VAR\\)\\|~\\(?:CAT\\(?:5IN?\\|IA\\(?:IN?\\)?\\|[5I]\\)\\|P\\(?:AR\\(?:A\\(?:IN?\\)?\\)?\\|RO\\(?:E\\(?:IN?\\)?\\)?\\)\\|SAT\\(?:IN?\\)?\\|UGIN?\\)\\)"
"APDL keyword name regexp 2b.")

(defconst apdl-command-regexp-2c
"\\(?:\\*\\(?:A\\(?:BBR?\\|FUN?\\|SK\\|XPY?\\)\\|C\\(?:F\\(?:CL\\(?:OS?\\)?\\|OP\\(?:EN?\\)?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\|[COW]\\)\\|OMP?\\|RE\\(?:A\\(?:TE?\\)?\\)?\\|YC\\(?:LE?\\)?\\)\\|D\\(?:EL\\|IM\\|MAT?\\|O\\(?:WH\\(?:I\\(?:LE?\\)?\\)?\\|[TW]\\)\\|PF\\)\\|E\\(?:IG\\(?:EN?\\)?\\|LSE\\|X\\(?:IT\\|PO\\(?:RT?\\)?\\|[IP]\\)\\)\\|F\\(?:FT\\|REE?\\)\\|GET\\|HPR\\(?:OD?\\)?\\|I\\(?:N\\(?:IT\\|QU\\(?:I\\(?:RE?\\)?\\)?\\|[IQ]\\)\\|TE\\(?:N\\(?:G\\(?:I\\(?:NE?\\)?\\)?\\)?\\)?\\)\\|KRON?\\|L\\(?:IST?\\|S\\(?:BAC?\\|DU\\(?:MP?\\)?\\|EN\\(?:G\\(?:I\\(?:NE?\\)?\\)?\\)?\\|FA\\(?:C\\(?:T\\(?:OR?\\)?\\)?\\)?\\|RE\\(?:S\\(?:T\\(?:O\\(?:RE?\\)?\\)?\\)?\\)?\\|[BDEFR]\\)\\)\\|M\\(?:ER\\(?:GE?\\)?\\|F\\(?:OU\\(?:RI?\\)?\\|UN\\|[OU]\\)\\|OP\\(?:ER?\\)?\\|SG\\|ULT?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|NRM\\|P\\(?:LUG?\\|RI\\(?:NT?\\)?\\)\\|RE\\(?:MO\\(?:VE?\\)?\\|NA\\(?:ME?\\)?\\|PE\\(?:AT?\\)?\\|TU\\(?:RN?\\)?\\|[MNPT]\\)\\|S\\(?:CAL?\\|ET\\|MAT?\\|ORT?\\|RE\\(?:AD?\\)?\\|TA\\(?:T\\(?:US?\\)?\\)?\\)\\|T\\(?:AX\\(?:IS?\\)?\\|OP\\(?:ER?\\)?\\|RE\\(?:AD?\\)?\\)\\|U\\(?:LIB?\\|SE\\)\\|V\\(?:ABS?\\|C\\(?:OL\\|UM\\|[OU]\\)\\|E\\(?:DIT?\\|[CD]\\)\\|F\\(?:ACT?\\|ILL?\\|UN\\|[AIU]\\)\\|GET?\\|IT\\(?:RP?\\)?\\|LEN?\\|MA\\(?:SK?\\)?\\|OP\\(?:ER?\\)?\\|P\\(?:LOT?\\|UT\\|[LU]\\)\\|RE\\(?:AD?\\)?\\|S\\(?:CF\\(?:UN?\\)?\\|TAT?\\|[CT]\\)\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|WRK\\|XPL\\)\\|/\\(?:A\\(?:N\\(?:3D\\|FI\\(?:LE?\\)?\\|GLE?\\|NOT?\\|UM\\|[3FGNU]\\)\\|SS\\(?:I\\(?:GN?\\)?\\)?\\|U\\(?:TO?\\|X\\(?:1[25]\\|[23]\\)\\)\\|XL\\(?:AB?\\)?\\)\\|BAT\\(?:CH?\\)?\\|C\\(?:FO\\(?:R\\(?:M\\(?:AT?\\)?\\)?\\)?\\|L\\(?:AB\\(?:EL?\\)?\\|EAR?\\|OG\\|[AEO]\\)\\|MAP?\\|O\\(?:LOR?\\|N\\(?:FIG?\\|TO\\(?:UR?\\)?\\|[FT]\\)\\|PY\\|[LMP]\\)\\|PL\\(?:A\\(?:NE?\\)?\\)?\\|TY\\(?:PE?\\)?\\|VAL?\\|WD\\|YC\\(?:E\\(?:X\\(?:P\\(?:A\\(?:ND?\\)?\\)?\\)?\\)?\\)?\\)\\|D\\(?:B\\(?:DE\\(?:C\\(?:R\\(?:Y\\(?:PT?\\)?\\)?\\)?\\)?\\|EN\\(?:C\\(?:R\\(?:Y\\(?:PT?\\)?\\)?\\)?\\)?\\|[DE]\\)\\|E\\(?:CR\\(?:Y\\(?:PT?\\)?\\)?\\|LE\\(?:TE?\\)?\\|VI\\(?:CE?\\)?\\|[CLV]\\)\\|FL\\(?:AB?\\)?\\|I\\(?:RE\\(?:C\\(?:T\\(?:O\\(?:RY?\\)?\\)?\\)?\\)?\\|ST\\|[RS]\\)\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|V3D?\\)\\|E\\(?:DGE?\\|FA\\(?:C\\(?:ET?\\)?\\)?\\|NC\\(?:R\\(?:Y\\(?:PT?\\)?\\)?\\)?\\|OF\\|RA\\(?:SE?\\)?\\|SH\\(?:A\\(?:PE?\\)?\\)?\\|X\\(?:IT\\|PA\\(?:ND?\\)?\\|[IP]\\)\\)\\|F\\(?:AC\\(?:ET?\\)?\\|C\\(?:LE\\(?:AN?\\)?\\|OMP?\\|[LO]\\)\\|DE\\(?:LE?\\)?\\|IL\\(?:N\\(?:A\\(?:ME?\\)?\\)?\\)?\\|O\\(?:CUS?\\|RM\\(?:AT?\\)?\\|[CR]\\)\\)\\|G\\(?:C\\(?:MD\\|OL\\(?:U\\(?:MN?\\)?\\)?\\|[MO]\\)\\|F\\(?:ILE?\\|OR\\(?:M\\(?:AT?\\)?\\)?\\|[IO]\\)\\|LI\\(?:NE?\\)?\\|MA\\(?:R\\(?:K\\(?:ER?\\)?\\)?\\)?\\|O\\(?:LI\\(?:ST?\\)?\\|PR\\|[LP]\\)\\|R\\(?:AP\\(?:H\\(?:I\\(?:CS?\\)?\\)?\\)?\\|ES\\(?:U\\(?:ME?\\)?\\)?\\|ID\\|OPT?\\|TYP?\\|[AEIOT]\\)\\|S\\(?:AVE?\\|[AT]\\)\\|T\\(?:HK\\|YPE?\\|[HY]\\)\\)\\|H\\(?:BC\\|EA\\(?:D\\(?:ER?\\)?\\)?\\)\\|I\\(?:C\\(?:LW\\(?:ID?\\)?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|[LS]\\)\\|MA\\(?:GE?\\)?\\|N\\(?:PUT?\\|QU\\(?:I\\(?:RE?\\)?\\)?\\|[PQ]\\)\\)\\|L\\(?:ARC?\\|I\\(?:GHT?\\|NE\\|[GN]\\)\\|S\\(?:PEC?\\|YM\\(?:B\\(?:OL?\\)?\\)?\\|[PY]\\)\\)\\|M\\(?:AP\\|ENU?\\|KD\\(?:IR?\\)?\\|PL\\(?:IB?\\)?\\|REP?\\|ST\\(?:A\\(?:RT?\\)?\\)?\\)\\|N\\(?:ERR?\\|O\\(?:ER\\(?:A\\(?:SE?\\)?\\)?\\|LI\\(?:ST?\\)?\\|PR\\|RM\\(?:AL?\\)?\\|[ELPR]\\)\\|UM\\(?:B\\(?:ER?\\)?\\)?\\)\\|OUT\\(?:P\\(?:UT?\\)?\\)?\\|P\\(?:AGE?\\|B[CF]\\|CI\\(?:R\\(?:C\\(?:LE?\\)?\\)?\\)?\\|LO\\(?:P\\(?:TS?\\)?\\)?\\|M\\(?:AC\\(?:RO?\\)?\\|ORE?\\|[AO]\\)\\|NUM?\\|OL\\(?:Y\\(?:G\\(?:ON?\\)?\\)?\\)?\\|S\\(?:EA\\(?:R\\(?:CH?\\)?\\)?\\|PEC?\\|TA\\(?:T\\(?:US?\\)?\\)?\\|YMB?\\|[EFPTY]\\)\\|WE\\(?:D\\(?:GE?\\)?\\)?\\)\\|QUIT?\\|R\\(?:AT\\(?:IO?\\)?\\|E\\(?:NA\\(?:ME?\\)?\\|PL\\(?:OT?\\)?\\|SET?\\|[NPS]\\)\\|GB\\|MD\\(?:IR?\\)?\\)\\|S\\(?:E\\(?:CL\\(?:IB?\\)?\\|[CG]\\)\\|H\\(?:ADE?\\|OW\\|RI\\(?:NK?\\)?\\|[AOR]\\)\\|MBC?\\|OLU?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|T\\(?:AT\\(?:US?\\)?\\|IT\\(?:LE?\\)?\\|[AI]\\)\\|Y[PS]\\)\\|T\\(?:EE\\|IT\\(?:LE?\\)?\\|LA\\(?:B\\(?:EL?\\)?\\)?\\|R\\(?:IAD?\\|LCY?\\|[IL]\\)\\|SP\\(?:EC?\\)?\\|XT\\(?:RE?\\)?\\|YPE?\\)\\|U\\(?:CMD?\\|DOC?\\|IS\\|NI\\(?:TS?\\)?\\|PF\\|SER?\\)\\|V\\(?:CO\\(?:NE?\\)?\\|IEW?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|UP\\)\\|W\\(?:AIT?\\|IN\\(?:D\\(?:OW?\\)?\\)?\\)\\|X\\(?:FRM?\\|RA\\(?:N\\(?:GE?\\)?\\)?\\)\\|YRA\\(?:N\\(?:GE?\\)?\\)?\\|ZOOM?\\)\\|A\\(?:A\\(?:DD\\|TT\\)\\|B\\(?:B\\(?:RES?\\|SAV?\\|[RS]\\)\\|EX\\(?:T\\(?:R\\(?:A\\(?:CT?\\)?\\)?\\)?\\)?\\)\\|C\\(?:C\\(?:AT\\|OP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\|[AO]\\)\\|EL\\|LE\\(?:AR?\\)?\\)\\|D\\(?:AMS?\\|DAM?\\|ELE?\\|GL\\|PCI?\\|RAG?\\)\\|E\\(?:RO\\(?:C\\(?:O\\(?:E\\(?:FF?\\)?\\)?\\)?\\)?\\|SI\\(?:ZE?\\)?\\)\\|F\\(?:IL\\(?:LT?\\)?\\|LI\\(?:ST?\\)?\\|SU\\(?:RF?\\)?\\)\\|G\\(?:EN\\|LUE?\\)\\|I\\(?:N[APV]\\|RL\\)\\|L\\(?:IST?\\|LS\\(?:EL?\\)?\\|PH\\(?:AD?\\)?\\)\\|M\\(?:AP\\|B\\(?:EAM?\\|UI\\(?:LD?\\)?\\|[EU]\\)\\|E\\(?:NV\\|SH\\|[NS]\\)\\|MAT?\\|PO\\(?:W\\(?:D\\(?:ER?\\)?\\)?\\)?\\|RE\\(?:S\\(?:U\\(?:LT?\\)?\\)?\\)?\\|S\\(?:TEP?\\|UP\\(?:P\\(?:O\\(?:R\\(?:TS?\\)?\\)?\\)?\\)?\\|[TU]\\)\\|TY\\(?:PE?\\)?\\)\\|N\\(?:C\\(?:NTR?\\|UT\\|YC\\|[NUY]\\)\\|D\\(?:ATA?\\|SCL?\\|YNA?\\|[ASY]\\)\\|FL\\(?:OW?\\)?\\|HA\\(?:RM?\\)?\\|I\\(?:SOS?\\|[MS]\\)\\|MO\\(?:DE?\\)?\\|ORM?\\|PR\\(?:ES?\\)?\\|S\\(?:OL?\\|TOA\\(?:QWA?\\|SAS?\\|[QS]\\)\\)\\|T\\(?:IME?\\|YPE?\\|[IY]\\)\\)\\|O\\(?:FF\\(?:ST?\\)?\\|VL\\(?:AP?\\)?\\)\\|P\\(?:LOT?\\|ORT?\\|PE\\(?:ND?\\)?\\|TN\\)\\|R\\(?:C\\(?:LEN?\\|TRM?\\|[LT]\\)\\|E\\(?:AS\\|FI\\(?:NE?\\)?\\|ME\\(?:SH?\\)?\\|VE\\(?:R\\(?:SE?\\)?\\)?\\|[AFMV]\\)\\|OT\\(?:AT?\\)?\\|S\\(?:CA\\(?:LE?\\)?\\|YM\\|[CY]\\)\\)\\|S\\(?:B[ALVW]\\|CR\\(?:ES?\\)?\\|EL\\|IF\\(?:I\\(?:LE?\\)?\\)?\\|KIN?\\|L[LV]\\|OL\\|U[BM]\\)\\|T\\(?:AN\\|RAN?\\|YPE?\\)\\|UTO\\(?:TS?\\)?\\|V\\(?:PR\\(?:IN?\\)?\\|RES?\\)\\|WAVE?\\)\\|B\\(?:CSO\\(?:P\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)?\\|ETAD?\\|F\\(?:A\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|[DL]\\)\\|CUM?\\|DE\\(?:LE?\\)?\\|E\\(?:CUM?\\|DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|SC\\(?:AL?\\)?\\|[CDLS]\\)\\|INT?\\|K\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|[DL]\\)\\|L\\(?:DE\\(?:LE?\\)?\\|IST?\\|LI\\(?:ST?\\)?\\|[DIL]\\)\\|PO\\(?:RT?\\)?\\|SC\\(?:A\\(?:LE?\\)?\\)?\\|TR\\(?:AN?\\)?\\|UN\\(?:IF?\\)?\\|V\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|[DL]\\)\\)\\|IO\\(?:OPT?\\|[OT]\\)\\|L\\(?:C[45]\\|OCK?\\)\\|O\\(?:OL\\|PTN?\\)\\|S\\(?:AX\\|M[12D]\\|PL\\(?:IN?\\)?\\|S[12]\\|T[EQ]\\)\\|TOL\\|UCO\\(?:PT?\\)?\\)\\|C\\(?:A\\(?:LC\\|MP\\(?:B\\(?:E\\(?:LL?\\)?\\)?\\)?\\)\\|B\\(?:DOF?\\|M[DX]\\|T\\(?:MP\\|[EM]\\)\\)\\|D\\(?:OPT?\\|RE\\(?:AD?\\)?\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|E\\(?:C\\(?:HE\\(?:CK?\\)?\\|MOD?\\|YC\\(?:MS?\\)?\\|[HMY]\\)\\|DE\\(?:LE?\\)?\\|FI\\(?:L\\(?:T\\(?:ER?\\)?\\)?\\)?\\|I\\(?:MS\\|NTF?\\|[MN]\\)\\|LI\\(?:ST?\\)?\\|NT\\(?:ER?\\)?\\|QN\\|RIG?\\|S\\(?:EL\\|GEN?\\|[EG]\\)\\)\\|FACT?\\|G\\(?:LOC?\\|OM\\(?:GA?\\)?\\|ROW?\\)\\|H\\(?:ECK?\\|KM\\(?:SH?\\)?\\)\\|I\\(?:NT\\|RC\\(?:LE?\\)?\\|SOL?\\)\\|JUMP?\\|L\\(?:O\\(?:AD\\|CAL?\\|[ACG]\\)\\|RM\\(?:S\\(?:H\\(?:LN?\\)?\\)?\\)?\\)\\|M\\(?:A\\(?:CEL?\\|TR\\(?:IX?\\)?\\|[CT]\\)\\|D\\(?:ELE?\\|OM\\(?:E\\(?:GA?\\)?\\)?\\|[EO]\\)\\|ED\\(?:IT?\\)?\\|GRP?\\|LI\\(?:ST?\\)?\\|MOD?\\|OM\\(?:E\\(?:GA?\\)?\\)?\\|PL\\(?:OT?\\)?\\|RO\\(?:T\\(?:A\\(?:TE?\\)?\\)?\\)?\\|S\\(?:EL\\|FI\\(?:LE?\\)?\\|OPT?\\|[EFO]\\)\\|WR\\(?:I\\(?:TE?\\)?\\)?\\)\\|N\\(?:CH\\(?:E\\(?:CK?\\)?\\)?\\|KM\\(?:OD?\\)?\\|TR\\|VT\\(?:OL?\\)?\\)\\|O\\(?:M\\(?:BI\\(?:NE?\\)?\\|PR\\(?:E\\(?:SS?\\)?\\)?\\|[BP]\\)\\|N\\(?:JUG?\\|[4EJ]\\)\\|RI\\(?:O\\(?:L\\(?:IS?\\)?\\)?\\)?\\|UP\\(?:LE?\\)?\\|VAL?\\)\\|P\\(?:CYC?\\|DE\\(?:LE?\\)?\\|IN\\(?:TF?\\)?\\|L\\(?:GEN?\\|IST?\\|[GI]\\)\\|ME\\(?:R\\(?:GE?\\)?\\)?\\|NG\\(?:EN?\\)?\\|S\\(?:EL\\|GEN?\\|[EG]\\)\\)\\|S\\(?:CIR?\\|DE\\(?:LE?\\)?\\|KP\\|LI\\(?:ST?\\)?\\|WP\\(?:LA?\\)?\\|YS\\)\\|U\\(?:RR\\(?:2D?\\)?\\|TC\\(?:O\\(?:N\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\)?\\)?\\)\\|VAR\\|Y\\(?:C\\(?:CA\\(?:LC?\\)?\\|F\\(?:IL\\(?:ES?\\)?\\|REQ?\\|[IR]\\)\\|LIC?\\|OPT?\\|PH\\(?:A\\(?:SE?\\)?\\)?\\|SP\\(?:EC?\\)?\\|[CLOPS]\\)\\|L\\(?:IND?\\|[45I]\\)\\)\\|Z\\(?:DEL?\\|ME\\(?:SH?\\)?\\)\\)\\|D\\(?:A\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|M\\(?:OR\\(?:PH?\\)?\\|PO\\(?:PT?\\)?\\|[OP]\\)\\|TA\\(?:D\\(?:EF?\\)?\\)?\\)\\|C\\(?:GO\\(?:MG?\\)?\\|UM\\)\\|D\\(?:AS\\(?:P\\(?:EC?\\)?\\)?\\|ELE?\\|OP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)\\|E\\(?:ACT?\\|FI\\(?:NE?\\)?\\|L\\(?:ETE?\\|TIM?\\|[ET]\\)\\|MO\\(?:R\\(?:PH?\\)?\\)?\\|RIV?\\|S\\(?:IZE?\\|OL\\|[IO]\\)\\|TAB?\\)\\|F\\(?:LX\\|SW\\(?:A\\(?:VE?\\)?\\)?\\)\\|ISP\\(?:L\\(?:AY?\\)?\\)?\\|J\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\)\\|K\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\)\\|L\\(?:DE\\(?:LE?\\)?\\|IST?\\|LI\\(?:ST?\\)?\\)\\|MP\\(?:EXT?\\|OP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\|RAT?\\|STR?\\|[EORS]\\)\\|NSOL?\\|O\\(?:FS\\(?:EL?\\)?\\|ME\\(?:GA?\\)?\\)\\|S\\(?:CA\\(?:LE?\\)?\\|PO\\(?:P\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\)?\\|UM\\|Y[MS]\\)\\|TRAN?\\|UMP\\|V\\(?:AL\\|MO\\(?:R\\(?:PH?\\)?\\)?\\)\\|YNO\\(?:PT?\\)?\\)\\|E\\(?:ALI\\(?:VE?\\)?\\|CPC\\(?:HG?\\)?\\|DELE?\\|E\\(?:MB\\(?:ED?\\)?\\|XT\\(?:R\\(?:U\\(?:DE?\\)?\\)?\\)?\\)\\|G\\(?:EN\\|ID\\)\\|IN\\(?:FIN?\\|TF\\|[FT]\\)\\|KILL?\\|L\\(?:BOW?\\|EM\\|IST?\\)\\|M\\(?:A\\(?:GE\\(?:RR?\\)?\\|TW\\(?:R\\(?:I\\(?:TE?\\)?\\)?\\)?\\|[GT]\\)\\|FT\\|I[DS]\\|O\\(?:DIF?\\|RE\\|[DR]\\)\\|S\\(?:EL\\|YM\\|[EY]\\)\\|TG\\(?:EN?\\)?\\|UN\\(?:IT?\\)?\\)\\|N\\(?:DR\\(?:E\\(?:L\\(?:E\\(?:A\\(?:SE?\\)?\\)?\\)?\\)?\\)?\\|ER\\(?:S\\(?:OL?\\)?\\)?\\|GEN?\\|ORM?\\|SYM?\\)\\|ORI\\(?:E\\(?:NT?\\)?\\)?\\|PLOT?\\|QSLV?\\|R\\(?:ASE?\\|E\\(?:AD\\|FI\\(?:NE?\\)?\\|INF?\\|SX\\|[AFIS]\\)\\|NO\\(?:RM?\\)?\\|RA\\(?:NG?\\)?\\)\\|S\\(?:CH\\(?:E\\(?:CK?\\)?\\)?\\|EL\\|IZE?\\|L[ALNV]\\|O\\(?:RT\\|[LR]\\)\\|TIF?\\|URF?\\|Y[MS]\\)\\|T\\(?:AB\\(?:LE?\\)?\\|C\\(?:HG\\|ON\\(?:T\\(?:R\\(?:OL?\\)?\\)?\\)?\\|[HO]\\)\\|DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|YPE?\\)\\|USO\\(?:RT?\\)?\\|WRI\\(?:TE?\\)?\\|X\\(?:BO\\(?:PT?\\)?\\|OP\\(?:T\\(?:I\\(?:ON?\\)?\\)?\\)?\\|P\\(?:A\\(?:ND\\|SS\\|[NS]\\)\\|RO\\(?:F\\(?:I\\(?:LE?\\)?\\)?\\)?\\|SOL?\\|[RS]\\)\\|T\\(?:OPT?\\|REM?\\|[OR]\\)\\|UN\\(?:IT?\\)?\\)\\)\\|F\\(?:C\\(?:CH\\(?:E\\(?:CK?\\)?\\)?\\|DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\|TYP?\\|UM\\)\\|DELE?\\|E\\(?:BO\\(?:DY?\\)?\\|CO\\(?:NS?\\)?\\|FOR?\\|SU\\(?:RF?\\)?\\)\\|I\\(?:L\\(?:EAUX[23]\\|LD\\(?:A\\(?:TA?\\)?\\)?\\|[EL]\\)\\|NI\\(?:SH?\\)?\\|TEM?\\)\\|J\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\)\\|K\\(?:DE\\(?:LE?\\)?\\|LI\\(?:ST?\\)?\\)\\|L\\(?:IST?\\|ST\\|U\\(?:RE\\(?:AD?\\)?\\|XV\\|[RX]\\)\\)\\|OR\\(?:CE\\|[CM]\\)\\|R\\(?:EQ\\|QS\\(?:CL?\\)?\\)\\|S\\(?:CA\\(?:LE?\\)?\\|S\\(?:ECT?\\|PA\\(?:RM?\\)?\\|[EP]\\)\\|UM\\)\\|T\\(?:RAN?\\|YPE?\\)\\|VME\\(?:SH?\\)?\\)\\|G\\(?:AUGE?\\|C\\(?:DEF?\\|GEN?\\)\\|E\\(?:NO\\(?:PT?\\)?\\|OM\\(?:E\\(?:T\\(?:RY?\\)?\\)?\\)?\\)\\|M\\(?:AT\\(?:R\\(?:IX?\\)?\\)?\\|FA\\(?:CE?\\)?\\)\\|PLOT?\\|S\\(?:BD\\(?:A\\(?:TA?\\)?\\)?\\|GD\\(?:A\\(?:TA?\\)?\\)?\\|LI\\(?:ST?\\)?\\|SOL?\\|UM\\)\\)\\|H\\(?:ARF\\(?:RQ?\\)?\\|BM\\(?:AT\\|OPT?\\|[AO]\\)\\|E\\(?:LP\\|MIOPT?\\)\\)\\)"
"APDL keyword name regexp 2c.")

(defconst apdl-element-regexp
"\\<\\(BEAM18[89]\\|C\\(?:ABLE280\\|IRCU\\(?:12[45]\\|94\\)\\|O\\(?:MBI\\(?:2\\(?:14\\|50\\)\\|N\\(?:14\\|3[79]\\|40\\)\\)\\|NTA17[24578]\\)\\|PT21[23567]\\)\\|ELBOW290\\|F\\(?:LUID\\(?:1\\(?:16\\|29\\|3[0689]\\)\\|2\\(?:18\\|2[01]\\|4[34]\\|9\\)\\|3[08]\\)\\|OLLW201\\)\\|HSFLD24[12]\\|IN\\(?:FIN\\(?:11[01]\\|\\(?:25\\|4\\)7\\)\\|TER\\(?:19[2-5]\\|20[2-5]\\)\\)\\|LINK\\(?:1\\(?:1\\|80\\)\\|228\\|3[134]\\|68\\)\\|M\\(?:A\\(?:SS\\(?:[27]1\\)\\|TRIX\\(?:27\\|50\\)\\)\\|ESH200\\|PC184\\)\\|P\\(?:IPE28[89]\\|LANE\\(?:1\\(?:21\\|3\\|8[23]\\)\\|2\\(?:2[23]\\|3[038]\\|5\\|9[23]\\)\\|35\\|55\\|7[578]\\|83\\)\\|RETS179\\)\\|REINF26[345]\\|S\\(?:HELL\\(?:1\\(?:3[12]\\|57\\|81\\)\\|2\\(?:0[89]\\|81\\)\\|61\\)\\|O\\(?:L\\(?:ID\\(?:1\\(?:2[23]\\|8[567]\\)\\|2\\(?:2[567]\\|3[12679]\\|40\\|7[2389]\\|85\\|91\\)\\|5\\|70\\|87\\|9[068]\\)\\|SH190\\)\\|URC36\\)\\|URF\\(?:15[1-69]\\|25[12]\\)\\)\\|T\\(?:ARGE1\\(?:69\\|70\\)\\|RANS126\\)\\|USER300\\)\\>"
...
'(("BEAM3" . "BEAM188") ("BEAM4" . "BEAM188") ("BEAM23" . "BEAM188") ("BEAM24" . "BEAM188") ("BEAM44" . "BEAM188") ("BEAM54" . "BEAM188") ("CONTAC12" . "CONTA178") ("CONTAC52" . "CONTA178") ("CONTA171" . "CONTA172") ("CONTA173" . "CONTA174") ("CONTA176" . "CONTA177") ("COMBIN7" . "MPC184") ("FLUID79" . "Fluid29") ("FLUID80" . "Fluid29") ("FLUID81" . "Fluid29") ("FLUID141" . "CFX") ("FLUID142" . "CFX") ("INFIN9" . "INFIN110") ("INFIN47" . "INFIN111") ("PIPE16" . "PIPE288") ("PIPE18" . "ELBOW290") ("PLANE13" . "PLANE223") ("PLANE25" . "PLANE272") ("PLANE42" . "PLANE182") ("PLANE53" . "PLANE233") ("PLANE67" . "PLANE223") ("PLANE82" . "PLANE183") ("PLANE83" . "SOLID273") ("PLANE145" . "-") ("PLANE146" . "-") ("CONTAC12" . "CONTA178") ("CONTAC52" . "CONTA178") ("LINK1" . "LINK180") ("LINK8" . "LINK180") ("LINK10" . "LINK180") ("LINK32" . "LINK33") ("PIPE16" . "PIPE288") ("PIPE17" . "PIPE288") ("PIPE18" . "ELBOW290") ("PIPE20" . "PIPE288") ("PIPE59" . "PIPE288") ("PIPE60" . "ELBOW290") ("SHELL41" . "SHELL181") ("SHELL43" . "SHELL181") ("SHELL57" . "SHELL131") ("SHELL63" . "SHELL181") ("SHELL91" . "SHELL281") ("SHELL93" . "SHELL281") ("SHELL99" . "SHELL281") ("SHELL150" . "-") ("SOLID5" . "SOLID226") ("SOLID45" . "SOLID185") ("SOLID46" . "SOLID185") ("SOLID65" . "SOLID185") ("SOLID69" . "SOLID226") ("SOLID92" . "SOLID187") ("SOLID95" . "SOLID186") ("SOLID117" . "SOLID236") ("SOLID127" . "-") ("SOLID128" . "-") ("SOLID147" . "-") ("SOLID148" . "-") ("SOLID191" . "SOLID186") ("VISCO88" . "PLANE183") ("VISCO89" . "SOLID186") ("VISCO106" . "PLANE182") ("VISCO107" . "SOLID185") ("VISCO108" . "PLANE183") ("TRANS109" . "PLANE223"))
"Association list for APDL deprecated elements.
Together with their proposed replacements.")

(defconst apdl-get-function-regexp
"\\(?:A\\(?:NGLE[KN]\\|R\\(?:EA\\(?:KP\\|ND\\)\\|FACE\\|N\\(?:EXT\\|ODE\\)\\)\\|SEL\\|[XYZ]\\)\\|C\\(?:ENTR[XYZ]\\|HRHEX\\)\\|DIST\\(?:EN\\|KP\\|ND\\)\\|E\\(?:ATT\\|L\\(?:ADJ\\|NEXT\\)\\|N\\(?:DS\\|E\\(?:\\(?:AR\\|XT\\)N\\)\\|KE\\)\\|SEL\\)\\|JOIN\\|K\\(?:NEAR\\|PNEXT\\|SEL\\|WGET\\|[PXYZ]\\)\\|L\\(?:S\\(?:EL\\|NEXT\\|[XYZ]\\)\\|WCASE\\|[XYZ]\\)\\|MAG\\|N\\(?:D\\(?:FACE\\|NEXT\\)\\|ELEM\\|MFACE\\|NEAR\\|O\\(?:DE\\(?:DOF\\)?\\|RM\\(?:K[XYZ]\\|N[XYZ]\\)\\)\\|SEL\\|[XYZ]\\)\\|PRES\\|R\\(?:CON\\|OT[XYZ]\\)\\|S\\(?:ECTO\\(?:MAT\\|REAL\\)\\|PLIT\\|TR\\(?:C\\(?:AT\\|OMP\\)\\|FILL\\|LENG\\|POS\\|SUB\\)\\)\\|TEMP\\|U\\(?:PCASE\\|[XYZ]\\)\\|V\\(?:AL\\(?:CHR\\|HEX\\)\\|IRTINQR\\|LNEXT\\|OLT\\|SEL\\|[XYZ]\\)\\)"
"APDL get function regexp.")

(defconst apdl-parametric-function-regexp
"\\(?:A\\(?:BS\\|COS\\|SIN\\|TAN2?\\)\\|C\\(?:HRVAL\\|OSH?\\|XABS\\)\\|EXP\\|GDIS\\|L\\(?:ARGEINT\\|OG\\(?:10\\)?\\|WCASE\\)\\|MOD\\|NINT\\|RAND\\|S\\(?:I\\(?:GN\\|NH?\\)\\|QRT\\)\\|TANH?\\|UPCASE\\|VALCHR\\)"
"APDL parametric function regexp.")

(defconst apdl-completions
'("SOLID5" "LINK11" "PLANE13" "COMBIN14" "MASS21" "PLANE25" "MATRIX27" "FLUID29" "FLUID30" "LINK31" "LINK33" "LINK34" "PLANE35" "SOURC36" "COMBIN37" "FLUID38" "COMBIN39" "COMBIN40" "INFIN47" "MATRIX50" "PLANE55" "SHELL61" "LINK68" "SOLID70" "MASS71" "PLANE75" "PLANE77" "PLANE78" "PLANE83" "SOLID87" "SOLID90" "CIRCU94" "SOLID96" "SOLID98" "INFIN110" "INFIN111" "FLUID116" "PLANE121" "SOLID122" "SOLID123" "CIRCU124" "CIRCU125" "TRANS126" "FLUID129" "FLUID130" "SHELL131" "SHELL132" "FLUID136" "FLUID138" "FLUID139" "SURF151" "SURF152" "SURF153" "SURF154" "SURF155" "SURF156" "SHELL157" "SURF159" "TARGE169" "TARGE170" "CONTA172" "CONTA174" "CONTA175" "CONTA177" "CONTA178" "PRETS179" "LINK180" "SHELL181" "PLANE182" "PLANE183" "MPC184" "SOLID185" "SOLID186" "SOLID187" "BEAM188" "BEAM189" "SOLSH190" "INTER192" "INTER193" "INTER194" "INTER195" "MESH200" "FOLLW201" "INTER202" "INTER203" "INTER204" "INTER205" "SHELL208" "SHELL209" "CPT212" "CPT213" "COMBI214" "CPT215" "CPT216" "CPT217" "FLUID218" "FLUID220" "FLUID221" "PLANE222" "PLANE223" "SOLID225" "SOLID226" "SOLID227" "LINK228" "PLANE230" "SOLID231" "SOLID232" "PLANE233" "SOLID236" "SOLID237" "PLANE238" "SOLID239" "SOLID240" "HSFLD241" "HSFLD242" "FLUID243" "FLUID244" "COMBI250" "SURF251" "SURF252" "INFIN257" "REINF263" "REINF264" "REINF265" "SOLID272" "SOLID273" "SOLID278" "SOLID279" "CABLE280" "SHELL281" "SOLID285" "PIPE288" "PIPE289" "ELBOW290" "SOLID291" "PLANE292" "PLANE293" "USER300" "BEAM3" "BEAM4" "BEAM23" "BEAM24" "BEAM44" "BEAM54" "CONTAC12" "CONTAC52" "CONTA171" "CONTA173" "CONTA176" "COMBIN7" "FLUID79" "FLUID80" "FLUID81" "FLUID141" "FLUID142" "INFIN9" "INFIN47" "PIPE16" "PIPE18" "PLANE13" "PLANE25" "PLANE42" "PLANE53" "PLANE67" "PLANE82" "PLANE83" "PLANE145" "PLANE146" "CONTAC12" "CONTAC52" "LINK1" "LINK8" "LINK10" "LINK32" "PIPE16" "PIPE17" "PIPE18" "PIPE20" "PIPE59" "PIPE60" "SHELL41" "SHELL43" "SHELL57" "SHELL63" "SHELL91" "SHELL93" "SHELL99" "SHELL150" "SOLID5" "SOLID45" "SOLID46" "SOLID65" "SOLID69" "SOLID92" "SOLID95" "SOLID117" "SOLID127" "SOLID128" "SOLID147" "SOLID148" "SOLID191" "VISCO88" "VISCO89" "VISCO106" "VISCO107" "VISCO108" "TRANS109" "NSEL()" "ESEL()" "KSEL()" "LSEL()" "ASEL()" "VSEL()" "NDNEXT()" "ELNEXT()" "KPNEXT()" "LSNEXT()" "ARNEXT()" "VLNEXT()" "CENTRX()" "CENTRY()" "CENTRZ()" "NX()" "NY()" "NZ()" "KX()" "KY()" "KZ()" "LX()" "LY()" "LZ()" "LSX()" "LSY()" "LSZ()" "NODE()" "KP()" "DISTND()" "DISTKP()" "DISTEN()" "ANGLEN()" "ANGLEK()" "NNEAR()" "KNEAR()" "ENEARN()" "AREAND()" "AREAKP()" "ARNODE()" "NORMNX()" "NORMNY()" "NORMNZ()" "NORMKX()" "NORMKY()" "NORMKZ()" "ENEXTN()" "NELEM()" "NODEDOF()" "ELADJ()" "NDFACE()" "NMFACE()" "ARFACE()" "EATT()" "RCON()" "SECTOMAT()" "SECTOREAL()" "UX()" "UY()" "UZ()" "ROTX()" "ROTY()" "ROTZ()" "TEMP()" "PRES()" "VX()" "VY()" "VZ()" "ENKE()" "ENDS()" "VOLT()" "MAG()" "AX()" "AY()" "AZ()" "VIRTINQR()" "KWGET()" "VALCHR()" "VALHEX()" "CHRHEX()" "STRSUB()" "STRCAT()" "STRFILL()" "STRCOMP()" "STRPOS()" "STRLENG()" "UPCASE()" "LWCASE()" "JOIN()" "SPLIT()" "ABS()" "SIGN()" "CXABS()" "EXP()" "LOG()" "LOG10()" "SQRT()" "NINT()" "MOD()" "RAND()" "GDIS()" "SIN()" "COS()" "TAN()" "SINH()" "COSH()" "TANH()" "ASIN()" "ACOS()" "ATAN()" "ATAN2()" "VALCHR()" "CHRVAL()" "UPCASE()" "LWCASE()" "LARGEINT()" "*ABBR" "*AFUN" "*ASK" "*AXPY" "*CFCLOS" "*CFOPEN" "*CFWRITE" "*COMP" "*CREATE" "*CYCLE" "*DEL" "*DIM" "*DMAT" "*DO" "*DOT" "*DOWHILE" "*DPF" "*EIGEN" "*ELSE" "*ELSEIF" "*END" "*ENDDO" "*ENDIF" "*EXIT" "*EXPORT" "*FFT" "*FREE" "*GET" "*GO" "*HPROD" "*IF" "*INIT" "*INQUIRE" "*ITENGINE" "*KRON" "*LIST" "*LSBAC" "*LSDUMP" "*LSENGINE" "*LSFACTOR" "*LSRESTORE" "*MERGE" "*MFOURI" "*MFUN" "*MOPER" "*MSG" "*MULT" "*MWRITE" "*NRM" "*PLUG" "*PRINT" "*REMOVE" "*RENAME" "*REPEAT" "*RETURN" "*SCAL" "*SET" "*SMAT" "*SORT" "*SREAD" "*STATUS" "*TAXIS" "*TOPER" "*TREAD" "*ULIB" "*USE" "*VABS" "*VCOL" "*VCUM" "*VEC" "*VEDIT" "*VFACT" "*VFILL" "*VFUN" "*VGET" "*VITRP" "*VLEN" "*VMASK" "*VOPER" "*VPLOT" "*VPUT" "*VREAD" "*VSCFUN" "*VSTAT" "*VWRITE" "*WRK" "*XPL" "/AN3D" "/ANFILE" "/ANGLE" "/ANNOT" "/ANUM" "/ASSIGN" "/AUTO" "/AUX12" "/AUX15" "/AUX2" "/AUX3" "/AXLAB" "/BATCH" "/CFORMAT" "/CLABEL" "/CLEAR" "/CLOG" "/CMAP" "/COLOR" "/COM" "/CONFIG" "/CONTOUR" "/COPY" "/CPLANE" "/CTYPE" "/CVAL" "/CWD" "/CYCEXPAND" "/DBDECRYPT" "/DBENCRYPT" "/DECRYPT" "/DELETE" "/DEVICE" "/DFLAB" "/DIRECTORY" "/DIST" "/DSCALE" "/DV3D" "/EDGE" "/EFACET" "/ENCRYPT" "/EOF" "/ERASE" "/ESHAPE" "/EXIT" "/EXPAND" "/FACET" "/FCLEAN" "/FCOMP" "/FDELE" "/FILNAME" "/FOCUS" "/FORMAT" "/GCMD" "/GCOLUMN" "/GFILE" "/GFORMAT" "/GLINE" "/GMARKER" "/GO" "/GOLIST" "/GOPR" "/GRAPHICS" "/GRESUME" "/GRID" "/GROPT" "/GRTYP" "/GSAVE" "/GST" "/GTHK" "/GTYPE" "/HBC" "/HEADER" "/ICLWID" "/ICSCALE" "/IMAGE" "/INPUT" "/INQUIRE" "/LARC" "/LIGHT" "/LINE" "/LSPEC" "/LSYMBOL" "/MAP" "/MENU" "/MKDIR" "/MPLIB" "/MREP" "/MSTART" "/NERR" "/NOERASE" "/NOLIST" "/NOPR" "/NORMAL" "/NUMBER" "/OUTPUT" "/PAGE" "/PBC" "/PBF" "/PCIRCLE" "/PLOPTS" "/PMACRO" "/PMORE" "/PNUM" "/POLYGON" "/POST1" "/POST26" "/PREP7" "/PSEARCH" "/PSF" "/PSPEC" "/PSTATUS" "/PSYMB" "/PWEDGE" "/QUIT" "/RATIO" "/RENAME" "/REPLOT" "/RESET" "/RGB" "/RMDIR" "/SECLIB" "/SEG" "/SHADE" "/SHOW" "/SHRINK" "/SMBC" "/SOLU" "/SSCALE" "/STATUS" "/STITLE" "/SYP" "/SYS" "/TEE" "/TITLE" "/TLABEL" "/TRIAD" "/TRLCY" "/TSPEC" "/TXTRE" "/TYPE" "/UCMD" "/UDOC" "/UI" "/UIS" "/UNITS" "/UPF" "/USER" "/VCONE" "/VIEW" "/VSCALE" "/VUP" "/WAIT" "/WINDOW" "/XFRM" "/XRANGE" "/YRANGE" "/ZOOM" "A" "AADD" "AATT" "ABBRES" "ABBSAV" "ABEXTRACT" "ABS" "ACCAT" "ACCOPTION" "ACEL" "ACLEAR" "ADAMS" "ADD" "ADDAM" "ADELE" "ADGL" "ADPCI" "ADRAG" "AEROCOEFF" "AESIZE" "AFILLT" "AFLIST" "AFSURF" "AGEN" "AGLUE" "AINA" "AINP" "AINV" "AIRL" "AL" "ALIST" "ALLSEL" "ALPHAD" "AMAP" "AMBEAM" "AMBUILD" "AMENV" "AMESH" "AMMAT" "AMPOWDER" "AMRESULT" "AMSTEP" "AMSUPPORTS" "AMTYPE" "ANCNTR" "ANCUT" "ANCYC" "ANDATA" "ANDSCL" "ANDYNA" "ANFLOW" "ANHARM" "ANIM" "ANISOS" "ANMODE" "ANORM" "ANPRES" "ANSOL" "ANSTOAQWA" "ANSTOASAS" "ANTIME" "ANTYPE" "AOFFST" "AOVLAP" "APLOT" "APORT" "APPEND" "APTN" "ARCLEN" "ARCTRM" "AREAS" "AREFINE" "AREMESH" "AREVERSE" "AROTAT" "ARSCALE" "ARSYM" "ASBA" "ASBL" "ASBV" "ASBW" "ASCRES" "ASEL" "ASIFILE" "ASKIN" "ASLL" "ASLV" "ASOL" "ASUB" "ASUM" "ATAN" "ATRAN" "ATYPE" "AUTOTS" "AVPRIN" "AVRES" "AWAVE" "BCSOPTION" "BETAD" "BF" "BFA" "BFADELE" "BFALIST" "BFCUM" "BFDELE" "BFE" "BFECUM" "BFEDELE" "BFELIST" "BFESCAL" "BFINT" "BFK" "BFKDELE" "BFKLIST" "BFL" "BFLDELE" "BFLIST" "BFLLIST" "BFPORT" "BFSCALE" "BFTRAN" "BFUNIF" "BFV" "BFVDELE" "BFVLIST" "BIOOPT" "BIOT" "BLC4" "BLC5" "BLOCK" "BOOL" "BOPTN" "BSAX" "BSM1" "BSM2" "BSMD" "BSPLIN" "BSS1" "BSS2" "BSTE" "BSTQ" "BTOL" "BUCOPT" "C" "CALC" "CAMPBELL" "CBDOF" "CBMD" "CBMX" "CBTE" "CBTMP" "CDOPT" "CDREAD" "CDWRITE" "CE" "CECHECK" "CECMOD" "CECYCMS" "CEDELE" "CEFILTER" "CEIMS" "CEINTF" "CELIST" "CENTER" "CEQN" "CERIG" "CESEL" "CESGEN" "CFACT" "CGLOC" "CGOMGA" "CGROW" "CHECK" "CHKMSH" "CINT" "CIRCLE" "CISOL" "CJUMP" "CLOAD" "CLOCAL" "CLOG" "CLRMSHLN" "CM" "CMACEL" "CMATRIX" "CMDELE" "CMDOMEGA" "CMEDIT" "CMGRP" "CMLIST" "CMMOD" "CMOMEGA" "CMPLOT" "CMROTATE" "CMSEL" "CMSFILE" "CMSOPT" "CMWRITE" "CNCHECK" "CNKMOD" "CNTR" "CNVTOL" "COMBINE" "COMPRESS" "CON4" "CONE" "CONJUG" "CORIOLIS" "COUPLE" "COVAL" "CP" "CPCYC" "CPDELE" "CPINTF" "CPLGEN" "CPLIST" "CPMERGE" "CPNGEN" "CPSEL" "CPSGEN" "CQC" "CS" "CSCIR" "CSDELE" "CSKP" "CSLIST" "CSWPLA" "CSYS" "CURR2D" "CUTCONTROL" "CVAR" "CYCCALC" "CYCFILES" "CYCFREQ" "CYCLIC" "CYCOPT" "CYCPHASE" "CYCSPEC" "CYL4" "CYL5" "CYLIND" "CZDEL" "CZMESH" "D" "DA" "DADELE" "DALIST" "DAMORPH" "DAMPOPT" "DATA" "DATADEF" "DCGOMG" "DCUM" "DDASPEC" "DDELE" "DDOPTION" "DEACT" "DEFINE" "DELETE" "DELTIM" "DEMORPH" "DERIV" "DESIZE" "DESOL" "DETAB" "DFLX" "DFSWAVE" "DISPLAY" "DJ" "DJDELE" "DJLIST" "DK" "DKDELE" "DKLIST" "DL" "DLDELE" "DLIST" "DLLIST" "DMPEXT" "DMPOPTION" "DMPRAT" "DMPSTR" "DNSOL" "DOF" "DOFSEL" "DOMEGA" "DSCALE" "DSPOPTION" "DSUM" "DSYM" "DSYS" "DTRAN" "DUMP" "DVAL" "DVMORPH" "DYNOPT" "E" "EALIVE" "ECPCHG" "EDELE" "EEMBED" "EEXTRUDE" "EGEN" "EGID" "EINFIN" "EINTF" "EKILL" "ELBOW" "ELEM" "ELIST" "EMAGERR" "EMATWRITE" "EMF" "EMFT" "EMID" "EMIS" "EMODIF" "EMORE" "EMSEL" "EMSYM" "EMTGEN" "EMUNIT" "EN" "ENDRELEASE" "ENERSOL" "ENGEN" "ENORM" "ENSYM" "EORIENT" "EPLOT" "EQSLV" "ERASE" "EREAD" "EREFINE" "EREINF" "ERESX" "ERNORM" "ERRANG" "ESCHECK" "ESEL" "ESIZE" "ESLA" "ESLL" "ESLN" "ESLV" "ESOL" "ESORT" "ESTIF" "ESURF" "ESYM" "ESYS" "ET" "ETABLE" "ETCHG" "ETCONTROL" "ETDELE" "ETLIST" "ETYPE" "EUSORT" "EWRITE" "EXBOPT" "EXOPTION" "EXP" "EXPAND" "EXPASS" "EXPROFILE" "EXPSOL" "EXTOPT" "EXTREM" "EXUNIT" "F" "FC" "FCCHECK" "FCDELE" "FCLIST" "FCTYP" "FCUM" "FDELE" "FEBODY" "FECONS" "FEFOR" "FESURF" "FILE" "FILEAUX2" "FILEAUX3" "FILL" "FILLDATA" "FINISH" "FITEM" "FJ" "FJDELE" "FJLIST" "FK" "FKDELE" "FKLIST" "FLIST" "FLST" "FLUREAD" "FLUXV" "FORCE" "FORM" "FREQ" "FRQSCL" "FSCALE" "FSSECT" "FSSPARM" "FSUM" "FTRAN" "FTYPE" "FVMESH" "GAUGE" "GCDEF" "GCGEN" "GENOPT" "GEOM" "GEOMETRY" "GMATRIX" "GMFACE" "GPLOT" "GRP" "GSBDATA" "GSGDATA" "GSLIST" "GSSOL" "GSUM" "HARFRQ" "HBMAT" "HBMOPT" "HELP" "HEMIOPT" "HFANG" "HFSYM" "HPTCREATE" "HPTDELETE" "HRCPLX" "HREXP" "HROCEAN" "HROPT" "HROUT" "IC" "ICDELE" "ICLIST" "ICROTATE" "IGESIN" "IGESOUT" "IMAGIN" "IMESH" "IMMED" "INISTATE" "INRES" "INRTIA" "INT1" "INVOPT" "IOPTN" "IRLF" "IRLIST" "JPEG" "JSOL" "K" "KATT" "KBC" "KBETW" "KCENTER" "KCLEAR" "KDELE" "KDIST" "KEEP" "KESIZE" "KEYOPT" "KEYPTS" "KEYW" "KFILL" "KGEN" "KL" "KLIST" "KMESH" "KMODIF" "KMOVE" "KNODE" "KPLOT" "KPSCALE" "KREFINE" "KRYOPT" "KSCALE" "KSCON" "KSEL" "KSLL" "KSLN" "KSUM" "KSYMM" "KTRAN" "KUSE" "KWPAVE" "KWPLAN" "L" "L2ANG" "L2TAN" "LANBOPTION" "LANG" "LARC" "LAREA" "LARGE" "LATT" "LAYER" "LAYERP26" "LAYLIST" "LAYPLOT" "LCABS" "LCASE" "LCCALC" "LCCAT" "LCDEF" "LCFACT" "LCFILE" "LCLEAR" "LCOMB" "LCOPER" "LCSEL" "LCSL" "LCSUM" "LCWRITE" "LCZERO" "LDELE" "LDIV" "LDRAG" "LDREAD" "LESIZE" "LEXTND" "LFILLT" "LFSURF" "LGEN" "LGLUE" "LGWRITE" "LINA" "LINE" "LINES" "LINL" "LINP" "LINV" "LIST" "LLIST" "LMESH" "LNSRCH" "LOCAL" "LOVLAP" "LPLOT" "LPTN" "LREFINE" "LREVERSE" "LROTAT" "LSBA" "LSBL" "LSBV" "LSBW" "LSCLEAR" "LSDELE" "LSEL" "LSLA" "LSLK" "LSOPER" "LSREAD" "LSSCALE" "LSSOLVE" "LSTR" "LSUM" "LSWRITE" "LSYMM" "LTAN" "LTRAN" "LUMPM" "LVSCALE" "LWPLAN" "M" "MACOPT" "MAGOPT" "MAGSOLV" "MAP" "MAP2DTO3D" "MAPSOLVE" "MAPVAR" "MASCALE" "MASTER" "MAT" "MATER" "MAXCYCMODE" "MCFOPT" "MCHECK" "MDAMP" "MDELE" "MDPLOT" "MEMM" "MESHING" "MGEN" "MIDTOL" "MLIST" "MMASS" "MMF" "MODCONT" "MODDIR" "MODE" "MODIFY" "MODMSH" "MODOPT" "MODSELOPTION" "MONITOR" "MOPT" "MORPH" "MOVE" "MP" "MPAMOD" "MPCHG" "MPCOPY" "MPDATA" "MPDELE" "MPDRES" "MPLIST" "MPPLOT" "MPREAD" "MPRINT" "MPTEMP" "MPTGEN" "MPTRES" "MPWRITE" "MRPM" "MSAVE" "MSHAPE" "MSHCOPY" "MSHKEY" "MSHMID" "MSHPATTERN" "MSOLVE" "MSOPT" "MSTOLE" "MXPAND" "N" "NANG" "NAXIS" "NCNV" "NDELE" "NDIST" "NDSURF" "NEQIT" "NFORCE" "NGEN" "NKPT" "NLADAPTIVE" "NLDIAG" "NLDPOST" "NLGEOM" "NLHIST" "NLIST" "NLMESH" "NLOG" "NLOPT" "NMODIF" "NODES" "NOOFFSET" "NORA" "NORL" "NPLOT" "NPRINT" "NREAD" "NREFINE" "NRLSUM" "NROPT" "NROTAT" "NRRANG" "NSCALE" "NSEL" "NSLA" "NSLE" "NSLK" "NSLL" "NSLV" "NSMASS" "NSMOOTH" "NSOL" "NSORT" "NSTORE" "NSUBST" "NSVR" "NSYM" "NUMCMP" "NUMEXP" "NUMMRG" "NUMOFF" "NUMSTR" "NUMVAR" "NUSORT" "NWPAVE" "NWPLAN" "NWRITE" "OCDATA" "OCDELETE" "OCLIST" "OCREAD" "OCTABLE" "OCTYPE" "OCZONE" "OMEGA" "OPERATE" "OPNCONTROL" "OSRESULT" "OUTAERO" "OUTGEOM" "OUTOPT" "OUTPR" "OUTRES" "PADELE" "PAGET" "PAPUT" "PARESU" "PARRES" "PARSAV" "PASAVE" "PATH" "PAUSE" "PCALC" "PCGOPT" "PCIRC" "PCROSS" "PDEF" "PDOT" "PERBC2D" "PERTURB" "PFACT" "PIVCHECK" "PLAS" "PLCAMP" "PLCFREQ" "PLCHIST" "PLCINT" "PLCKSURF" "PLCPLX" "PLDISP" "PLESOL" "PLETAB" "PLF2D" "PLFAR" "PLGEOM" "PLLS" "PLMAP" "PLMC" "PLNEAR" "PLNSOL" "PLORB" "PLOTTING" "PLPAGM" "PLPATH" "PLSECT" "PLTIME" "PLTRAC" "PLVAR" "PLVECT" "PLZZ" "PMAP" "PMGTRAN" "PMLOPT" "PMLSIZE" "PNGR" "POINT" "POLY" "POWERH" "PPATH" "PRANGE" "PRAS" "PRCAMP" "PRCINT" "PRCPLX" "PRED" "PRENERGY" "PRERR" "PRESOL" "PRETAB" "PRFAR" "PRI2" "PRIM" "PRINT" "PRISM" "PRITER" "PRJSOL" "PRMC" "PRNEAR" "PRNLD" "PRNSOL" "PROD" "PRORB" "PRPATH" "PRRFOR" "PRRSOL" "PRSCONTROL" "PRSECT" "PRTIME" "PRVAR" "PRVECT" "PSCONTROL" "PSDCOM" "PSDFRQ" "PSDGRAPH" "PSDRES" "PSDSPL" "PSDUNIT" "PSDVAL" "PSDWAV" "PSEL" "PSMAT" "PSMESH" "PSTRES" "PSYS" "PTR" "PTXY" "PVECT" "QDVAL" "QRDOPT" "QSOPT" "QUAD" "QUOT" "R" "RACE" "RADOPT" "RAPPND" "RATE" "RBE3" "RCON" "RCYC" "RDEC" "RDELE" "READ" "REAL" "REALVAR" "RECTNG" "REMESH" "RESCOMBINE" "RESCONTROL" "RESET" "RESP" "RESUME" "RESVEC" "RESWRITE" "REZONE" "RFORCE" "RIGID" "RIGRESP" "RLIST" "RMFLVEC" "RMODIF" "RMORE" "ROCK" "ROSE" "RPOLY" "RPR4" "RPRISM" "RPSD" "RSMESH" "RSOPT" "RSPLIT" "RSTCONTROL" "RSTMAC" "RSTOFF" "RSURF" "RSYMM" "RSYS" "SABS" "SADD" "SALLOW" "SAVE" "SBCLIST" "SBCTRAN" "SCOPT" "SDELETE" "SE" "SECCONTROL" "SECDATA" "SECFUNCTION" "SECJOINT" "SECLOCK" "SECMODIF" "SECNUM" "SECOFFSET" "SECPLOT" "SECREAD" "SECSTOP" "SECTYPE" "SECWRITE" "SED" "SEDLIST" "SEEXP" "SELIST" "SELM" "SELTOL" "SEMIIMPLICIT" "SENERGY" "SEOPT" "SESYMM" "SET" "SETFGAP" "SETRAN" "SEXP" "SF" "SFA" "SFACT" "SFADELE" "SFALIST" "SFBEAM" "SFCALC" "SFCONTROL" "SFCUM" "SFDELE" "SFE" "SFEDELE" "SFELIST" "SFFUN" "SFGRAD" "SFL" "SFLDELE" "SFLEX" "SFLIST" "SFLLIST" "SFSCALE" "SFTRAN" "SHELL" "SHPP" "SHSD" "SLIST" "SLOAD" "SMALL" "SMAX" "SMBODY" "SMCONS" "SMFOR" "SMIN" "SMOOTH" "SMRTSIZE" "SMSURF" "SMULT" "SNOPTION" "SOLOPTION" "SOLU" "SOLUOPT" "SOLVE" "SORT" "SOURCE" "SPACE" "SPCNOD" "SPCTEMP" "SPDAMP" "SPEC" "SPFREQ" "SPGRAPH" "SPH4" "SPH5" "SPHERE" "SPLINE" "SPLOT" "SPMWRITE" "SPOINT" "SPOPT" "SPREAD" "SPTOPT" "SPUNIT" "SPVAL" "SQRT" "SRSS" "SSBT" "SSLN" "SSMT" "SSOPT" "SSPA" "SSPB" "SSPD" "SSPE" "SSPM" "SSTATE" "SSUM" "STABILIZE" "STAT" "STEF" "STORE" "SUBOPT" "SUBSET" "SUCALC" "SUCR" "SUDEL" "SUEVAL" "SUGET" "SUMAP" "SUMTYPE" "SUPL" "SUPR" "SURESU" "SUSAVE" "SUSEL" "SUVECT" "SV" "SVPLOT" "SVTYP" "SWADD" "SWDEL" "SWGEN" "SWLIST" "SYNCHRO" "TALLOW" "TARGET" "TB" "TBCOPY" "TBDATA" "TBDELE" "TBEO" "TBFIELD" "TBFPLOT" "TBFT" "TBIN" "TBLE" "TBLIST" "TBMODIF" "TBPLOT" "TBPT" "TBTEMP" "TCHG" "THEXPAND" "THOPT" "TIFF" "TIME" "TIMERANGE" "TIMINT" "TIMP" "TINTP" "TOFFST" "TORUS" "TRANSFER" "TREF" "TRNOPT" "TRPDEL" "TRPLIS" "TRPOIN" "TRTIME" "TSHAP" "TSRES" "TUNIF" "TVAR" "TYPE" "UIMP" "UNDELETE" "UNDO" "UNPAUSE" "UPCOORD" "UPGEOM" "USRCAL" "USRDOF" "USRELEM" "V" "V2DOPT" "VA" "VADD" "VARDEL" "VARNAM" "VATT" "VCLEAR" "VCROSS" "VDDAM" "VDELE" "VDGL" "VDOT" "VDRAG" "VEORIENT" "VEXT" "VFCO" "VFDI" "VFOPT" "VFQUERY" "VFSM" "VFUP" "VGEN" "VGET" "VGLUE" "VIMP" "VINP" "VINV" "VLIST" "VLSCALE" "VMESH" "VOFFST" "VOLUMES" "VOVLAP" "VPLOT" "VPTN" "VPUT" "VROTAT" "VSBA" "VSBV" "VSBW" "VSEL" "VSLA" "VSUM" "VSWEEP" "VSYMM" "VTRAN" "VTYPE" "WPAVE" "WPCSYS" "WPLANE" "WPOFFS" "WPROTA" "WPSTYL" "WRFULL" "WRITE" "WRITEMAP" "WSPRINGS" "WTBCREATE" "XFCRKMESH" "XFDATA" "XFENRICH" "XFLIST" "XVAR" "~CAT5IN" "~CATIAIN" "~PARAIN" "~PROEIN" "~SATIN" "~UGIN" "*EVAL" "*MOONEY" "*PREAD" "/OPT" "/PICE" "/PMETH" "/RUNST" "/RUNSTAT" "/SSS" "/TRACK" "/VERIFY" "/VT" "/WB" "/XML" "ALPFILL" "ARCOLLAPSE" "ARDETACH" "ARFILL" "ARMERGE" "ARSPLIT" "ASLN" "BELLOW" "BEND" "BRANCH" "CECYC" "CEWRITE" "CMBLOCK" "CNTR" "CRPLIM" "CWZPLOT" "EALL" "EBLOCK" "END" "EQSLV" "FATIGUE" "FE" "FELIST" "FIPLOT" "FL" "FLANGE" "FLDATA1-40" "FLITEM" "FLLIST" "FLOCHECK" "FLOTRAN" "FLREAD" "FMAGSUM" "FP" "FPLIST" "FS" "FSDELE" "FSLIST" "FSNODE" "FSPLOT" "FTCALC" "FTSIZE" "FTWRITE" "GAP" "GAPF" "GAPFINISH" "GAPLIST" "GAPMERGE" "GAPOPT" "GAPPLOT" "GP" "GPDELE" "GPLIST" "HFADP" "HFARRAY" "HFDEEM" "HFEIGOPT" "HFEREFINE" "HFMODPRT" "HFPA" "HFPCSWP" "HFPORT" "HFPOWER" "HFSCAT" "ICE" "ICEDELE" "ICELIST" "ICVFRC" "KCALC" "LNCOLLAPSE" "LNDETACH" "LNFILL" "LNMERGE" "LNSPLIT" "LPRT" "LSLN" "MITER" "MSADV" "MSCAP" "MSDATA" "MSMASS" "MSMETH" "MSMIR" "MSNOMF" "MSPROP" "MSQUAD" "MSRELAX" "MSSOLU" "MSSPEC" "MSTERM" "MSVARY" "NALL" "NBLOCK" "NELE" "OPADD" "OPANL" "OPCLR" "OPDATA" "OPDEL" "OPEQN" "OPEXE" "OPFACT" "OPFRST" "OPGRAD" "OPKEEP" "OPLFA" "OPLGR" "OPLIST" "OPLOOP" "OPLSW" "OPMAKE" "OPPRNT" "OPRAND" "OPRESU" "OPRFA" "OPRGR" "OPRSW" "OPSAVE" "OPSEL" "OPSUBP" "OPSWEEP" "OPTYPE" "OPUSER" "OPVAR" "PCONV" "PCORRO" "PDRAG" "PEMOPTS" "PERI" "PEXCLUDE" "PFLUID" "PGAP" "PGRAPH" "PGRSET" "PGSAVE" "PGSELE" "PGWRITE" "PILECALC" "PILEDISPSET" "PILEGEN" "PILELOAD" "PILEMASS" "PILERUN" "PILESEL" "PILESTIF" "PINCLUDE" "PINSUL" "PIPE" "PLCONV" "PLCRACK" "PLFSS" "PLSCH" "PLSYZ" "PLTD" "PLTLINE" "PLVAROPT" "PLVFRC" "PLWAVE" "PMETH" "PMOPTS" "POPT" "POUTRES" "PPLOT" "PPRANGE" "PPRES" "PRCONV" "PRECISION" "PRSYZ" "PRVAROPT" "PSOLVE" "PSOLVE" "PSPEC" "PSPRNG" "PTEMP" "PUNIT" "QFACT" "RALL" "REDUCE" "RFILSZ" "RITER" "RMEMRY" "RSPEED" "RSTAT" "RTIMST" "RUN" "RWFRNT" "SARPLOT" "SHSD" "SLPPLOT" "SLSPLOT" "SOLCONTROL" "SPADP" "SPARM" "SPFSS" "SPICE" "SPSCAN" "SPSWP" "SSTIF" "TEE" "TOCOMP" "TODEF" "TOEXE" "TOFREQ" "TOGRAPH" "TOLIST" "TOLOOP" "TOPLOT" "TOPRINT" "TOSTAT" "TOTAL" "TOTYPE" "TOVAR" "TZAMESH" "TZDELE" "TZEGEN" "VALVE" "VCVFILL" "VTCLR" "VTDISC" "VTEVAL" "VTFREQ" "VTGEOM" "VTIN" "VTMETH" "VTMP" "VTOP" "VTPOST" "VTREAL" "VTRFIL" "VTRSLT" "VTSEC" "VTSFE" "VTSL" "VTSTAT" "VTTEMP" "VTVMOD" "XMLO" "XVAROPT" "~CFIN" "~EUI")
