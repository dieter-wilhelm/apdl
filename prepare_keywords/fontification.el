...
;; 4.) `Apdl_commands_without_arguments' <- dynprompt241.ans
;;

;;; Code:

(defconst Apdl_undocumented_commands    ; or macros? and archived commands?
  '(
...
files, old macros or old APDL verification macros.")
...
(defconst Apdl_commands_without_arguments
  ...
  "APDL commands which have no arguments.")

;; deprecated element list is from Ansys version
;; 12.0, 13.0, 14.0, 16.2, archived elements v201 v241
